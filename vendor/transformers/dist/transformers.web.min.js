...
`}async _call(e,s=null,r=null,n={}){typeof e=="string"&&(e=[e]);let o;r&&(o=await this.feature_extractor(r,n),e=e.map(l=>l.replaceAll(this.audio_token,this.full_audio_sequence)));let a;return s&&(a=await this.image_processor(s,n),e=e.map(l=>l.replaceAll(this.image_token,this.full_image_sequence))),{...this.tokenizer(e,n),...a,...o}}};function cv(t,e){let r=t.dims.at(-1)-1,n=t.tolist();n.fill(!1,0,1),n.fill(!1,r);let o=e.tolist();return n.map((a,i)=>a?i:null).filter(a=>a!==null).map(a=>o[a])}var sp=class extends j{static tokenizer_class=L;static image_processor_class=_e;async _call(e,s,r={}){let n=e?await this.image_processor(e,r):{};return{...s?this.tokenizer(s,r):{},...n}}post_process_grounded_object_detection(e,s,{box_threshold:r=.25,text_threshold:n=.25,target_sizes:o=null}={}){let{logits:a,pred_boxes:i}=e,l=a.dims[0];if(o!==null&&o.length!==l)throw Error("Make sure that you pass in as many target sizes as the batch dimension of the logits");let c=a.dims.at(1),u=a.sigmoid(),p=u.max(-1).tolist(),d=i.tolist().map(m=>m.map(h=>du(h))),_=[];for(let m=0;m<l;++m){let h=o!==null?o[m]:null;h!==null&&(d[m]=d[m].map(E=>E.map((A,b)=>A*h[(b+1)%2])));let x=p[m],g=[],w=[],y=[];for(let E=0;E<c;++E){let A=x[E];if(A<=r)continue;let b=d[m][E],O=u[m][E];g.push(A),y.push(b);let N=cv(O.gt(n),s[m]);w.push(N)}_.push({scores:g,boxes:y,labels:this.batch_decode(w)})}return _}};function uv(t,e,s,r,n,o){let a="";for(let i=0;i<e;++i){for(let l=0;l<s;++l)a+=r+`<row_${i+1}_col_${l+1}>`+n.repeat(t);a+=`
`}return a+=`
${r}${o}`+n.repeat(t)+`${r}`,a}function pv(t,e,s,r){return`${e}${r}`+s.repeat(t)+`${e}`}function dv(t,e,s,r,n,o){return t===0&&e===0?pv(s,r,n,o):uv(s,t,e,r,n,o)}var Ea=class extends j{static image_processor_class=_e;static tokenizer_class=L;static uses_processor_config=!0;fake_image_token="<fake_token_around_image>";image_token="<image>";global_img_token="<global-img>";async _call(e,s=null,r={}){r.return_row_col_info??=!0;let n;s&&(n=await this.image_processor(s,r)),Array.isArray(e)||(e=[e]);let o=n.rows??[new Array(e.length).fill(0)],a=n.cols??[new Array(e.length).fill(0)],i=this.config.image_seq_len,l=[],c=[];for(let p=0;p<e.length;++p){let d=e[p],_=o[p],m=a[p];l.push(iw(d,this.image_token));let h=_.map((w,y)=>dv(w,m[y],i,this.fake_image_token,this.image_token,this.global_img_token)),x=d.split(this.image_token);if(x.length===0)throw new Error("The image token should be present in the text.");let g=x[0];for(let w=0;w<h.length;++w)g+=h[w]+x[w+1];c.push(g)}return{...this.tokenizer(c),...n}}};var rp=class extends j{static image_processor_class=_e;static tokenizer_class=L;static uses_processor_config=!0;constructor(e,s,r){super(e,s,r),this.image_tag=this.config.image_tag,this.image_start_tag=this.config.image_start_tag,this.image_end_tag=this.config.image_end_tag,this.num_image_tokens=this.config.num_image_tokens}async _call(e,{images:s=null,chat_template:r="default"}={}){s?Array.isArray(s)||(s=[s]):s=await Promise.all(e.filter(x=>x.images).flatMap(x=>x.images).map(x=>we.read(x)));let n=this.tokenizer,o=n.apply_chat_template(e,{tokenize:!1,add_generation_prompt:!0,chat_template:r}),a=x=>n.encode(x,{add_special_tokens:!1}),i=o.split(this.image_tag),l=i.length-1;if(s.length!==l)throw new Error(`Number of images provided (${s.length}) does not match number of "${this.image_tag}" image tags (${l})`);let[c,u,p]=n.convert_tokens_to_ids([this.image_tag,this.image_start_tag,this.image_end_tag]),d=a(i[0]),_=new Array(d.length).fill(!1);for(let x=1;x<i.length;++x){let g=new Array(this.num_image_tokens).fill(c),w=a(i[x]);d=Pe(d,[u],g,[p],w);let y=new Array(this.num_image_tokens).fill(!0);_=Pe(_,[!1],y,[!1],new Array(w.length).fill(!1))}let m=[1,d.length],h={input_ids:new S("int64",d,m),attention_mask:new S("int64",new Array(d.length).fill(1),m),images_seq_mask:new S("bool",_,m),images_emb_mask:new S("bool",new Array(l*this.num_image_tokens).fill(!0),[1,l,this.num_image_tokens])};if(s&&s.length>0){let x=await this.image_processor(s);return x.pixel_values.unsqueeze_(0),{...h,...x}}return h}};var np=class extends j{static tokenizer_class=L;static image_processor_class=_e;async _call(e=null,s=null,r={}){if(!e&&!s)throw new Error("Either text or images must be provided");let n=e?this.tokenizer(e,r):{},o=s?await this.image_processor(s,r):{};return{...n,...o}}};var op=class extends j{static tokenizer_class=L;static image_processor_class=_e;static uses_processor_config=!0;async _call(e,s=null,r={}){let n=await this.image_processor(e,r);if(s){let[a,i]=n.pixel_values.dims.slice(-2),{image_token:l,patch_size:c,num_additional_image_tokens:u}=this.config,p=Math.floor(a/c)*Math.floor(i/c)+u;s=structuredClone(s),Array.isArray(s)||(s=[s]);for(let d=0;d<s.length;++d)s[d]=s[d].replace(l,l.repeat(p))}let o=s?this.tokenizer(s,r):{};return{...n,...o}}};var ey={char:["char_decode",1],bpe:["bpe_decode",2],wp:["wp_decode",102]},ap=class extends j{static tokenizer_class=L;static image_processor_class=_e;get char_tokenizer(){return this.components.char_tokenizer}get bpe_tokenizer(){return this.components.bpe_tokenizer}get wp_tokenizer(){return this.components.wp_tokenizer}_decode_helper(e,s){if(!ey.hasOwnProperty(s))throw new Error(`Format ${s} is not supported.`);let[r,n]=ey[s],o=this[r].bind(this),[a,i]=e.dims,l=[],c=[],u=e.tolist();for(let d=0;d<a;++d){let _=u[d],m=[],h=[];for(let g=1;g<i;++g){let[w,y]=ae(ue(_[g]));if(h.push(w),y==n)break;m.push(y)}let x=h.length>0?h.reduce((g,w)=>g*w,1):0;c.push(m),l.push(x)}return[o(c),l]}char_decode(e){return this.char_tokenizer.batch_decode(e).map(s=>s.replaceAll(" ",""))}bpe_decode(e){return this.bpe_tokenizer.batch_decode(e)}wp_decode(e){return this.wp_tokenizer.batch_decode(e).map(s=>s.replaceAll(" ",""))}batch_decode([e,s,r]){let[n,o]=this._decode_helper(e,"char"),[a,i]=this._decode_helper(s,"bpe"),[l,c]=this._decode_helper(r,"wp"),u=[],p=[];for(let d=0;d<n.length;++d){let[_,m]=ae([o[d],i[d],c[d]]);u.push([n[d],a[d],l[d]][m]),p.push(_)}return{generated_text:u,scores:p,char_preds:n,bpe_preds:a,wp_preds:l}}static async from_pretrained(...e){let s=await super.from_pretrained(...e),r=await L.from_pretrained("Xenova/gpt2"),n=await L.from_pretrained("Xenova/bert-base-uncased");return s.components={image_processor:s.image_processor,char_tokenizer:s.tokenizer,bpe_tokenizer:r,wp_tokenizer:n},s}async _call(e,s=null){let r=await this.image_processor(e);return s&&(r.labels=this.tokenizer(s).input_ids),r}};var ip=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;async _call(e){return await this.feature_extractor(e)}};var lp=class extends j{static tokenizer_class=L;static image_processor_class=_e};var Os="<image>";function _v(t,e,s,r,n){return`${r.repeat(s*n)}${e}${t}
`}var cp=class extends j{static tokenizer_class=L;static image_processor_class=_e;static uses_processor_config=!1;async _call(e,s=null,r={}){s||(console.warn("You are using PaliGemma without a text prefix. It will perform as a picture-captioning model."),s=""),Array.isArray(e)||(e=[e]),Array.isArray(s)||(s=[s]);let n=this.tokenizer.bos_token,o=this.image_processor.config.image_seq_length,a;s.some(c=>c.includes(Os))?a=s.map(c=>{let u=c.replaceAll(Os,Os.repeat(o)),p=u.lastIndexOf(Os),d=p===-1?0:p+Os.length;return u.slice(0,d)+n+u.slice(d)+`
`}):(console.warn("You are passing both `text` and `images` to `PaliGemmaProcessor`. The processor expects special image tokens in the text, as many tokens as there are images per each text. It is recommended to add `<image>` tokens in the very beginning of your text. For this call, we will infer how many images each text has and add special tokens."),a=s.map(c=>_v(c,n,o,Os,e.length)));let i=this.tokenizer(a,r);return{...await this.image_processor(e,r),...i}}};var ty="<|image|>",fv=/<\|image_\d+\|>/g,up=class extends j{static image_processor_class=_e;static tokenizer_class=L;async _call(e,s=null,{padding:r=!0,truncation:n=!0,num_crops:o=null}={}){Array.isArray(e)||(e=[e]);let a,i;if(s){i=await this.image_processor(s,{num_crops:o});let{num_img_tokens:l}=i,c=e.map((p,d)=>p.split(fv).join(ty.repeat(l[d])));a=this.tokenizer(c,{padding:r,truncation:n});let u=this.tokenizer._tokenizer.token_to_id(ty);a.input_ids.map_(p=>p==u?-p:p)}else a=this.tokenizer(e);return{...a,...i}}};var pp=class extends j{static tokenizer_class=L;static image_processor_class=_e;static uses_processor_config=!0;async _call(e,s=null,r={}){let n=await this.image_processor(e,r);if(s){let[a,i]=n.pixel_values.dims.slice(-2),{image_token:l,image_break_token:c,image_end_token:u,patch_size:p,spatial_merge_size:d}=this.config,_=p*d,m=Math.floor(a/_),h=Math.floor(i/_);s=structuredClone(s),Array.isArray(s)||(s=[s]);for(let x=0;x<s.length;++x){let g=l.repeat(h),w=g+c,y=g+u,E=w.repeat(m-1)+y;s[x]=s[x].replace(l,E)}}let o=s?this.tokenizer(s,r):{};return{...n,...o}}};var dp=class extends j{static feature_extractor_class=wr;async _call(e){return await this.feature_extractor(e)}post_process_speaker_diarization(...e){return this.feature_extractor.post_process_speaker_diarization(...e)}get sampling_rate(){return this.feature_extractor.config.sampling_rate}};var _p=class extends j{static image_processor_class=_e;static tokenizer_class=L;async _call(e,s=null,...r){Array.isArray(e)||(e=[e]);let n,o;if(s&&(n=await this.image_processor(s),o=n.image_grid_thw),o){let i=this.image_processor.config.merge_size**2,l=0,c=o.tolist();e=e.map(u=>{for(;u.includes("<|image_pad|>");){let p=Number(c[l++].reduce((d,_)=>d*_,1n));u=u.replace("<|image_pad|>","<|placeholder|>".repeat(Math.floor(p/i)))}return u.replaceAll("<|placeholder|>","<|image_pad|>")})}return{...this.tokenizer(e),...n}}};var kr=class extends j{static image_processor_class=_e;async _call(...e){return await this.image_processor(...e)}post_process_masks(...e){return this.image_processor.post_process_masks(...e)}reshape_input_points(...e){return this.image_processor.reshape_input_points(...e)}};var Aa=class extends kr{},fp=class extends Aa{};var mp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;async _call(e){return await this.feature_extractor(e)}};var hp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;static uses_processor_config=!0;async _call(e,s=null,r={}){if(Array.isArray(e))throw new Error("Batched inputs are not supported yet.");let n={};if(s){let a=s.length,{input_features:i}=await this.feature_extractor(s,{...r,max_length:a}),l=Math.round(a/this.config.encoder_ds_factor+1e-4),c=1+Math.ceil(l/this.config.stack_factor);n.audio_token_len=[c],n.audio_values=i;let u=this.config.audio_placeholder;if(!e.includes(u))throw new Error(`The input text does not contain the image token ${u}.`);e=e.replaceAll(u,u.repeat(c))}return{...this.tokenizer(e,{add_special_tokens:!1,...r}),...n}}};var Ma="[AUDIO]",mv="[BEGIN_AUDIO]",hv=375;function xv(t,e){let s=[];for(let r=0;r<t.length;r+=e)s.push(t.subarray(r,Math.min(r+e,t.length)));return s}var xp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;static uses_processor_config=!1;async _call(e,s=null,r={}){if(Array.isArray(e))throw new Error("Batched inputs are not supported yet.");let n={};if(s){if(!e.includes(Ma))throw new Error(`The input text does not contain the audio token ${Ma}.`);Array.isArray(s)||(s=[s]);let a=e.split(Ma),i=a.length-1;if(i!==s.length)throw new Error(`The number of audio inputs (${s.length}) does not match the number of audio tokens in the text (${i}).`);let l=this.feature_extractor.config.n_samples,c=s.map(m=>xv(m,l)),u=c.map(m=>m.length),p=c.flat(),d=(await Promise.all(p.map(m=>this.feature_extractor(m,r)))).map(m=>m.input_features);n.audio_values=d.length>1?ne(d,0):d[0];let _=a[0];for(let m=0;m<u.length;++m){_+=mv;for(let h=0;h<u[m];++h)_+=Ma.repeat(hv);_+=a[m+1]}e=_}return{...this.tokenizer(e,{add_special_tokens:!1,...r}),...n}}};var gp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;async _call(e){return await this.feature_extractor(e)}};var wp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;async _call(e){return await this.feature_extractor(e)}};var yp=class extends j{static tokenizer_class=L;static feature_extractor_class=ve;async _call(e){return await this.feature_extractor(e)}};var ze=class{static async from_pretrained(e,s={}){let r=await Se(e,ks,!0,s),{image_processor_type:n,feature_extractor_type:o,processor_class:a}=r;if(a&&Sa[a])return Sa[a].from_pretrained(e,s);if(!n&&!o)throw new Error("No `image_processor_type` or `feature_extractor_type` found in the config.");let i={};if(n){let c=Ss[n.replace(/Fast$/,"")];if(!c)throw new Error(`Unknown image_processor_type: '${n}'.`);i.image_processor=new c(r)}if(o){let c=Ss[o];if(c)i.image_processor=new c(r);else{let u=yr[o];if(!u)throw new Error(`Unknown feature_extractor_type: '${o}'.`);i.feature_extractor=new u(r)}}let l={};return new j(l,i,null)}};async function gv(t,e){return await Se(t,"config.json",!0,e)}function Is(t){let e={},s={};switch(t.model_type){case"llava":case"paligemma":case"gemma3":case"florence2":case"llava_onevision":case"idefics3":case"ultravox":case"voxtral":case"smolvlm":case"gemma3n":case"chatterbox":case"mistral3":s=Is(t.text_config);break;case"moondream1":s=Is(t.phi_config);break;case"musicgen":s=Is(t.decoder);break;case"multi_modality":s=Is(t.language_config);break;case"gpt2":case"gptj":case"jais":case"codegen":case"gpt_bigcode":e.num_heads="n_head",e.num_layers="n_layer",e.hidden_size="n_embd";break;case"gpt_neox":case"stablelm":case"opt":case"falcon":case"modernbert-decoder":e.num_heads="num_attention_heads",e.num_layers="num_hidden_layers",e.hidden_size="hidden_size";break;case"gpt_oss":case"llama":case"llama4_text":case"nanochat":case"apertus":case"arcee":case"lfm2":case"lfm2_moe":case"smollm3":case"olmo":case"olmo2":case"olmo3":case"mobilellm":case"granite":case"granitemoehybrid":case"cohere":case"cohere2":case"mistral":case"starcoder2":case"qwen2":case"qwen2_vl":case"phi":case"phi3":case"phi3_v":case"llava_qwen2":e.num_heads="num_key_value_heads",e.num_layers="num_hidden_layers",e.hidden_size="hidden_size",e.num_attention_heads="num_attention_heads",e.dim_kv="head_dim";break;case"qwen3":case"gemma":case"gemma2":case"vaultgemma":case"gemma3_text":case"gemma3n_text":case"glm":case"helium":case"ernie4_5":case"hunyuan_v1_dense":case"falcon_h1":case"ministral":case"ministral3":e.num_heads="num_key_value_heads",e.num_layers="num_hidden_layers",e.dim_kv="head_dim";break;case"openelm":e.num_heads="num_kv_heads",e.num_layers="num_transformer_layers",e.dim_kv="head_dim";break;case"gpt_neo":case"donut-swin":e.num_heads="num_heads",e.num_layers="num_layers",e.hidden_size="hidden_size";break;case"bloom":e.num_heads="n_head",e.num_layers="n_layer",e.hidden_size="hidden_size";break;case"mpt":e.num_heads="n_heads",e.num_layers="n_layers",e.hidden_size="d_model";break;case"exaone":e.num_heads="num_key_value_heads",e.num_layers="num_layers",e.dim_kv="head_dim",e.num_attention_heads="num_attention_heads";break;case"youtu":e.num_heads="num_key_value_heads",e.num_layers="num_hidden_layers",e.dim_kv="qk_head_dim",e.num_attention_heads="num_attention_heads";break;case"t5":case"mt5":case"longt5":e.num_decoder_layers="num_decoder_layers",e.num_decoder_heads="num_heads",e.decoder_dim_kv="d_kv",e.num_encoder_layers="num_layers",e.num_encoder_heads="num_heads",e.encoder_dim_kv="d_kv";break;case"bart":case"mbart":case"marian":case"whisper":case"lite-whisper":case"m2m_100":case"blenderbot":case"blenderbot-small":case"florence2_language":e.num_decoder_layers="decoder_layers",e.num_decoder_heads="decoder_attention_heads",e.decoder_hidden_size="d_model",e.num_encoder_layers="encoder_layers",e.num_encoder_heads="encoder_attention_heads",e.encoder_hidden_size="d_model";break;case"speecht5":e.num_decoder_layers="decoder_layers",e.num_decoder_heads="decoder_attention_heads",e.decoder_hidden_size="hidden_size",e.num_encoder_layers="encoder_layers",e.num_encoder_heads="encoder_attention_heads",e.encoder_hidden_size="hidden_size";break;case"trocr":e.num_encoder_layers=e.num_decoder_layers="decoder_layers",e.num_encoder_heads=e.num_decoder_heads="decoder_attention_heads",e.encoder_hidden_size=e.decoder_hidden_size="d_model";break;case"musicgen_decoder":e.num_encoder_layers=e.num_decoder_layers="num_hidden_layers",e.num_encoder_heads=e.num_decoder_heads="num_attention_heads",e.encoder_hidden_size=e.decoder_hidden_size="hidden_size";break;case"moonshine":e.num_decoder_layers="decoder_num_hidden_layers",e.num_decoder_heads="decoder_num_key_value_heads",e.num_encoder_layers="encoder_num_hidden_layers",e.num_encoder_heads="encoder_num_key_value_heads",e.encoder_hidden_size=e.decoder_hidden_size="hidden_size";break;case"vision-encoder-decoder":let n=Is(t.decoder),o="num_decoder_layers"in n,a=Me(t,["model_type","is_encoder_decoder"]);return o?(a.num_decoder_layers=n.num_decoder_layers,a.num_decoder_heads=n.num_decoder_heads,a.decoder_hidden_size=n.decoder_hidden_size,a.num_encoder_layers=n.num_encoder_layers,a.num_encoder_heads=n.num_encoder_heads,a.encoder_hidden_size=n.encoder_hidden_size):(a.num_layers=n.num_layers,a.num_heads=n.num_heads,a.hidden_size=n.hidden_size),a}let r={...s,...Me(t,["model_type","multi_query","is_encoder_decoder"])};for(let n in e)r[n]=t[e[n]];return r}function Ia(t,e){if(["lfm2","lfm2_moe"].includes(t.model_type)){let s=e?.prefix??"past_key_values",r=s==="present"?"present":"past",n={},{layer_types:o,num_attention_heads:a,num_key_value_heads:i,hidden_size:l,conv_L_cache:c}=t,u=l/a,p=e?.batch_size??1;for(let d=0;d<o.length;++d)if(o[d]==="full_attention")for(let _ of["key","value"])n[`${s}.${d}.${_}`]=[p,i,0,u];else if(o[d]==="conv")n[`${r}_conv.${d}`]=[p,l,c];else throw new Error(`Unsupported layer type: ${o[d]}`);return n}else if(["granitemoehybrid","falcon_h1"].includes(t.model_type)){let s=e?.prefix??"past_key_values",r=s==="present"?"present":"past",n={},{layer_types:o,num_hidden_layers:a,num_attention_heads:i,num_key_value_heads:l,hidden_size:c,mamba_d_conv:u,mamba_n_heads:p,mamba_d_head:d,mamba_d_state:_,mamba_n_groups:m,mamba_expand:h,mamba_d_ssm:x}=t,g=c/i,w=e?.batch_size??1,y=(x??h*c)+2*m*_;for(let E=0;E<a;++E)if((!o||o[E]==="mamba")&&(n[`${r}_conv.${E}`]=[w,y,u],n[`${r}_ssm.${E}`]=[w,p,d,_]),!o||o[E]==="attention")for(let A of["key","value"])n[`${s}.${E}.${A}`]=[w,l,0,g];return n}return wv(t,e)}function wv(t,{prefix:e="past_key_values",batch_size:s=1}={}){let r={},n=t.normalized_config;if(n.is_encoder_decoder&&"num_encoder_heads"in n&&"num_decoder_heads"in n){let o=n.encoder_dim_kv??n.encoder_hidden_size/n.num_encoder_heads,a=n.decoder_dim_kv??n.decoder_hidden_size/n.num_decoder_heads,i=[s,n.num_encoder_heads,0,o],l=[s,n.num_decoder_heads,0,a];for(let c=0;c<n.num_decoder_layers;++c)r[`${e}.${c}.encoder.key`]=i,r[`${e}.${c}.encoder.value`]=i,r[`${e}.${c}.decoder.key`]=l,r[`${e}.${c}.decoder.value`]=l}else{let o=n.num_heads,a=n.num_layers,i=n.dim_kv??n.hidden_size/(n.num_attention_heads??o);if(n.model_type==="falcon"){let l=[s*o,0,i];for(let c=0;c<a;++c)r[`${e}.${c}.key`]=l,r[`${e}.${c}.value`]=l}else if(n.multi_query){let l=[s*o,0,2*i];for(let c=0;c<a;++c)r[`${e}.${c}.key_value`]=l}else if(n.model_type==="bloom"){let l=[s*o,i,0],c=[s*o,0,i];for(let u=0;u<a;++u)r[`${e}.${u}.key`]=l,r[`${e}.${u}.value`]=c}else if(n.model_type==="openelm")for(let l=0;l<a;++l){let c=[s,o[l],0,i];r[`${e}.${l}.key`]=c,r[`${e}.${l}.value`]=c}else{let l=[s,o,0,i];for(let c=0;c<a;++c)r[`${e}.${c}.key`]=l,r[`${e}.${c}.value`]=l}}return r}var Oa=class t{model_type=null;is_encoder_decoder=!1;max_position_embeddings;"transformers.js_config";constructor(e){Object.assign(this,e),this.normalized_config=Is(this)}static async from_pretrained(e,{progress_callback:s=null,config:r=null,cache_dir:n=null,local_files_only:o=!1,revision:a="main"}={}){r&&!(r instanceof t)&&(r=new t(r));let i=r??await gv(e,{progress_callback:s,config:r,cache_dir:n,local_files_only:o,revision:a});return new this(i)}},Yt=class{static async from_pretrained(...e){return Oa.from_pretrained(...e)}};async function sy(t,e,s,r){let n=`${e}${r}.onnx`,o=`${s.subfolder??""}/${n}`;return await lr(t,o,!0,s,ee.IS_NODE_ENV)}async function ry(t,e,s,r,n,o={}){let a=`${e}${s}.onnx`,i=ee.IS_NODE_ENV,l=[];if(n){let c;typeof n=="object"?n.hasOwnProperty(a)?c=n[a]:n.hasOwnProperty(e)?c=n[e]:c=!1:c=n;let u=+c;if(u>Wo)throw new Error(`The number of external data chunks (${u}) exceeds the maximum allowed value (${Wo}).`);for(let p=0;p<u;++p){let d=`${a}_data${p===0?"":"_"+p}`,_=`${r.subfolder??""}/${d}`;l.push(new Promise(async(m,h)=>{let x=await lr(t,_,!0,r,i);m(x instanceof Uint8Array?{path:d,data:x}:d)}))}}else o.externalData!==void 0&&(l=o.externalData.map(async c=>{if(typeof c.data=="string"){let u=await lr(t,c.data,!0,r);return{...c,data:u}}return c}));return Promise.all(l)}async function yv(t,e,s,r=!1){let n=s.config?.["transformers.js_config"]??{},o=s.device??n.device;o&&typeof o!="string"&&(o.hasOwnProperty(e)?o=o[e]:(console.warn(`device not specified for "${e}". Using the default device.`),o=null));let a=o??(ee.IS_NODE_ENV?"cpu":"wasm"),i=zw(a),l=n.device_config??{};l.hasOwnProperty(a)&&(n={...n,...l[a]});let c=s.dtype??n.dtype;if(typeof c!="string"&&(c&&c.hasOwnProperty(e)?c=c[e]:(c=Kl[a]??Ne.fp32,console.warn(`dtype not specified for "${e}". Using the default dtype (${c}) for this device (${a}).`))),c===Ne.auto){let A=n.dtype;typeof A!="string"&&(A=A?.[e]),A&&A!==Ne.auto&&Ne.hasOwnProperty(A)?c=A:c=Kl[a]??Ne.fp32}let u=c;if(Ql.hasOwnProperty(u)){if(a==="webgpu"&&!ee.IS_NODE_ENV&&u===Ne.fp16&&!await Nw())throw new Error(`The device (${a}) does not support fp16.`)}else throw new Error(`Invalid dtype: ${u}. Should be one of: ${Object.keys(Ne).join(", ")}`);let p=n.kv_cache_dtype,d=p?typeof p=="string"?p:p[u]??"float32":void 0;if(d&&!["float32","float16"].includes(d))throw new Error(`Invalid kv_cache_dtype: ${d}. Should be one of: float32, float16`);let _=Ql[u],m={...s.session_options};m.executionProviders??=i;let h=n.free_dimension_overrides;h?m.freeDimensionOverrides??=h:a.startsWith("webnn")&&!m.freeDimensionOverrides&&console.warn(`WebNN does not currently support dynamic shapes and requires 'free_dimension_overrides' to be set in config.json, preferably as a field within config["transformers.js_config"]["device_config"]["${a}"]. When 'free_dimension_overrides' is not set, you may experience significant performance degradation.`);let x=sy(t,e,s,_),g=s.use_external_data_format??n.use_external_data_format,w=await ry(t,e,_,s,g,m);if(w.length>0&&!ee.IS_NODE_ENV&&(m.externalData=w),r&&a==="webgpu"&&p!==!1){let A=Ia(s.config,{prefix:"present"});if(Object.keys(A).length>0&&!ur()){let b={};for(let O in A)b[O]="gpu-buffer";m.preferredOutputLocation=b}}return{buffer_or_path:await x,session_options:m,session_config:{dtype:u,kv_cache_dtype:d,device:a}}}async function Fe(t,e,s,r=void 0){return Object.fromEntries(await Promise.all(Object.keys(e).map(async n=>{let{buffer_or_path:o,session_options:a,session_config:i}=await yv(t,e[n],s,n===r),l=await Qo(o,a,i);return[n,l]})))}function ny(t){for(let e in t)Yo(t[e])?t[e]=new S(t[e]):typeof t[e]=="object"&&ny(t[e]);return t}async function q(t,e){let s=bv(t,e);try{let r=Object.fromEntries(Object.entries(s).map(([o,a])=>{let i=a.ort_tensor;return ee.IS_NODE_ENV&&typeof Float16Array<"u"&&i.cpuData instanceof Float16Array&&(i.cpuData=new Uint16Array(i.cpuData.buffer)),[o,i]})),n=await Jo(t,r);return ny(n)}catch(r){let n=Object.fromEntries(Object.entries(s).map(([o,a])=>{let i={type:a.type,dims:a.dims,location:a.location};return i.location!=="gpu-buffer"&&(i.data=a.data),[o,i]}));throw console.error(`An error occurred during model execution: "${r}".`),console.error("Inputs given to model:",n),r}}function bv(t,e){let s=Object.create(null),r=[];for(let a of t.inputNames){let i=e[a];if(!(i instanceof S)){r.push(a);continue}s[a]=ur()?i.clone():i}if(r.length>0)throw new Error(`An error occurred during model execution: "Missing the following inputs: ${r.join(", ")}.`);let n=Object.keys(e).length,o=t.inputNames.length;if(n>o){let a=Object.keys(e).filter(i=>!t.inputNames.includes(i));console.warn(`WARNING: Too many inputs were provided (${n} > ${o}). The following inputs will be ignored: "${a.join(", ")}".`)}return s}var pe=class{};var z=class extends pe{constructor({logits:e,...s}){super(),this.logits=e;let r=Object.values(s);r.length>0&&(this.attentions=r)}},K=class extends pe{constructor({logits:e}){super(),this.logits=e}},J=class extends pe{constructor({logits:e}){super(),this.logits=e}},oe=class extends pe{constructor({start_logits:e,end_logits:s}){super(),this.start_logits=e,this.end_logits=s}},$e=class extends pe{constructor({logits:e}){super(),this.logits=e}};var za=class extends pe{constructor({alphas:e}){super(),this.alphas=e}};var Qe=class extends ke{_call(e,s){throw Error("`_call` should be implemented in a subclass")}},vr=class extends ke{_call(e,s){throw Error("`_call` should be implemented in a subclass")}},Zt=class extends ke{constructor(){super(),this.processors=[]}push(e){this.processors.push(e)}extend(e){this.processors.push(...e)}_call(e,s){let r=s;for(let n of this.processors)r=n(e,r);return r}[Symbol.iterator](){return this.processors.values()}},Ta=class extends Qe{constructor(e){super(),this.bos_token_id=e}_call(e,s){for(let r=0;r<e.length;++r)if(e[r].length===1){let n=s[r].data;n.fill(-1/0),n[this.bos_token_id]=0}return s}},Pa=class extends Qe{constructor(e,s){super(),this.max_length=e,this.eos_token_id=Array.isArray(s)?s:[s]}_call(e,s){for(let r=0;r<e.length;++r)if(e[r].length===this.max_length-1){let n=s[r].data;n.fill(-1/0);for(let o of this.eos_token_id)n[o]=0}return s}},zs=class extends Qe{constructor(e,s){super(),this.begin_suppress_tokens=e,this.begin_index=s}_call(e,s){for(let r=0;r<e.length;++r)if(e[r].length===this.begin_index){let n=s[r].data;for(let o of this.begin_suppress_tokens)n[o]=-1/0}return s}},Ca=class extends Qe{constructor(e,s){super(),this.eos_token_id=Array.isArray(e.eos_token_id)?e.eos_token_id[0]:e.eos_token_id,this.no_timestamps_token_id=e.no_timestamps_token_id,this.timestamp_begin=this.no_timestamps_token_id+1,this.begin_index=s.length,s.at(-1)===this.no_timestamps_token_id&&(this.begin_index-=1),this.max_initial_timestamp_index=e.max_initial_timestamp_index}_call(e,s){for(let r=0;r<e.length;++r){let n=s[r].data;if(n[this.no_timestamps_token_id]=-1/0,e[r].length===this.begin_index-1){n.fill(-1/0),n[this.timestamp_begin]=0;continue}let o=e[r].slice(this.begin_index),a=o.length>=1&&o[o.length-1]>=this.timestamp_begin,i=o.length<2||o[o.length-2]>=this.timestamp_begin;if(a&&(i?n.subarray(this.timestamp_begin).fill(-1/0):n.subarray(0,this.eos_token_id).fill(-1/0)),e[r].length===this.begin_index&&this.max_initial_timestamp_index!==null){let p=this.timestamp_begin+this.max_initial_timestamp_index;n.subarray(p+1).fill(-1/0)}let l=Gl(n),c=Math.log(l.subarray(this.timestamp_begin).map(Math.exp).reduce((p,d)=>p+d)),u=ae(l.subarray(0,this.timestamp_begin))[0];c>u&&n.subarray(0,this.timestamp_begin).fill(-1/0)}return s}},Na=class extends Qe{constructor(e){super(),this.no_repeat_ngram_size=e}getNgrams(e){let s=e.length,r=[];for(let o=0;o<s+1-this.no_repeat_ngram_size;++o){let a=[];for(let i=0;i<this.no_repeat_ngram_size;++i)a.push(e[o+i]);r.push(a.map(Number))}let n=new Map;for(let o of r){let a=o.slice(0,o.length-1),i=JSON.stringify(a),l=n.get(i)??[];l.push(o[o.length-1]),n.set(i,l)}return n}getGeneratedNgrams(e,s){let r=s.slice(s.length+1-this.no_repeat_ngram_size,s.length);return e.get(JSON.stringify(r.map(Number)))??[]}calcBannedNgramTokens(e){let s=[];if(e.length+1<this.no_repeat_ngram_size)return s;{let r=this.getNgrams(e);return this.getGeneratedNgrams(r,e)}}_call(e,s){for(let r=0;r<e.length;++r){let n=s[r].data,o=this.calcBannedNgramTokens(e[r]);for(let a of o)n[a]=-1/0}return s}},La=class extends Qe{constructor(e){super(),this.penalty=e}_call(e,s){for(let r=0;r<e.length;++r){let n=s[r].data;for(let o of new Set(e[r])){let a=Number(o);n[a]<0?n[a]*=this.penalty:n[a]/=this.penalty}}return s}},$a=class extends Qe{constructor(e,s){super(),this.min_length=e,this.eos_token_id=Array.isArray(s)?s:[s]}_call(e,s){for(let r=0;r<e.length;++r)if(e[r].length<this.min_length){let n=s[r].data;for(let o of this.eos_token_id)n[o]=-1/0}return s}},Ra=class extends Qe{constructor(e,s,r){super(),this.prompt_length_to_skip=e,this.min_new_tokens=s,this.eos_token_id=Array.isArray(r)?r:[r]}_call(e,s){for(let r=0;r<e.length;++r)if(e[r].length-this.prompt_length_to_skip<this.min_new_tokens){let o=s[r].data;for(let a of this.eos_token_id)o[a]=-1/0}return s}},Fa=class extends Qe{constructor(e,s){super(),this.bad_words_ids=e,this.eos_token_id=Array.isArray(s)?s:[s]}_call(e,s){for(let r=0;r<e.length;++r){let n=s[r].data,o=e[r];for(let a of this.bad_words_ids){if(o.length<a.length-1)continue;let i=!0;for(let l=1;l<=a.length-1;++l)if(a.at(-l-1)!=o.at(-l)){i=!1;break}i&&(n[a.at(-1)]=-1/0)}}return s}},Da=class extends Qe{constructor(e){if(super(),e<=1)throw new Error(`Require guidance scale >1 to use the classifier free guidance processor, got guidance scale ${e}.`);this.guidance_scale=e}_call(e,s){if(s.dims[0]!==2*e.length)throw new Error(`Logits should have twice the batch size of the input ids, the first half of batches corresponding to the conditional inputs, and the second half of batches corresponding to the unconditional inputs. Got batch size ${s.dims[0]} for the logits and ${e.length} for the input ids.`);let r=e.length,n=s.slice([0,r],null),o=s.slice([r,s.dims[0]],null);for(let a=0;a<o.data.length;++a)o.data[a]+=(n.data[a]-o.data[a])*this.guidance_scale;return o}},ja=class extends vr{constructor(e){if(super(),typeof e!="number"||e<=0){let s=`\`temperature\` (=${e}) must be a strictly positive float, otherwise your next token scores will be invalid.`;e===0&&(s+=" If you're looking for greedy decoding strategies, set `do_sample=false`.")}this.temperature=e}_call(e,s){let r=s.data;for(let n=0;n<r.length;++n)r[n]/=this.temperature;return s}},oy=class extends vr{constructor(e,{filter_value:s=-1/0,min_tokens_to_keep:r=1}={}){if(super(),e<0||e>1)throw new Error(`\`top_p\` must be a float > 0 and < 1, but is ${e}`);if(!Number.isInteger(r)||r<1)throw new Error(`\`min_tokens_to_keep\` must be a positive integer, but is ${r}`);this.top_p=e,this.filter_value=s,this.min_tokens_to_keep=r}},ay=class extends vr{constructor(e,{filter_value:s=-1/0,min_tokens_to_keep:r=1}={}){if(super(),!Number.isInteger(e)||e<0)throw new Error(`\`top_k\` must be a positive integer, but is ${e}`);this.top_k=Math.max(e,r),this.filter_value=s}};var Ts=class{max_length=20;max_new_tokens=null;min_length=0;min_new_tokens=null;early_stopping=!1;max_time=null;do_sample=!1;num_beams=1;num_beam_groups=1;penalty_alpha=null;use_cache=!0;temperature=1;top_k=50;top_p=1;typical_p=1;epsilon_cutoff=0;eta_cutoff=0;diversity_penalty=0;repetition_penalty=1;encoder_repetition_penalty=1;length_penalty=1;no_repeat_ngram_size=0;bad_words_ids=null;force_words_ids=null;renormalize_logits=!1;constraints=null;forced_bos_token_id=null;forced_eos_token_id=null;remove_invalid_values=!1;exponential_decay_length_penalty=null;suppress_tokens=null;streamer=null;begin_suppress_tokens=null;forced_decoder_ids=null;guidance_scale=null;num_return_sequences=1;output_attentions=!1;output_hidden_states=!1;output_scores=!1;return_dict_in_generate=!1;pad_token_id=null;bos_token_id=null;eos_token_id=null;encoder_no_repeat_ngram_size=0;decoder_start_token_id=null;generation_kwargs={};constructor(e){Object.assign(this,Me(e,Object.getOwnPropertyNames(this)))}};var Ps=class extends ke{_call(e,s){throw Error("StoppingCriteria needs to be subclassed")}},Ba=class t extends ke{constructor(){super(),this.criteria=[]}push(e){this.criteria.push(e)}extend(e){e instanceof t?e=e.criteria:e instanceof Ps&&(e=[e]),this.criteria.push(...e)}_call(e,s){let r=new Array(e.length).fill(!1);for(let n of this.criteria){let o=n(e,s);for(let a=0;a<r.length;++a)r[a]||=o[a]}return r}[Symbol.iterator](){return this.criteria.values()}},Ua=class extends Ps{constructor(e,s=null){super(),this.max_length=e,this.max_position_embeddings=s}_call(e){return e.map(s=>s.length>=this.max_length)}},qa=class extends Ps{constructor(e){super(),Array.isArray(e)||(e=[e]),this.eos_token_id=e}_call(e,s){return e.map(r=>{let n=r.at(-1);return this.eos_token_id.some(o=>n==o)})}},iy=class extends Ps{constructor(){super(),this.interrupted=!1}interrupt(){this.interrupted=!0}reset(){this.interrupted=!1}_call(e,s){return new Array(e.length).fill(this.interrupted)}};var es=class extends ke{constructor(e){super(),this.generation_config=e}async _call(e){return this.sample(e)}async sample(e){throw Error("sample should be implemented in subclasses.")}getLogits(e,s){let r=e.dims.at(-1),n=e.data;if(s===-1)n=n.slice(-r);else{let o=s*r;n=n.slice(o,o+r)}return n}randomSelect(e){let s=0;for(let n=0;n<e.length;++n)s+=e[n];let r=Math.random()*s;for(let n=0;n<e.length;++n)if(r-=e[n],r<=0)return n;return 0}static getSampler(e){if(e.do_sample)return new kp(e);if(e.num_beams>1)return new vp(e);if(e.num_return_sequences>1)throw Error(`num_return_sequences has to be 1 when doing greedy search, but is ${e.num_return_sequences}.`);return new bp(e)}},bp=class extends es{async sample(e){let s=ae(e.data)[1];return[[BigInt(s),0]]}},kp=class extends es{async sample(e){let s=e.dims.at(-1);this.generation_config.top_k>0&&(s=Math.min(this.generation_config.top_k,s));let[r,n]=await ot(e,s),o=ue(r.data);return Array.from({length:this.generation_config.num_beams},()=>{let a=this.randomSelect(o);return[n.data[a],Math.log(o[a])]})}},vp=class extends es{async sample(e){let s=e.dims.at(-1);this.generation_config.top_k>0&&(s=Math.min(this.generation_config.top_k,s));let[r,n]=await ot(e,s),o=ue(r.data);return Array.from({length:this.generation_config.num_beams},(a,i)=>[n.data[i],Math.log(o[i])])}};var Er=null;function cy(t){Er=t}function Ep(t){if(t instanceof S)return t;if(t.length===0)throw Error("items must be non-empty");if(Array.isArray(t[0])){if(t.some(e=>e.length!==t[0].length))throw Error("Unable to create tensor, you should probably activate truncation and/or padding with 'padding=True' and/or 'truncation=True' to have batched tensors with the same length.");return new S("int64",BigInt64Array.from(t.flat().map(e=>BigInt(e))),[t.length,t[0].length])}else return new S("int64",BigInt64Array.from(t.map(e=>BigInt(e))),[1,t.length])}function Ap(t){return new S("bool",[t],[1])}var C={EncoderOnly:0,EncoderDecoder:1,Seq2Seq:2,Vision2Seq:3,DecoderOnly:4,DecoderOnlyWithoutHead:5,MaskGeneration:6,ImageTextToText:7,Musicgen:8,MultiModality:9,Phi3V:10,AudioTextToText:11,AutoEncoder:12,ImageAudioTextToText:13,Supertonic:14,Chatterbox:15},ly={[C.DecoderOnly]:{can_generate:!0,forward:Ue,prepare_inputs:Ar},[C.DecoderOnlyWithoutHead]:{can_generate:!1,forward:Ue,prepare_inputs:Ar},[C.Seq2Seq]:{can_generate:!0,forward:Ga,prepare_inputs:Mr},[C.Vision2Seq]:{can_generate:!0,forward:Ga,prepare_inputs:Mr},[C.Musicgen]:{can_generate:!0,forward:Ga},[C.EncoderDecoder]:{can_generate:!1,forward:Ga},[C.ImageTextToText]:{can_generate:!0,forward:Ev,prepare_inputs:Wa},[C.AudioTextToText]:{can_generate:!0,forward:vv,prepare_inputs:Wa},[C.Phi3V]:{can_generate:!0,prepare_inputs:Wa},[C.ImageAudioTextToText]:{can_generate:!0,prepare_inputs:Wa},[C.MultiModality]:{can_generate:!0},[C.AutoEncoder]:{can_generate:!1,forward:kv},[C.Chatterbox]:{can_generate:!0,forward:Je},default:{can_generate:!1,forward:Je}},ss=new Map,Va=new Map,ts=new Map,f=class extends ke{main_input_name="input_ids";forward_params=["input_ids","attention_mask"];_return_dict_in_generate_keys=null;constructor(e,s,r){super(),this.config=e,this.sessions=s,this.configs=r;let n=ts.get(this.constructor),o=ss.get(n),a=ly[o]??ly.default;this.can_generate=a.can_generate,this._forward=a.forward,this._prepare_inputs_for_generation=a.prepare_inputs,this.can_generate&&this.forward_params.push("past_key_values"),this.custom_config=this.config["transformers.js_config"]??{}}async dispose(){let e=[];for(let s of Object.values(this.sessions))e.push(s.release?.());return await Promise.all(e)}static async from_pretrained(e,{progress_callback:s=null,config:r=null,cache_dir:n=null,local_files_only:o=!1,revision:a="main",model_file_name:i=null,subfolder:l="onnx",device:c=null,dtype:u=null,use_external_data_format:p=null,session_options:d={}}={}){let _={progress_callback:s,config:r,cache_dir:n,local_files_only:o,revision:a,model_file_name:i,subfolder:l,device:c,dtype:u,use_external_data_format:p,session_options:d},m=ts.get(this),h=ss.get(m);r=_.config=await Yt.from_pretrained(e,_);let x;if(h===C.DecoderOnly)x=await Promise.all([Fe(e,{model:_.model_file_name??"model"},_,"model"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.Seq2Seq||h===C.Vision2Seq)x=await Promise.all([Fe(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},_,"decoder_model_merged"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.MaskGeneration)x=await Promise.all([Fe(e,{model:"vision_encoder",prompt_encoder_mask_decoder:"prompt_encoder_mask_decoder"},_)]);else if(h===C.EncoderDecoder)x=await Promise.all([Fe(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},_,"decoder_model_merged")]);else if(h===C.ImageTextToText){let g={embed_tokens:"embed_tokens",vision_encoder:"vision_encoder",decoder_model_merged:"decoder_model_merged"};r.is_encoder_decoder&&(g.model="encoder_model"),x=await Promise.all([Fe(e,g,_,"decoder_model_merged"),bt(e,{generation_config:"generation_config.json"},_)])}else if(h===C.AudioTextToText){let g={embed_tokens:"embed_tokens",audio_encoder:"audio_encoder",decoder_model_merged:"decoder_model_merged"};x=await Promise.all([Fe(e,g,_,"decoder_model_merged"),bt(e,{generation_config:"generation_config.json"},_)])}else if(h===C.ImageAudioTextToText){let g={embed_tokens:"embed_tokens",audio_encoder:"audio_encoder",vision_encoder:"vision_encoder",decoder_model_merged:"decoder_model_merged"};x=await Promise.all([Fe(e,g,_),bt(e,{generation_config:"generation_config.json"},_)])}else if(h===C.Musicgen)x=await Promise.all([Fe(e,{model:"text_encoder",decoder_model_merged:"decoder_model_merged",encodec_decode:"encodec_decode"},_,"decoder_model_merged"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.MultiModality)x=await Promise.all([Fe(e,{prepare_inputs_embeds:"prepare_inputs_embeds",model:"language_model",lm_head:"lm_head",gen_head:"gen_head",gen_img_embeds:"gen_img_embeds",image_decode:"image_decode"},_,"model"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.Phi3V)x=await Promise.all([Fe(e,{prepare_inputs_embeds:"prepare_inputs_embeds",model:"model",vision_encoder:"vision_encoder"},_,"model"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.Chatterbox)x=await Promise.all([Fe(e,{embed_tokens:"embed_tokens",speech_encoder:"speech_encoder",model:"language_model",conditional_decoder:"conditional_decoder"},_,"model"),bt(e,{generation_config:"generation_config.json"},_)]);else if(h===C.AutoEncoder)x=await Promise.all([Fe(e,{encoder_model:"encoder_model",decoder_model:"decoder_model"},_)]);else if(h===C.Supertonic)x=await Promise.all([Fe(e,{text_encoder:"text_encoder",latent_denoiser:"latent_denoiser",voice_decoder:"voice_decoder"},_)]);else{if(h===void 0){let g=m??r?.model_type;g!=="custom"&&console.warn(`Model type for '${g}' not found, assuming encoder-only architecture. Please report this at ${bs}.`)}x=await Promise.all([Fe(e,{model:_.model_file_name??"model"},_)])}return new this(r,...x)}async _call(e){return await this.forward(e)}async forward(e){return await this._forward(this,e)}get generation_config(){return this.configs?.generation_config??null}_get_logits_processor(e,s,r=null){let n=new Zt;if(e.repetition_penalty!==null&&e.repetition_penalty!==1&&n.push(new La(e.repetition_penalty)),e.no_repeat_ngram_size!==null&&e.no_repeat_ngram_size>0&&n.push(new Na(e.no_repeat_ngram_size)),e.bad_words_ids!==null&&n.push(new Fa(e.bad_words_ids,e.eos_token_id)),e.min_length!==null&&e.eos_token_id!==null&&e.min_length>0&&n.push(new $a(e.min_length,e.eos_token_id)),e.min_new_tokens!==null&&e.eos_token_id!==null&&e.min_new_tokens>0&&n.push(new Ra(s,e.min_new_tokens,e.eos_token_id)),e.forced_bos_token_id!==null&&n.push(new Ta(e.forced_bos_token_id)),e.forced_eos_token_id!==null&&n.push(new Pa(e.max_length,e.forced_eos_token_id)),e.begin_suppress_tokens!==null){let o=s>1||e.forced_bos_token_id===null?s:s+1;n.push(new zs(e.begin_suppress_tokens,o))}return e.guidance_scale!==null&&e.guidance_scale>1&&n.push(new Da(e.guidance_scale)),e.temperature===0&&e.do_sample&&(console.warn("`do_sample` changed to false because `temperature: 0` implies greedy sampling (always selecting the most likely token), which is incompatible with `do_sample: true`."),e.do_sample=!1),e.do_sample&&e.temperature!==null&&e.temperature!==1&&n.push(new ja(e.temperature)),r!==null&&n.extend(r),n}_prepare_generation_config(e,s,r=Ts){let n={...this.config};for(let a of["decoder","generator","text_config"])a in n&&Object.assign(n,n[a]);let o=new r(n);return Object.assign(o,this.generation_config??{}),e&&Object.assign(o,e),s&&Object.assign(o,Me(s,Object.getOwnPropertyNames(o))),o}_get_stopping_criteria(e,s=null){let r=new Ba;return e.max_length!==null&&r.push(new Ua(e.max_length,this.config.max_position_embeddings??null)),e.eos_token_id!==null&&r.push(new qa(e.eos_token_id)),s&&r.extend(s),r}_validate_model_class(){if(!this.can_generate){let e=[Er.MODEL_FOR_CAUSAL_LM_MAPPING_NAMES,Er.MODEL_FOR_VISION_2_SEQ_MAPPING_NAMES,Er.MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING_NAMES,Er.MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING_NAMES].filter(Boolean),s=ts.get(this.constructor),r=new Set,n=this.config.model_type;for(let a of e){let i=a?.get(n);i&&r.add(i)}let o=`The current model class (${s}) is not compatible with \`.generate()\`, as it doesn't have a language model head.`;throw r.size>0&&(o+=` Please use the following class instead: ${[...r].join(", ")}`),Error(o)}}prepare_inputs_for_generation(...e){if(!this._prepare_inputs_for_generation)throw new Error("prepare_inputs_for_generation is not implemented for this model.");return this._prepare_inputs_for_generation(this,...e)}_update_model_kwargs_for_generation({generated_input_ids:e,outputs:s,model_inputs:r,is_encoder_decoder:n}){return r.past_key_values=this.getPastKeyValues(s,r.past_key_values),r.input_ids=new S("int64",e.flat(),[e.length,1]),n?"decoder_attention_mask"in r:r.attention_mask=ne([r.attention_mask,Oe([r.attention_mask.dims[0],1])],1),r.position_ids=null,r}_prepare_model_inputs({inputs:e,bos_token_id:s,model_kwargs:r}){let n=Me(r,this.forward_params),o=this.main_input_name;if(o in n){if(e)throw new Error("`inputs`: {inputs}` were passed alongside {input_name} which is not allowed. Make sure to either pass {inputs} or {input_name}=...")}else n[o]=e;return{inputs_tensor:n[o],model_inputs:n,model_input_name:o}}async _prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:e,model_inputs:s,model_input_name:r,generation_config:n}){if(this.sessions.model.inputNames.includes("inputs_embeds")&&!s.inputs_embeds&&"_prepare_inputs_embeds"in this){let{input_ids:a,pixel_values:i,attention_mask:l,...c}=s,u=await this._prepare_inputs_embeds(s);s={...c,...Me(u,["inputs_embeds","attention_mask"])}}let{last_hidden_state:o}=await Je(this,s);if(n.guidance_scale!==null&&n.guidance_scale>1)o=ne([o,dr(o,0)],0),"attention_mask"in s&&(s.attention_mask=ne([s.attention_mask,sc(s.attention_mask)],0));else if(s.decoder_input_ids){let a=Ep(s.decoder_input_ids).dims[0];if(a!==o.dims[0]){if(o.dims[0]!==1)throw new Error(`The encoder outputs have a different batch size (${o.dims[0]}) than the decoder inputs (${a}).`);o=ne(Array.from({length:a},()=>o),0)}}return s.encoder_outputs=o,s}_prepare_decoder_input_ids_for_generation({batch_size:e,model_input_name:s,model_kwargs:r,decoder_start_token_id:n,bos_token_id:o,generation_config:a}){let{decoder_input_ids:i,...l}=r;if(!(i instanceof S)){if(i)Array.isArray(i[0])||(i=Array.from({length:e},()=>i));else if(n??=o,this.config.model_type==="musicgen")i=Array.from({length:e*this.config.decoder.num_codebooks},()=>[n]);else if(Array.isArray(n)){if(n.length!==e)throw new Error(`\`decoder_start_token_id\` expcted to have length ${e} but got ${n.length}`);i=n}else i=Array.from({length:e},()=>[n]);i=Ep(i)}return r.decoder_attention_mask=sa(i),{input_ids:i,model_inputs:l}}async generate({inputs:e=null,generation_config:s=null,logits_processor:r=null,stopping_criteria:n=null,streamer:o=null,...a}){this._validate_model_class(),s=this._prepare_generation_config(s,a);let{inputs_tensor:i,model_inputs:l,model_input_name:c}=this._prepare_model_inputs({inputs:e,model_kwargs:a}),u=this.config.is_encoder_decoder;u&&("encoder_outputs"in l||(l=await this._prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:i,model_inputs:l,model_input_name:c,generation_config:s})));let p;u?{input_ids:p,model_inputs:l}=this._prepare_decoder_input_ids_for_generation({batch_size:l[c].dims.at(0),model_input_name:c,model_kwargs:l,decoder_start_token_id:s.decoder_start_token_id,bos_token_id:s.bos_token_id,generation_config:s}):p=l[c];let d=p.dims.at(-1);s.max_new_tokens!==null&&(s.max_length=d+s.max_new_tokens);let _=this._get_logits_processor(s,d,r),m=this._get_stopping_criteria(s,n),h=l[c].dims.at(0),x=es.getSampler(s),g=new Array(h).fill(0),w=p.tolist();o&&o.put(w);let y,E={},A={};for(;;){if(l=this.prepare_inputs_for_generation(w,l,s),y=await this.forward(l),s.return_dict_in_generate)if(s.output_attentions){let G=this.getAttentions(y);for(let D in G)D in E||(E[D]=[]),E[D].push(G[D])}else this._return_dict_in_generate_keys&&Object.assign(A,Me(y,this._return_dict_in_generate_keys));let N=y.logits.slice(null,-1,null).to("float32"),F=_(w,N),R=[];for(let G=0;G<F.dims.at(0);++G){let D=F[G],X=await x(D);for(let[V,re]of X){let Y=BigInt(V);g[G]+=re,w[G].push(Y),R.push([Y]);break}}if(o&&o.put(R),m(w).every(G=>G))break;l=this._update_model_kwargs_for_generation({generated_input_ids:R,outputs:y,model_inputs:l,is_encoder_decoder:u})}o&&o.end();let b=this.getPastKeyValues(y,l.past_key_values,!0),O=new S("int64",w.flat(),[w.length,w[0].length]);if(s.return_dict_in_generate)return{sequences:O,past_key_values:b,...E,...A};for(let N of Object.values(y))N.location==="gpu-buffer"&&N.dispose();return O}getPastKeyValues(e,s,r=!1){let n=Object.create(null);for(let o in e)if(o.startsWith("present")){let a=o.replace("present_ssm","past_ssm").replace("present_conv","past_conv").replace("present","past_key_values"),i=o.includes("encoder");if(i&&s?n[a]=s[a]:n[a]=e[o],s&&(!i||r)){let l=s[a];l.location==="gpu-buffer"&&l.dispose()}}return n}getAttentions(e){let s={};for(let r of["cross_attentions","encoder_attentions","decoder_attentions"])for(let n in e)n.startsWith(r)&&(r in s||(s[r]=[]),s[r].push(e[n]));return s}addPastKeyValues(e,s){if(s)Object.assign(e,s);else{let r=this.sessions.decoder_model_merged??this.sessions.model,n=(e[this.main_input_name]??e.attention_mask)?.dims?.[0]??1,o=r?.config?.kv_cache_dtype??"float32",a=o==="float16"?ws.float16:ws.float32,i=Ia(this.config,{batch_size:n});for(let l in i){let c=i[l].reduce((u,p)=>u*p,1);e[l]=new S(o,new a(c),i[l])}}}async encode_image({pixel_values:e}){return(await q(this.sessions.vision_encoder,{pixel_values:e})).image_features}async encode_text({input_ids:e}){return(await q(this.sessions.embed_tokens,{input_ids:e})).inputs_embeds}async encode_audio({audio_values:e}){return(await q(this.sessions.audio_encoder,{audio_values:e})).audio_features}};async function Ga(t,e){let{encoder_outputs:s,input_ids:r,decoder_input_ids:n,...o}=e;if(!s){let a=Me(e,t.sessions.model.inputNames);s=(await Je(t,a)).last_hidden_state}return o.input_ids=n,o.encoder_hidden_states=s,t.sessions.decoder_model_merged.inputNames.includes("encoder_attention_mask")&&(o.encoder_attention_mask=e.attention_mask),await Ue(t,o,!0)}async function Je(t,e){let s=t.sessions.model,r=Me(e,s.inputNames);if(s.inputNames.includes("inputs_embeds")&&!r.inputs_embeds){if(!e.input_ids)throw new Error("Both `input_ids` and `inputs_embeds` are missing in the model inputs.");r.inputs_embeds=await t.encode_text({input_ids:e.input_ids})}if(s.inputNames.includes("token_type_ids")&&!r.token_type_ids){if(!r.input_ids)throw new Error("Both `input_ids` and `token_type_ids` are missing in the model inputs.");r.token_type_ids=sc(r.input_ids)}if(s.inputNames.includes("pixel_mask")&&!r.pixel_mask){if(!r.pixel_values)throw new Error("Both `pixel_values` and `pixel_mask` are missing in the model inputs.");let n=r.pixel_values.dims;r.pixel_mask=Oe([n[0],n[2],n[3]])}return await q(s,r)}async function kv(t,e){let s=await t.encode(e);return await t.decode(s)}async function Ue(t,e,s=!1){let r=t.sessions[s?"decoder_model_merged":"model"],{past_key_values:n,...o}=e;if(r.inputNames.includes("use_cache_branch")&&(o.use_cache_branch=Ap(!!n)),r.inputNames.includes("position_ids")&&o.attention_mask&&!o.position_ids){let i=["paligemma","gemma3_text","gemma3"].includes(t.config.model_type)?1:0;o.position_ids=Av(o,n,i)}t.addPastKeyValues(o,n);let a=Me(o,r.inputNames);return await q(r,a)}async function uy(t,{encode_function:e,merge_function:s,modality_input_name:r,modality_output_name:n,input_ids:o=null,attention_mask:a=null,position_ids:i=null,inputs_embeds:l=null,past_key_values:c=null,generation_config:u=null,logits_processor:p=null,...d}){let _=d[r];if(!l){if(l=await t.encode_text({input_ids:o,...d}),_&&o.dims[1]!==1){let h=await e({[r]:_,...d});({inputs_embeds:l,attention_mask:a}=s({[n]:h,inputs_embeds:l,input_ids:o,attention_mask:a}))}else if(c&&_&&o.dims[1]===1){let h=o.dims[1],x=Object.values(c)[0].dims.at(-2);a=ne([Oe([o.dims[0],x]),a.slice(null,[a.dims[1]-h,a.dims[1]])],1)}}if(!i&&t.config.model_type==="qwen2_vl"){let{image_grid_thw:h,video_grid_thw:x}=d;[i]=t.get_rope_index(o,h,x,a)}return await Ue(t,{inputs_embeds:l,past_key_values:c,attention_mask:a,position_ids:i,generation_config:u,logits_processor:p},!0)}async function vv(t,e){return await uy(t,{...e,modality_input_name:"audio_values",modality_output_name:"audio_features",encode_function:t.encode_audio.bind(t),merge_function:t._merge_input_ids_with_audio_features.bind(t)})}async function Ev(t,e){return await uy(t,{...e,modality_input_name:"pixel_values",modality_output_name:"image_features",encode_function:t.encode_image.bind(t),merge_function:t._merge_input_ids_with_image_features.bind(t)})}function Mp(t,e=0){let[s,r]=t.dims,n=t.data,o=new BigInt64Array(n.length);for(let a=0;a<s;++a){let i=a*r,l=BigInt(e);for(let c=0;c<r;++c){let u=i+c;n[u]===0n?o[u]=BigInt(1):(o[u]=l,l+=n[u])}}return{data:o,dims:t.dims}}function Av(t,e=null,s=0){let{input_ids:r,inputs_embeds:n,attention_mask:o}=t,{data:a,dims:i}=Mp(o,s),l=new S("int64",a,i);if(e){let c=-(r??n).dims.at(1);l=l.slice(null,[c,null])}return l}function Ar(t,e,s,r){let n=s.past_key_values?Object.values(s.past_key_values)[0].dims.at(-2):0;if(!s.attention_mask){let o;for(let a of["input_ids","inputs_embeds","position_ids"])if(s[a]){o=s[a].dims;break}if(!o)throw new Error("attention_mask is not provided, and unable to infer its shape from model inputs.");s.attention_mask=Oe([o[0],n+o[1]])}if(s.past_key_values){let{input_ids:o,attention_mask:a}=s;a&&a.dims[1]>o.dims[1]||n<o.dims[1]&&(s.input_ids=o.slice(null,[n,null]))}return s}function Mr(t,e,s,r){return s.past_key_values&&(e=e.map(n=>[n.at(-1)])),{...s,decoder_input_ids:Ep(e)}}function Wa(t,...e){return t.config.is_encoder_decoder?Mr(t,...e):Ar(t,...e)}function py({modality_token_id:t,inputs_embeds:e,modality_features:s,input_ids:r,attention_mask:n}){let o=r.tolist().map(c=>c.reduce((u,p,d)=>(p==t&&u.push(d),u),[])),a=o.reduce((c,u)=>c+u.length,0),i=s.dims[0];if(a!==i)throw new Error(`Number of tokens and features do not match: tokens: ${a}, features ${i}`);let l=0;for(let c=0;c<o.length;++c){let u=o[c],p=e[c];for(let d=0;d<u.length;++d)p[u[d]].data.set(s[l++].data)}return{inputs_embeds:e,attention_mask:n}}function _t({image_token_id:t,inputs_embeds:e,image_features:s,input_ids:r,attention_mask:n}){return py({modality_token_id:t,inputs_embeds:e,modality_features:s,input_ids:r,attention_mask:n})}function Ha({audio_token_id:t,inputs_embeds:e,audio_features:s,input_ids:r,attention_mask:n}){return py({modality_token_id:t,inputs_embeds:e,modality_features:s,input_ids:r,attention_mask:n})}async function bt(t,e,s){return Object.fromEntries(await Promise.all(Object.keys(e).map(async r=>{let n=await Se(t,e[r],!1,s);return[r,n]})))}var Io={};us(Io,{ASTForAudioClassification:()=>$p,ASTModel:()=>Lp,ASTPreTrainedModel:()=>Ir,AlbertForMaskedLM:()=>zp,AlbertForQuestionAnswering:()=>Ip,AlbertForSequenceClassification:()=>Op,AlbertModel:()=>Sp,AlbertPreTrainedModel:()=>rs,ApertusForCausalLM:()=>Pp,ApertusModel:()=>Tp,ApertusPreTrainedModel:()=>Sr,ArceeForCausalLM:()=>Np,ArceeModel:()=>Cp,ArceePreTrainedModel:()=>Or,BartForConditionalGeneration:()=>Fp,BartForSequenceClassification:()=>Dp,BartModel:()=>Rp,BartPretrainedModel:()=>Cs,BeitForImageClassification:()=>Bp,BeitModel:()=>jp,BeitPreTrainedModel:()=>zr,BertForMaskedLM:()=>qp,BertForQuestionAnswering:()=>Vp,BertForSequenceClassification:()=>Gp,BertForTokenClassification:()=>Wp,BertModel:()=>Up,BertPreTrainedModel:()=>Ot,BlenderbotForConditionalGeneration:()=>Xp,BlenderbotModel:()=>Hp,BlenderbotPreTrainedModel:()=>Tr,BlenderbotSmallForConditionalGeneration:()=>Qp,BlenderbotSmallModel:()=>Kp,BlenderbotSmallPreTrainedModel:()=>Pr,BloomForCausalLM:()=>Yp,BloomModel:()=>Jp,BloomPreTrainedModel:()=>Cr,CLIPModel:()=>ad,CLIPPreTrainedModel:()=>ft,CLIPSegForImageSegmentation:()=>pd,CLIPSegModel:()=>ud,CLIPSegPreTrainedModel:()=>Fr,CLIPTextModel:()=>id,CLIPTextModelWithProjection:()=>Rr,CLIPVisionModel:()=>ld,CLIPVisionModelWithProjection:()=>cd,CamembertForMaskedLM:()=>ed,CamembertForQuestionAnswering:()=>rd,CamembertForSequenceClassification:()=>td,CamembertForTokenClassification:()=>sd,CamembertModel:()=>Zp,CamembertPreTrainedModel:()=>It,ChatterboxModel:()=>Nr,ChatterboxPreTrainedModel:()=>Xa,ChineseCLIPModel:()=>nd,ChineseCLIPPreTrainedModel:()=>Ka,ClapAudioModelWithProjection:()=>$r,ClapModel:()=>od,ClapPreTrainedModel:()=>Ns,ClapTextModelWithProjection:()=>Lr,CodeGenForCausalLM:()=>_d,CodeGenModel:()=>dd,CodeGenPreTrainedModel:()=>Dr,Cohere2ForCausalLM:()=>xd,Cohere2Model:()=>hd,Cohere2PreTrainedModel:()=>Br,CohereForCausalLM:()=>md,CohereModel:()=>fd,CoherePreTrainedModel:()=>jr,ConvBertForMaskedLM:()=>wd,ConvBertForQuestionAnswering:()=>kd,ConvBertForSequenceClassification:()=>yd,ConvBertForTokenClassification:()=>bd,ConvBertModel:()=>gd,ConvBertPreTrainedModel:()=>zt,ConvNextForImageClassification:()=>Ed,ConvNextModel:()=>vd,ConvNextPreTrainedModel:()=>Ur,ConvNextV2ForImageClassification:()=>Md,ConvNextV2Model:()=>Ad,ConvNextV2PreTrainedModel:()=>qr,DFineForObjectDetection:()=>zd,DFineModel:()=>Id,DFinePreTrainedModel:()=>Wr,DINOv3ConvNextModel:()=>e_,DINOv3ConvNextPreTrainedModel:()=>si,DINOv3ViTModel:()=>t_,DINOv3ViTPreTrainedModel:()=>ri,DPTForDepthEstimation:()=>c_,DPTModel:()=>l_,DPTPreTrainedModel:()=>Jr,DacDecoderModel:()=>Hr,DacDecoderOutput:()=>Ja,DacEncoderModel:()=>Vr,DacEncoderOutput:()=>Qa,DacModel:()=>Td,DacPreTrainedModel:()=>Ls,DebertaForMaskedLM:()=>Cd,DebertaForQuestionAnswering:()=>$d,DebertaForSequenceClassification:()=>Nd,DebertaForTokenClassification:()=>Ld,DebertaModel:()=>Pd,DebertaPreTrainedModel:()=>Tt,DebertaV2ForMaskedLM:()=>Fd,DebertaV2ForQuestionAnswering:()=>Bd,DebertaV2ForSequenceClassification:()=>Dd,DebertaV2ForTokenClassification:()=>jd,DebertaV2Model:()=>Rd,DebertaV2PreTrainedModel:()=>Pt,DecisionTransformerModel:()=>Ud,DecisionTransformerPreTrainedModel:()=>Ya,DeiTForImageClassification:()=>Gd,DeiTModel:()=>qd,DeiTPreTrainedModel:()=>Xr,DepthAnythingForDepthEstimation:()=>Wd,DepthAnythingPreTrainedModel:()=>Za,DepthProForDepthEstimation:()=>Vd,DepthProPreTrainedModel:()=>ei,DetrForObjectDetection:()=>Xd,DetrForSegmentation:()=>Kd,DetrModel:()=>Hd,DetrObjectDetectionOutput:()=>Rs,DetrPreTrainedModel:()=>$s,DetrSegmentationOutput:()=>ti,Dinov2ForImageClassification:()=>Jd,Dinov2Model:()=>Qd,Dinov2PreTrainedModel:()=>Kr,Dinov2WithRegistersForImageClassification:()=>Zd,Dinov2WithRegistersModel:()=>Yd,Dinov2WithRegistersPreTrainedModel:()=>Qr,DistilBertForMaskedLM:()=>a_,DistilBertForQuestionAnswering:()=>o_,DistilBertForSequenceClassification:()=>r_,DistilBertForTokenClassification:()=>n_,DistilBertModel:()=>s_,DistilBertPreTrainedModel:()=>Ct,DonutSwinModel:()=>i_,DonutSwinPreTrainedModel:()=>ni,EdgeTamModel:()=>Hh,EfficientNetForImageClassification:()=>p_,EfficientNetModel:()=>u_,EfficientNetPreTrainedModel:()=>Yr,ElectraForMaskedLM:()=>__,ElectraForQuestionAnswering:()=>h_,ElectraForSequenceClassification:()=>f_,ElectraForTokenClassification:()=>m_,ElectraModel:()=>d_,ElectraPreTrainedModel:()=>Nt,Ernie4_5ForCausalLM:()=>g_,Ernie4_5Model:()=>x_,Ernie4_5PretrainedModel:()=>Zr,EsmForMaskedLM:()=>y_,EsmForSequenceClassification:()=>b_,EsmForTokenClassification:()=>k_,EsmModel:()=>w_,EsmPreTrainedModel:()=>ns,ExaoneForCausalLM:()=>E_,ExaoneModel:()=>v_,ExaonePreTrainedModel:()=>en,FalconForCausalLM:()=>M_,FalconH1ForCausalLM:()=>O_,FalconH1Model:()=>S_,FalconH1PreTrainedModel:()=>sn,FalconModel:()=>A_,FalconPreTrainedModel:()=>tn,FastViTForImageClassification:()=>z_,FastViTModel:()=>I_,FastViTPreTrainedModel:()=>rn,Florence2ForConditionalGeneration:()=>T_,Florence2PreTrainedModel:()=>oi,GLPNForDepthEstimation:()=>B_,GLPNModel:()=>j_,GLPNPreTrainedModel:()=>un,GPT2LMHeadModel:()=>J_,GPT2Model:()=>Q_,GPT2PreTrainedModel:()=>mn,GPTBigCodeForCausalLM:()=>q_,GPTBigCodeModel:()=>U_,GPTBigCodePreTrainedModel:()=>pn,GPTJForCausalLM:()=>Z_,GPTJModel:()=>Y_,GPTJPreTrainedModel:()=>hn,GPTNeoForCausalLM:()=>W_,GPTNeoModel:()=>G_,GPTNeoPreTrainedModel:()=>dn,GPTNeoXForCausalLM:()=>H_,GPTNeoXModel:()=>V_,GPTNeoXPreTrainedModel:()=>_n,Gemma2ForCausalLM:()=>L_,Gemma2Model:()=>N_,Gemma2PreTrainedModel:()=>on,Gemma3ForCausalLM:()=>R_,Gemma3Model:()=>$_,Gemma3PreTrainedModel:()=>an,Gemma3nForConditionalGeneration:()=>ln,Gemma3nPreTrainedModel:()=>ai,GemmaForCausalLM:()=>C_,GemmaModel:()=>P_,GemmaPreTrainedModel:()=>nn,GlmForCausalLM:()=>D_,GlmModel:()=>F_,GlmPreTrainedModel:()=>cn,GptOssForCausalLM:()=>K_,GptOssModel:()=>X_,GptOssPreTrainedModel:()=>fn,GraniteForCausalLM:()=>tf,GraniteModel:()=>ef,GraniteMoeHybridForCausalLM:()=>rf,GraniteMoeHybridModel:()=>sf,GraniteMoeHybridPreTrainedModel:()=>gn,GranitePreTrainedModel:()=>xn,GroundingDinoForObjectDetection:()=>nf,GroundingDinoPreTrainedModel:()=>ii,GroupViTModel:()=>of,GroupViTPreTrainedModel:()=>li,HeliumForCausalLM:()=>lf,HeliumModel:()=>af,HeliumPreTrainedModel:()=>wn,HieraForImageClassification:()=>uf,HieraModel:()=>cf,HieraPreTrainedModel:()=>yn,HubertForCTC:()=>xf,HubertForSequenceClassification:()=>gf,HubertModel:()=>hf,HubertPreTrainedModel:()=>mf,HunYuanDenseV1ForCausalLM:()=>yf,HunYuanDenseV1Model:()=>wf,HunYuanDenseV1PreTrainedModel:()=>bn,IJepaForImageClassification:()=>vf,IJepaModel:()=>kf,IJepaPreTrainedModel:()=>kn,Idefics3ForConditionalGeneration:()=>ui,Idefics3PreTrainedModel:()=>ci,JAISLMHeadModel:()=>Af,JAISModel:()=>Ef,JAISPreTrainedModel:()=>vn,JinaCLIPModel:()=>Mf,JinaCLIPPreTrainedModel:()=>Fs,JinaCLIPTextModel:()=>En,JinaCLIPVisionModel:()=>Sf,Lfm2ForCausalLM:()=>If,Lfm2Model:()=>Of,Lfm2MoeForCausalLM:()=>Tf,Lfm2MoeModel:()=>zf,Lfm2MoePreTrainedModel:()=>Mn,Lfm2PreTrainedModel:()=>An,LiteWhisperForConditionalGeneration:()=>ng,Llama4ForCausalLM:()=>Nf,Llama4PreTrainedModel:()=>pi,LlamaForCausalLM:()=>Cf,LlamaModel:()=>Pf,LlamaPreTrainedModel:()=>Sn,LlavaForConditionalGeneration:()=>Ds,LlavaOnevisionForConditionalGeneration:()=>Ds,LlavaPreTrainedModel:()=>di,LlavaQwen2ForCausalLM:()=>$f,LongT5ForConditionalGeneration:()=>Ff,LongT5Model:()=>Rf,LongT5PreTrainedModel:()=>On,M2M100ForConditionalGeneration:()=>jf,M2M100Model:()=>Df,M2M100PreTrainedModel:()=>In,MBartForCausalLM:()=>Xf,MBartForConditionalGeneration:()=>Vf,MBartForSequenceClassification:()=>Hf,MBartModel:()=>Wf,MBartPreTrainedModel:()=>os,MPNetForMaskedLM:()=>Pm,MPNetForQuestionAnswering:()=>Lm,MPNetForSequenceClassification:()=>Cm,MPNetForTokenClassification:()=>Nm,MPNetModel:()=>Tm,MPNetPreTrainedModel:()=>Lt,MT5ForConditionalGeneration:()=>Dm,MT5Model:()=>Fm,MT5PreTrainedModel:()=>Bn,MarianMTModel:()=>Uf,MarianModel:()=>Bf,MarianPreTrainedModel:()=>zn,MaskFormerForInstanceSegmentation:()=>Gf,MaskFormerModel:()=>qf,MaskFormerPreTrainedModel:()=>Tn,Metric3DForDepthEstimation:()=>Kf,Metric3DPreTrainedModel:()=>_i,Metric3Dv2ForDepthEstimation:()=>Qf,Metric3Dv2PreTrainedModel:()=>fi,MgpstrForSceneTextRecognition:()=>Jf,MgpstrModelOutput:()=>mi,MgpstrPreTrainedModel:()=>hi,MimiDecoderModel:()=>Cn,MimiDecoderOutput:()=>gi,MimiEncoderModel:()=>Pn,MimiEncoderOutput:()=>xi,MimiModel:()=>Yf,MimiPreTrainedModel:()=>js,MistralForCausalLM:()=>em,MistralModel:()=>Zf,MistralPreTrainedModel:()=>Nn,MobileBertForMaskedLM:()=>sm,MobileBertForQuestionAnswering:()=>nm,MobileBertForSequenceClassification:()=>rm,MobileBertModel:()=>tm,MobileBertPreTrainedModel:()=>as,MobileLLMForCausalLM:()=>am,MobileLLMModel:()=>om,MobileLLMPreTrainedModel:()=>Ln,MobileNetV1ForImageClassification:()=>lm,MobileNetV1ForSemanticSegmentation:()=>cm,MobileNetV1Model:()=>im,MobileNetV1PreTrainedModel:()=>Bs,MobileNetV2ForImageClassification:()=>pm,MobileNetV2ForSemanticSegmentation:()=>dm,MobileNetV2Model:()=>um,MobileNetV2PreTrainedModel:()=>Us,MobileNetV3ForImageClassification:()=>fm,MobileNetV3ForSemanticSegmentation:()=>mm,MobileNetV3Model:()=>_m,MobileNetV3PreTrainedModel:()=>qs,MobileNetV4ForImageClassification:()=>xm,MobileNetV4ForSemanticSegmentation:()=>gm,MobileNetV4Model:()=>hm,MobileNetV4PreTrainedModel:()=>Gs,MobileViTForImageClassification:()=>ym,MobileViTModel:()=>wm,MobileViTPreTrainedModel:()=>$n,MobileViTV2ForImageClassification:()=>km,MobileViTV2Model:()=>bm,MobileViTV2PreTrainedModel:()=>Rn,ModernBertDecoderForCausalLM:()=>Om,ModernBertDecoderModel:()=>Sm,ModernBertDecoderPreTrainedModel:()=>Fn,ModernBertForMaskedLM:()=>Em,ModernBertForSequenceClassification:()=>Am,ModernBertForTokenClassification:()=>Mm,ModernBertModel:()=>vm,ModernBertPreTrainedModel:()=>is,Moondream1ForConditionalGeneration:()=>Lf,MoonshineForConditionalGeneration:()=>zm,MoonshineModel:()=>Im,MoonshinePreTrainedModel:()=>Dn,MptForCausalLM:()=>Rm,MptModel:()=>$m,MptPreTrainedModel:()=>jn,MultiModalityCausalLM:()=>jm,MultiModalityPreTrainedModel:()=>wi,MusicgenForCausalLM:()=>Um,MusicgenForConditionalGeneration:()=>qn,MusicgenModel:()=>Bm,MusicgenPreTrainedModel:()=>Un,NanoChatForCausalLM:()=>Gm,NanoChatModel:()=>qm,NanoChatPreTrainedModel:()=>Gn,NeoBertForMaskedLM:()=>Vm,NeoBertForQuestionAnswering:()=>Km,NeoBertForSequenceClassification:()=>Hm,NeoBertForTokenClassification:()=>Xm,NeoBertModel:()=>Wm,NeoBertPreTrainedModel:()=>$t,NomicBertModel:()=>Qm,NomicBertPreTrainedModel:()=>yi,OPTForCausalLM:()=>ah,OPTModel:()=>oh,OPTPreTrainedModel:()=>Kn,Olmo2ForCausalLM:()=>eh,Olmo2Model:()=>Zm,Olmo2PreTrainedModel:()=>Vn,Olmo3ForCausalLM:()=>sh,Olmo3Model:()=>th,Olmo3PreTrainedModel:()=>Hn,OlmoForCausalLM:()=>Ym,OlmoModel:()=>Jm,OlmoPreTrainedModel:()=>Wn,OpenELMForCausalLM:()=>nh,OpenELMModel:()=>rh,OpenELMPreTrainedModel:()=>Xn,OwlViTForObjectDetection:()=>uh,OwlViTModel:()=>ch,OwlViTPreTrainedModel:()=>Jn,Owlv2ForObjectDetection:()=>lh,Owlv2Model:()=>ih,Owlv2PreTrainedModel:()=>Qn,PaliGemmaForConditionalGeneration:()=>ph,PaliGemmaPreTrainedModel:()=>bi,ParakeetForCTC:()=>dh,ParakeetPreTrainedModel:()=>ki,PatchTSMixerForPrediction:()=>fh,PatchTSMixerModel:()=>_h,PatchTSMixerPreTrainedModel:()=>Yn,PatchTSTForPrediction:()=>hh,PatchTSTModel:()=>mh,PatchTSTPreTrainedModel:()=>Zn,Phi3ForCausalLM:()=>yh,Phi3Model:()=>wh,Phi3PreTrainedModel:()=>to,Phi3VForCausalLM:()=>so,Phi3VPreTrainedModel:()=>vi,PhiForCausalLM:()=>gh,PhiModel:()=>xh,PhiPreTrainedModel:()=>eo,PreTrainedModel:()=>f,PvtForImageClassification:()=>kh,PvtModel:()=>bh,PvtPreTrainedModel:()=>ro,PyAnnoteForAudioFrameClassification:()=>Eh,PyAnnoteModel:()=>vh,PyAnnotePreTrainedModel:()=>no,Qwen2ForCausalLM:()=>Mh,Qwen2Model:()=>Ah,Qwen2PreTrainedModel:()=>oo,Qwen2VLForConditionalGeneration:()=>Sh,Qwen2VLPreTrainedModel:()=>Ei,Qwen3ForCausalLM:()=>Ih,Qwen3Model:()=>Oh,Qwen3PreTrainedModel:()=>ao,RFDetrForObjectDetection:()=>Ch,RFDetrModel:()=>Ph,RFDetrObjectDetectionOutput:()=>Ai,RFDetrPreTrainedModel:()=>lo,RTDetrForObjectDetection:()=>Od,RTDetrModel:()=>Sd,RTDetrObjectDetectionOutput:()=>mt,RTDetrPreTrainedModel:()=>Gr,RTDetrV2ForObjectDetection:()=>Wh,RTDetrV2Model:()=>Gh,RTDetrV2ObjectDetectionOutput:()=>Mi,RTDetrV2PreTrainedModel:()=>co,ResNetForImageClassification:()=>Th,ResNetModel:()=>zh,ResNetPreTrainedModel:()=>io,RoFormerForMaskedLM:()=>jh,RoFormerForQuestionAnswering:()=>qh,RoFormerForSequenceClassification:()=>Bh,RoFormerForTokenClassification:()=>Uh,RoFormerModel:()=>Dh,RoFormerPreTrainedModel:()=>Ft,RobertaForMaskedLM:()=>Lh,RobertaForQuestionAnswering:()=>Fh,RobertaForSequenceClassification:()=>$h,RobertaForTokenClassification:()=>Rh,RobertaModel:()=>Nh,RobertaPreTrainedModel:()=>Rt,Sam2ImageSegmentationOutput:()=>Ii,Sam2Model:()=>uo,Sam2PreTrainedModel:()=>zi,Sam3TrackerModel:()=>Xh,SamImageSegmentationOutput:()=>Si,SamModel:()=>Vh,SamPreTrainedModel:()=>Oi,SapiensForDepthEstimation:()=>Qh,SapiensForNormalEstimation:()=>Jh,SapiensForSemanticSegmentation:()=>Kh,SapiensPreTrainedModel:()=>Ws,SegformerForImageClassification:()=>Zh,SegformerForSemanticSegmentation:()=>ex,SegformerModel:()=>Yh,SegformerPreTrainedModel:()=>Vs,SiglipModel:()=>tx,SiglipPreTrainedModel:()=>po,SiglipTextModel:()=>_o,SiglipVisionModel:()=>sx,SmolLM3ForCausalLM:()=>nx,SmolLM3Model:()=>rx,SmolLM3PreTrainedModel:()=>fo,SmolVLMForConditionalGeneration:()=>bf,SnacDecoderModel:()=>ho,SnacEncoderModel:()=>mo,SnacModel:()=>ox,SnacPreTrainedModel:()=>Hs,SpeechT5ForSpeechToText:()=>ix,SpeechT5ForTextToSpeech:()=>lx,SpeechT5HifiGan:()=>cx,SpeechT5Model:()=>ax,SpeechT5PreTrainedModel:()=>Xs,SqueezeBertForMaskedLM:()=>px,SqueezeBertForQuestionAnswering:()=>_x,SqueezeBertForSequenceClassification:()=>dx,SqueezeBertModel:()=>ux,SqueezeBertPreTrainedModel:()=>ls,StableLmForCausalLM:()=>mx,StableLmModel:()=>fx,StableLmPreTrainedModel:()=>xo,Starcoder2ForCausalLM:()=>xx,Starcoder2Model:()=>hx,Starcoder2PreTrainedModel:()=>go,StyleTextToSpeech2Model:()=>gx,StyleTextToSpeech2PreTrainedModel:()=>Ti,SupertonicForConditionalGeneration:()=>wo,SupertonicPreTrainedModel:()=>Pi,Swin2SRForImageSuperResolution:()=>vx,Swin2SRModel:()=>kx,Swin2SRPreTrainedModel:()=>yo,SwinForImageClassification:()=>yx,SwinForSemanticSegmentation:()=>bx,SwinModel:()=>wx,SwinPreTrainedModel:()=>Ks,T5ForConditionalGeneration:()=>Ax,T5Model:()=>Ex,T5PreTrainedModel:()=>bo,TableTransformerForObjectDetection:()=>Sx,TableTransformerModel:()=>Mx,TableTransformerObjectDetectionOutput:()=>Ci,TableTransformerPreTrainedModel:()=>ko,TrOCRForCausalLM:()=>Ox,TrOCRPreTrainedModel:()=>Ni,UltravoxModel:()=>$i,UltravoxPreTrainedModel:()=>Li,UniSpeechForCTC:()=>Tx,UniSpeechForSequenceClassification:()=>Px,UniSpeechModel:()=>zx,UniSpeechPreTrainedModel:()=>Qs,UniSpeechSatForAudioFrameClassification:()=>$x,UniSpeechSatForCTC:()=>Nx,UniSpeechSatForSequenceClassification:()=>Lx,UniSpeechSatModel:()=>Cx,UniSpeechSatPreTrainedModel:()=>cs,VaultGemmaForCausalLM:()=>Fx,VaultGemmaModel:()=>Rx,VaultGemmaPreTrainedModel:()=>vo,ViTForImageClassification:()=>Bx,ViTMAEModel:()=>Ux,ViTMAEPreTrainedModel:()=>Ri,ViTMSNForImageClassification:()=>Gx,ViTMSNModel:()=>qx,ViTMSNPreTrainedModel:()=>Ao,ViTModel:()=>jx,ViTPreTrainedModel:()=>Eo,VisionEncoderDecoderModel:()=>Dx,VitMatteForImageMatting:()=>Wx,VitMattePreTrainedModel:()=>Fi,VitPoseForPoseEstimation:()=>Vx,VitPosePreTrainedModel:()=>Di,VitsModel:()=>Hx,VitsModelOutput:()=>ji,VitsPreTrainedModel:()=>Bi,VoxtralForConditionalGeneration:()=>Ix,Wav2Vec2BertForCTC:()=>Kx,Wav2Vec2BertForSequenceClassification:()=>Qx,Wav2Vec2BertModel:()=>Xx,Wav2Vec2BertPreTrainedModel:()=>Js,Wav2Vec2ForAudioFrameClassification:()=>ff,Wav2Vec2ForCTC:()=>df,Wav2Vec2ForSequenceClassification:()=>_f,Wav2Vec2Model:()=>pf,Wav2Vec2PreTrainedModel:()=>it,WavLMForAudioFrameClassification:()=>tg,WavLMForCTC:()=>Yx,WavLMForSequenceClassification:()=>Zx,WavLMForXVector:()=>eg,WavLMModel:()=>Jx,WavLMPreTrainedModel:()=>Dt,WeSpeakerResNetModel:()=>sg,WeSpeakerResNetPreTrainedModel:()=>qi,WhisperForConditionalGeneration:()=>Wi,WhisperModel:()=>rg,WhisperPreTrainedModel:()=>Mo,XLMForQuestionAnswering:()=>cg,XLMForSequenceClassification:()=>ig,XLMForTokenClassification:()=>lg,XLMModel:()=>og,XLMPreTrainedModel:()=>jt,XLMRobertaForMaskedLM:()=>pg,XLMRobertaForQuestionAnswering:()=>fg,XLMRobertaForSequenceClassification:()=>dg,XLMRobertaForTokenClassification:()=>_g,XLMRobertaModel:()=>ug,XLMRobertaPreTrainedModel:()=>Bt,XLMWithLMHeadModel:()=>ag,XVectorOutput:()=>Ui,YolosForObjectDetection:()=>hg,YolosModel:()=>mg,YolosObjectDetectionOutput:()=>Vi,YolosPreTrainedModel:()=>So,YoutuForCausalLM:()=>gg,YoutuModel:()=>xg,YoutuPreTrainedModel:()=>Oo});var rs=class extends f{},Sp=class extends rs{},Op=class extends rs{async _call(e){return new z(await super._call(e))}},Ip=class extends rs{async _call(e){return new oe(await super._call(e))}},zp=class extends rs{async _call(e){return new J(await super._call(e))}};var Sr=class extends f{},Tp=class extends Sr{},Pp=class extends Sr{};var Or=class extends f{},Cp=class extends Or{},Np=class extends Or{};var Ir=class extends f{},Lp=class extends Ir{},$p=class extends Ir{};var Cs=class extends f{},Rp=class extends Cs{},Fp=class extends Cs{},Dp=class extends Cs{async _call(e){return new z(await super._call(e))}};var zr=class extends f{},jp=class extends zr{},Bp=class extends zr{async _call(e){return new z(await super._call(e))}};var Ot=class extends f{},Up=class extends Ot{},qp=class extends Ot{async _call(e){return new J(await super._call(e))}},Gp=class extends Ot{async _call(e){return new z(await super._call(e))}},Wp=class extends Ot{async _call(e){return new K(await super._call(e))}},Vp=class extends Ot{async _call(e){return new oe(await super._call(e))}};var Tr=class extends f{},Hp=class extends Tr{},Xp=class extends Tr{};var Pr=class extends f{},Kp=class extends Pr{},Qp=class extends Pr{};var Cr=class extends f{},Jp=class extends Cr{},Yp=class extends Cr{};var It=class extends f{},Zp=class extends It{},ed=class extends It{async _call(e){return new J(await super._call(e))}},td=class extends It{async _call(e){return new z(await super._call(e))}},sd=class extends It{async _call(e){return new K(await super._call(e))}},rd=class extends It{async _call(e){return new oe(await super._call(e))}};var Mv=4299n,dy=6561n,Xa=class extends f{forward_params=["input_ids","inputs_embeds","attention_mask","position_ids","audio_values","exaggeration","audio_features","audio_tokens","speaker_embeddings","speaker_features","past_key_values"];main_input_name="input_ids";_return_dict_in_generate_keys=["audio_tokens","speaker_embeddings","speaker_features"]},Nr=class extends Xa{async encode_speech(e){return q(this.sessions.speech_encoder,{audio_values:e})}async forward({input_ids:e=null,attention_mask:s=null,audio_values:r=null,exaggeration:n=null,position_ids:o=null,inputs_embeds:a=null,past_key_values:i=null,generation_config:l=null,logits_processor:c=null,audio_features:u=null,audio_tokens:p=null,speaker_embeddings:d=null,speaker_features:_=null,...m}){let h;if(!a){let g=this.sessions.embed_tokens.inputNames,w={input_ids:e};if(g.includes("exaggeration")){if(!(n instanceof S)){let y=e.dims[0];if(n==null)n=xe([y],.5);else if(typeof n=="number")n=xe([y],n);else if(Array.isArray(n))n=new S("float32",n,[y]);else throw new Error("Unsupported type for `exaggeration` input")}w.exaggeration=n}if(g.includes("position_ids")&&(w.position_ids=o),{inputs_embeds:a}=await q(this.sessions.embed_tokens,w),u&&p&&d&&_&&(h={audio_features:u,audio_tokens:p,speaker_embeddings:d,speaker_features:_}),h||r)h??=await this.encode_speech(r),a=ne([h.audio_features,a],1),s=Oe([a.dims[0],a.dims[1]]);else{let y=a.dims[1];if(!i||y!==1)throw new Error("Incorrect state encountered during generation.");let E=Object.values(i)[0].dims.at(-2);s=Oe([a.dims[0],E+y])}}return{...await Ue(this,{inputs_embeds:a,past_key_values:i,attention_mask:s,generation_config:l,logits_processor:c},!1),...h}}prepare_inputs_for_generation(e,s,r){if(!s.position_ids&&this.sessions.embed_tokens.inputNames.includes("position_ids"))if(s.input_ids.dims[1]===1){let n=Array.from({length:e.length},(o,a)=>e[a].length-e[a].findLastIndex(i=>i==dy)-1);s.position_ids=new S("int64",n,[e.length,1])}else{let o=s.input_ids.tolist().map(a=>{let i=0;return a.map(l=>l>=dy?0:i++)});s.position_ids=new S("int64",o.flat(),s.input_ids.dims)}return s.input_ids.dims[1]===1&&(delete s.audio_values,delete s.audio_features,delete s.audio_tokens,delete s.speaker_embeddings,delete s.speaker_features),Ar(this,e,s,r)}async generate(e){let{sequences:s,audio_tokens:r,speaker_embeddings:n,speaker_features:o}=await super.generate({...e,return_dict_in_generate:!0}),a=s.slice(null,[e.input_ids.dims[1],-1]),i=xe([a.dims[0],3],Mv),l=ne([r,a,i],1),{waveform:c}=await q(this.sessions.conditional_decoder,{speech_tokens:l,speaker_features:o,speaker_embeddings:n});return c}};var Ka=class extends f{},nd=class extends Ka{};var Ns=class extends f{},od=class extends Ns{},Lr=class extends Ns{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"text_model"})}},$r=class extends Ns{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"audio_model"})}};var ft=class extends f{},ad=class extends ft{},id=class extends ft{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"text_model"})}},Rr=class extends ft{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"text_model"})}},ld=class extends ft{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"vision_model"})}},cd=class extends ft{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"vision_model"})}};var Fr=class extends f{},ud=class extends Fr{},pd=class extends Fr{};var Dr=class extends f{},dd=class extends Dr{},_d=class extends Dr{};var jr=class extends f{},fd=class extends jr{},md=class extends jr{};var Br=class extends f{},hd=class extends Br{},xd=class extends Br{};var zt=class extends f{},gd=class extends zt{},wd=class extends zt{async _call(e){return new J(await super._call(e))}},yd=class extends zt{async _call(e){return new z(await super._call(e))}},bd=class extends zt{async _call(e){return new K(await super._call(e))}},kd=class extends zt{async _call(e){return new oe(await super._call(e))}};var Ur=class extends f{},vd=class extends Ur{},Ed=class extends Ur{async _call(e){return new z(await super._call(e))}};var qr=class extends f{},Ad=class extends qr{},Md=class extends qr{async _call(e){return new z(await super._call(e))}};var Gr=class extends f{},Sd=class extends Gr{},Od=class extends Gr{async _call(e){return new mt(await super._call(e))}},mt=class extends pe{constructor({logits:e,pred_boxes:s}){super(),this.logits=e,this.pred_boxes=s}};var Wr=class extends f{},Id=class extends Wr{},zd=class extends Wr{async _call(e){return new mt(await super._call(e))}};var Qa=class extends pe{constructor({audio_codes:e}){super(),this.audio_codes=e}},Ja=class extends pe{constructor({audio_values:e}){super(),this.audio_values=e}},Ls=class extends f{main_input_name="input_values";forward_params=["input_values"]},Td=class extends Ls{async encode(e){return new Qa(await q(this.sessions.encoder_model,e))}async decode(e){return new Ja(await q(this.sessions.decoder_model,e))}},Vr=class extends Ls{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"encoder_model"})}},Hr=class extends Ls{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"decoder_model"})}};var Tt=class extends f{},Pd=class extends Tt{},Cd=class extends Tt{async _call(e){return new J(await super._call(e))}},Nd=class extends Tt{async _call(e){return new z(await super._call(e))}},Ld=class extends Tt{async _call(e){return new K(await super._call(e))}},$d=class extends Tt{async _call(e){return new oe(await super._call(e))}};var Pt=class extends f{},Rd=class extends Pt{},Fd=class extends Pt{async _call(e){return new J(await super._call(e))}},Dd=class extends Pt{async _call(e){return new z(await super._call(e))}},jd=class extends Pt{async _call(e){return new K(await super._call(e))}},Bd=class extends Pt{async _call(e){return new oe(await super._call(e))}};var Ya=class extends f{},Ud=class extends Ya{};var Xr=class extends f{},qd=class extends Xr{},Gd=class extends Xr{async _call(e){return new z(await super._call(e))}};var Za=class extends f{},Wd=class extends Za{};var ei=class extends f{},Vd=class extends ei{};var $s=class extends f{},Hd=class extends $s{},Xd=class extends $s{async _call(e){return new Rs(await super._call(e))}},Kd=class extends $s{async _call(e){return new ti(await super._call(e))}},Rs=class extends pe{constructor({logits:e,pred_boxes:s}){super(),this.logits=e,this.pred_boxes=s}},ti=class extends pe{constructor({logits:e,pred_boxes:s,pred_masks:r}){super(),this.logits=e,this.pred_boxes=s,this.pred_masks=r}};var Kr=class extends f{},Qd=class extends Kr{},Jd=class extends Kr{async _call(e){return new z(await super._call(e))}};var Qr=class extends f{},Yd=class extends Qr{},Zd=class extends Qr{async _call(e){return new z(await super._call(e))}};var si=class extends f{},e_=class extends si{};var ri=class extends f{},t_=class extends ri{};var Ct=class extends f{},s_=class extends Ct{},r_=class extends Ct{async _call(e){return new z(await super._call(e))}},n_=class extends Ct{async _call(e){return new K(await super._call(e))}},o_=class extends Ct{async _call(e){return new oe(await super._call(e))}},a_=class extends Ct{async _call(e){return new J(await super._call(e))}};var ni=class extends f{},i_=class extends ni{};var Jr=class extends f{},l_=class extends Jr{},c_=class extends Jr{};var Yr=class extends f{},u_=class extends Yr{},p_=class extends Yr{async _call(e){return new z(await super._call(e))}};var Nt=class extends f{},d_=class extends Nt{},__=class extends Nt{async _call(e){return new J(await super._call(e))}},f_=class extends Nt{async _call(e){return new z(await super._call(e))}},m_=class extends Nt{async _call(e){return new K(await super._call(e))}},h_=class extends Nt{async _call(e){return new oe(await super._call(e))}};var Zr=class extends f{},x_=class extends Zr{},g_=class extends Zr{};var ns=class extends f{},w_=class extends ns{},y_=class extends ns{async _call(e){return new J(await super._call(e))}},b_=class extends ns{async _call(e){return new z(await super._call(e))}},k_=class extends ns{async _call(e){return new K(await super._call(e))}};var en=class extends f{},v_=class extends en{},E_=class extends en{};var tn=class extends f{},A_=class extends tn{},M_=class extends tn{};var sn=class extends f{},S_=class extends sn{},O_=class extends sn{};var rn=class extends f{},I_=class extends rn{},z_=class extends rn{async _call(e){return new z(await super._call(e))}};var oi=class extends f{forward_params=["input_ids","inputs_embeds","attention_mask","pixel_values","encoder_outputs","decoder_input_ids","decoder_inputs_embeds","decoder_attention_mask","past_key_values"];main_input_name="inputs_embeds"},T_=class extends oi{_merge_input_ids_with_image_features({inputs_embeds:e,image_features:s,input_ids:r,attention_mask:n}){return{inputs_embeds:ne([s,e],1),attention_mask:ne([Oe(s.dims.slice(0,2)),n],1)}}async _prepare_inputs_embeds({input_ids:e,pixel_values:s,inputs_embeds:r,attention_mask:n}){if(!e&&!s)throw new Error("Either `input_ids` or `pixel_values` should be provided.");let o,a;return e&&(o=await this.encode_text({input_ids:e})),s&&(a=await this.encode_image({pixel_values:s})),o&&a?{inputs_embeds:r,attention_mask:n}=this._merge_input_ids_with_image_features({inputs_embeds:o,image_features:a,input_ids:e,attention_mask:n}):r=o||a,{inputs_embeds:r,attention_mask:n}}async forward({input_ids:e,pixel_values:s,attention_mask:r,decoder_input_ids:n,decoder_attention_mask:o,encoder_outputs:a,past_key_values:i,inputs_embeds:l,decoder_inputs_embeds:c}){if(l||({inputs_embeds:l,attention_mask:r}=await this._prepare_inputs_embeds({input_ids:e,pixel_values:s,inputs_embeds:l,attention_mask:r})),!a){let{last_hidden_state:p}=await Je(this,{inputs_embeds:l,attention_mask:r});a=p}if(!c){if(!n)throw new Error("Either `decoder_input_ids` or `decoder_inputs_embeds` should be provided.");c=await this.encode_text({input_ids:n})}return await Ue(this,{inputs_embeds:c,attention_mask:o,encoder_attention_mask:r,encoder_hidden_states:a,past_key_values:i},!0)}};var nn=class extends f{},P_=class extends nn{},C_=class extends nn{};var on=class extends f{},N_=class extends on{},L_=class extends on{};var an=class extends f{},$_=class extends an{},R_=class extends an{};var ai=class extends f{forward_params=["input_ids","attention_mask","inputs_embeds","per_layer_inputs","position_ids","pixel_values","input_features","input_features_mask","past_key_values"]},ln=class extends ai{async forward({input_ids:e=null,attention_mask:s=null,pixel_values:r=null,input_features:n=null,input_features_mask:o=null,position_ids:a=null,inputs_embeds:i=null,per_layer_inputs:l=null,past_key_values:c=null,generation_config:u=null,logits_processor:p=null,...d}){if((!i||!l)&&({inputs_embeds:i,per_layer_inputs:l}=await q(this.sessions.embed_tokens,{input_ids:e}),e.dims[1]!==1)){if(r){let{image_features:m}=await q(this.sessions.vision_encoder,{pixel_values:r});({inputs_embeds:i,attention_mask:s}=this._merge_input_ids_with_image_features({image_features:m,inputs_embeds:i,input_ids:e,attention_mask:s}))}if(n){let{audio_features:m}=await q(this.sessions.audio_encoder,{input_features:n,input_features_mask:o});({inputs_embeds:i,attention_mask:s}=this._merge_input_ids_with_audio_features({audio_features:m,inputs_embeds:i,input_ids:e,attention_mask:s}))}}return await Ue(this,{inputs_embeds:i,per_layer_inputs:l,past_key_values:c,attention_mask:s,position_ids:a,generation_config:u,logits_processor:p},!0)}_merge_input_ids_with_image_features(e){let s=e.image_features.dims.at(-1),r=e.image_features.view(-1,s);return _t({image_token_id:this.config.image_token_id,...e,image_features:r})}_merge_input_ids_with_audio_features(e){let s=e.audio_features.dims.at(-1),r=e.audio_features.view(-1,s);return Ha({audio_token_id:this.config.audio_token_id,...e,audio_features:r})}};var cn=class extends f{},F_=class extends cn{},D_=class extends cn{};var un=class extends f{},j_=class extends un{},B_=class extends un{};var pn=class extends f{},U_=class extends pn{},q_=class extends pn{};var dn=class extends f{},G_=class extends dn{},W_=class extends dn{};var _n=class extends f{},V_=class extends _n{},H_=class extends _n{};var fn=class extends f{},X_=class extends fn{},K_=class extends fn{};var mn=class extends f{},Q_=class extends mn{},J_=class extends mn{};var hn=class extends f{},Y_=class extends hn{},Z_=class extends hn{};var xn=class extends f{},ef=class extends xn{},tf=class extends xn{};var gn=class extends f{},sf=class extends gn{},rf=class extends gn{};var ii=class extends f{},nf=class extends ii{};var li=class extends f{},of=class extends li{};var wn=class extends f{},af=class extends wn{},lf=class extends wn{};var yn=class extends f{},cf=class extends yn{},uf=class extends yn{async _call(e){return new z(await super._call(e))}};var it=class extends f{},pf=class extends it{},df=class extends it{async _call(e){return new $e(await super._call(e))}},_f=class extends it{async _call(e){return new z(await super._call(e))}},ff=class extends it{async _call(e){return new K(await super._call(e))}};var mf=class extends f{},hf=class extends it{},xf=class extends it{async _call(e){return new $e(await super._call(e))}},gf=class extends it{async _call(e){return new z(await super._call(e))}};var bn=class extends f{},wf=class extends bn{},yf=class extends bn{};var ci=class extends f{forward_params=["input_ids","attention_mask","pixel_values","pixel_attention_mask","position_ids","past_key_values"]},ui=class extends ci{async encode_image({pixel_values:e,pixel_attention_mask:s}){return(await q(this.sessions.vision_encoder,{pixel_values:e,pixel_attention_mask:s})).image_features}_merge_input_ids_with_image_features(e){let s=e.image_features.dims.at(-1),r=e.image_features.view(-1,s);return _t({image_token_id:this.config.image_token_id,...e,image_features:r})}},bf=class extends ui{};var kn=class extends f{},kf=class extends kn{},vf=class extends kn{async _call(e){return new z(await super._call(e))}};var vn=class extends f{},Ef=class extends vn{},Af=class extends vn{};var Fs=class extends f{},Mf=class extends Fs{async forward(e){let s=!e.input_ids,r=!e.pixel_values;if(s&&r)throw new Error("Either `input_ids` or `pixel_values` should be provided.");if(s&&(e.input_ids=Oe([e.pixel_values.dims[0],1])),r){let{image_size:c}=this.config.vision_config;e.pixel_values=xe([0,3,c,c],0)}let{text_embeddings:n,image_embeddings:o,l2norm_text_embeddings:a,l2norm_image_embeddings:i}=await super.forward(e),l={};return s||(l.text_embeddings=n,l.l2norm_text_embeddings=a),r||(l.image_embeddings=o,l.l2norm_image_embeddings=i),l}},En=class extends Fs{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"text_model"})}},Sf=class extends Fs{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"vision_model"})}};var An=class extends f{},Of=class extends An{},If=class extends An{};var Mn=class extends f{},zf=class extends Mn{},Tf=class extends Mn{};var Sn=class extends f{},Pf=class extends Sn{},Cf=class extends Sn{};var pi=class extends f{},Nf=class extends pi{};var di=class extends f{forward_params=["input_ids","attention_mask","pixel_values","position_ids","past_key_values"]},Ds=class extends di{_merge_input_ids_with_image_features(e){let s=e.image_features.dims.at(-1),r=e.image_features.view(-1,s);return _t({image_token_id:this.config.image_token_index,...e,image_features:r})}},Lf=class extends Ds{},$f=class extends Ds{};var On=class extends f{},Rf=class extends On{},Ff=class extends On{};var In=class extends f{},Df=class extends In{},jf=class extends In{};var zn=class extends f{},Bf=class extends zn{},Uf=class extends zn{};var Tn=class extends f{},qf=class extends Tn{},Gf=class extends Tn{};var os=class extends f{},Wf=class extends os{},Vf=class extends os{},Hf=class extends os{async _call(e){return new z(await super._call(e))}},Xf=class extends os{};var _i=class extends f{},Kf=class extends _i{};var fi=class extends f{},Qf=class extends fi{};var mi=class extends pe{constructor({char_logits:e,bpe_logits:s,wp_logits:r}){super(),this.char_logits=e,this.bpe_logits=s,this.wp_logits=r}get logits(){return[this.char_logits,this.bpe_logits,this.wp_logits]}},hi=class extends f{},Jf=class extends hi{async _call(e){return new mi(await super._call(e))}};var xi=class extends pe{constructor({audio_codes:e}){super(),this.audio_codes=e}},gi=class extends pe{constructor({audio_values:e}){super(),this.audio_values=e}},js=class extends f{main_input_name="input_values";forward_params=["input_values"]},Yf=class extends js{async encode(e){return new xi(await q(this.sessions.encoder_model,e))}async decode(e){return new gi(await q(this.sessions.decoder_model,e))}},Pn=class extends js{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"encoder_model"})}},Cn=class extends js{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"decoder_model"})}};var Nn=class extends f{},Zf=class extends Nn{},em=class extends Nn{};var as=class extends f{},tm=class extends as{},sm=class extends as{async _call(e){return new J(await super._call(e))}},rm=class extends as{async _call(e){return new z(await super._call(e))}},nm=class extends as{async _call(e){return new oe(await super._call(e))}};var Ln=class extends f{},om=class extends Ln{},am=class extends Ln{};var Bs=class extends f{},im=class extends Bs{},lm=class extends Bs{async _call(e){return new z(await super._call(e))}},cm=class extends Bs{};var Us=class extends f{},um=class extends Us{},pm=class extends Us{async _call(e){return new z(await super._call(e))}},dm=class extends Us{};var qs=class extends f{},_m=class extends qs{},fm=class extends qs{async _call(e){return new z(await super._call(e))}},mm=class extends qs{};var Gs=class extends f{},hm=class extends Gs{},xm=class extends Gs{async _call(e){return new z(await super._call(e))}},gm=class extends Gs{};var $n=class extends f{},wm=class extends $n{},ym=class extends $n{async _call(e){return new z(await super._call(e))}};var Rn=class extends f{},bm=class extends Rn{},km=class extends Rn{async _call(e){return new z(await super._call(e))}};var is=class extends f{},vm=class extends is{},Em=class extends is{async _call(e){return new J(await super._call(e))}},Am=class extends is{async _call(e){return new z(await super._call(e))}},Mm=class extends is{async _call(e){return new K(await super._call(e))}};var Fn=class extends f{},Sm=class extends Fn{},Om=class extends Fn{};var Dn=class extends f{requires_attention_mask=!1;main_input_name="input_values";forward_params=["input_values","decoder_input_ids","past_key_values"]},Im=class extends Dn{},zm=class extends Dn{};var Lt=class extends f{},Tm=class extends Lt{},Pm=class extends Lt{async _call(e){return new J(await super._call(e))}},Cm=class extends Lt{async _call(e){return new z(await super._call(e))}},Nm=class extends Lt{async _call(e){return new K(await super._call(e))}},Lm=class extends Lt{async _call(e){return new oe(await super._call(e))}};var jn=class extends f{},$m=class extends jn{},Rm=class extends jn{};var Bn=class extends f{},Fm=class extends Bn{},Dm=class extends Bn{};var wi=class extends f{},jm=class extends wi{forward_params=["input_ids","pixel_values","images_seq_mask","images_emb_mask","attention_mask","position_ids","past_key_values"];constructor(...e){super(...e),this._generation_mode="text"}async forward(e){let s=this._generation_mode??"text",r;if(s==="text"||!e.past_key_values){let l=this.sessions.prepare_inputs_embeds,c=Me(e,l.inputNames);r=await q(l,c)}else{let l=this.sessions.gen_img_embeds,c=Me({image_ids:e.input_ids},l.inputNames);r=await q(l,c)}let n={...e,...r},o=await Ue(this,n),a=this.sessions[s==="text"?"lm_head":"gen_head"];if(!a)throw new Error(`Unable to find "${a}" generation head`);let i=await q(a,Me(o,a.inputNames));return{...r,...o,...i}}prepare_inputs_for_generation(e,s,r){let n=!!s.past_key_values;return r.guidance_scale!==null&&r.guidance_scale>1&&(n?s.input_ids=ne([s.input_ids,s.input_ids],0):(s.input_ids=ne([s.input_ids,dr(s.input_ids,BigInt(r.pad_token_id))],0),s.attention_mask=ne([s.attention_mask,dr(s.attention_mask,0n)],0))),(n||!s.pixel_values)&&(s.pixel_values=xe([0,0,3,384,384],1)),n&&(s.images_seq_mask=new S("bool",new Array(1).fill(!0).fill(!1,0,1),[1,1]),s.images_emb_mask=new S("bool",new Array(0).fill(!1),[1,1,0])),s}async generate(e){return this._generation_mode="text",super.generate(e)}async generate_images(e){this._generation_mode="image";let s=(e.inputs??e[this.main_input_name]).dims[1],n=(await super.generate(e)).slice(null,[s,null]),o=this.sessions.image_decode,{decoded_image:a}=await q(o,{generated_tokens:n}),i=a.add_(1).mul_(255/2).clamp_(0,255).to("uint8"),l=[];for(let c of i){let u=we.fromTensor(c);l.push(u)}return l}};var Un=class extends f{},Bm=class extends Un{},Um=class extends Un{},qn=class extends f{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];_apply_and_filter_by_delay_pattern_mask(e){let[s,r]=e.dims,n=this.config.decoder.num_codebooks,o=r-n,a=0;for(let c=0;c<e.size;++c){if(e.data[c]==this.config.decoder.pad_token_id)continue;let u=c%r,p=Math.floor(c/r)%n,d=u-p;d>0&&d<=o&&(e.data[a++]=e.data[c])}let i=Math.floor(s/n),l=a/(i*n);return new S(e.type,e.data.slice(0,a),[i,n,l])}prepare_inputs_for_generation(e,s,r){let n=BigInt(this.config.decoder.pad_token_id),o=structuredClone(e);for(let a=0;a<o.length;++a)for(let i=0;i<o[a].length;++i)a%this.config.decoder.num_codebooks>=i&&(o[a][i]=n);return r.guidance_scale!==null&&r.guidance_scale>1&&(o=o.concat(o)),Mr(this,o,s,r)}async generate(e){let s=await super.generate(e),r=this._apply_and_filter_by_delay_pattern_mask(s).unsqueeze_(0),{audio_values:n}=await q(this.sessions.encodec_decode,{audio_codes:r});return n}};var Gn=class extends f{},qm=class extends Gn{},Gm=class extends Gn{};var $t=class extends f{},Wm=class extends $t{},Vm=class extends $t{async _call(e){return new J(await super._call(e))}},Hm=class extends $t{async _call(e){return new z(await super._call(e))}},Xm=class extends $t{async _call(e){return new K(await super._call(e))}},Km=class extends $t{async _call(e){return new oe(await super._call(e))}};var yi=class extends f{},Qm=class extends yi{};var Wn=class extends f{},Jm=class extends Wn{},Ym=class extends Wn{};var Vn=class extends f{},Zm=class extends Vn{},eh=class extends Vn{};var Hn=class extends f{},th=class extends Hn{},sh=class extends Hn{};var Xn=class extends f{},rh=class extends Xn{},nh=class extends Xn{};var Kn=class extends f{},oh=class extends Kn{},ah=class extends Kn{};var Qn=class extends f{},ih=class extends Qn{},lh=class extends Qn{};var Jn=class extends f{},ch=class extends Jn{},uh=class extends Jn{};var bi=class extends f{forward_params=["input_ids","attention_mask","pixel_values","position_ids","past_key_values"]},ph=class extends bi{_merge_input_ids_with_image_features(e){let s=e.image_features.dims.at(-1),r=e.image_features.view(-1,s);return _t({image_token_id:this.config.image_token_index,...e,image_features:r})}};var ki=class extends f{},dh=class extends ki{async _call(e){return new $e(await super._call(e))}};var Yn=class extends f{},_h=class extends Yn{},fh=class extends Yn{};var Zn=class extends f{},mh=class extends Zn{},hh=class extends Zn{};var eo=class extends f{},xh=class extends eo{},gh=class extends eo{};var to=class extends f{},wh=class extends to{},yh=class extends to{};var vi=class extends f{forward_params=["input_ids","inputs_embeds","attention_mask","position_ids","pixel_values","image_sizes","past_key_values"]},so=class extends vi{async forward({input_ids:e=null,attention_mask:s=null,pixel_values:r=null,image_sizes:n=null,position_ids:o=null,inputs_embeds:a=null,past_key_values:i=null,generation_config:l=null,logits_processor:c=null,...u}){if(!a){let d;if(r&&e.dims[1]!==1){if(!n)throw new Error("`image_sizes` must be provided when `pixel_values` is provided.");({image_features:d}=await q(this.sessions.vision_encoder,{pixel_values:r,image_sizes:n}))}else{let _=this.config.normalized_config.hidden_size;d=new S("float32",[],[0,_])}({inputs_embeds:a}=await q(this.sessions.prepare_inputs_embeds,{input_ids:e,image_features:d}))}return await Ue(this,{inputs_embeds:a,past_key_values:i,attention_mask:s,position_ids:o,generation_config:l,logits_processor:c},!1)}};var ro=class extends f{},bh=class extends ro{},kh=class extends ro{async _call(e){return new z(await super._call(e))}};var no=class extends f{},vh=class extends no{},Eh=class extends no{async _call(e){return new K(await super._call(e))}};var oo=class extends f{},Ah=class extends oo{},Mh=class extends oo{};var Ei=class extends f{forward_params=["input_ids","attention_mask","position_ids","past_key_values","pixel_values","image_grid_thw"]},Sh=class extends Ei{get_rope_index(e,s,r,n){let{vision_config:o,image_token_id:a,video_token_id:i,vision_start_token_id:l}=this.config,c=o.spatial_merge_size??2,u=[];if(s||r){let p=e.tolist();n||(n=sa(e));let d=n.tolist(),_=Array.from({length:3},w=>Array.from({length:e.dims[0]},y=>Array.from({length:e.dims[1]},E=>1))),m=s?s.tolist():[],h=r?r.tolist():[],x=0,g=0;for(let w=0;w<p.length;++w){let y=p[w].filter((k,v)=>d[w][v]==1),A=y.reduce((k,v,I)=>(v==l&&k.push(I),k),[]).map(k=>y[k+1]),b=A.filter(k=>k==a).length,O=A.filter(k=>k==i).length,N=[],F=0,R=b,B=O;for(let k=0;k<A.length;++k){let v=y.findIndex((ct,Ze)=>Ze>F&&ct==a),I=y.findIndex((ct,Ze)=>Ze>F&&ct==i),Q=R>0&&v!==-1?v:y.length+1,Z=B>0&&I!==-1?I:y.length+1,Ie,Ee,ht,xt;Q<Z?([Ee,ht,xt]=m[x],++x,--R,Ie=Q):([Ee,ht,xt]=h[g],++g,--B,Ie=Z);let[Gt,lt,Ye]=[Number(Ee),Math.floor(Number(ht)/c),Math.floor(Number(xt)/c)],gt=Ie-F,vt=N.length>0?ae(N.at(-1))[0]+1:0;N.push(Array.from({length:3*gt},(ct,Ze)=>vt+Ze%gt));let Wt=gt+vt,Et=Gt*lt*Ye,$o=Array.from({length:Et},(ct,Ze)=>Wt+Math.floor(Ze/(lt*Ye))),Ro=Array.from({length:Et},(ct,Ze)=>Wt+Math.floor(Ze/Ye)%lt),Fo=Array.from({length:Et},(ct,Ze)=>Wt+Ze%Ye);N.push([$o,Ro,Fo].flat()),F=Ie+Et}if(F<y.length){let k=N.length>0?ae(N.at(-1))[0]+1:0,v=y.length-F;N.push(Array.from({length:3*v},(I,Q)=>k+Q%v))}let G=N.reduce((k,v)=>k+v.length,0),D=new Array(G),X=0;for(let k=0;k<3;++k)for(let v=0;v<N.length;++v){let I=N[v],Q=I.length/3;for(let Z=k*Q;Z<(k+1)*Q;++Z)D[X++]=I[Z]}let V=0,re=d[w];for(let k=0;k<re.length;++k)if(re[k]==1){for(let v=0;v<3;++v)_[v][w][k]=D[v*G/3+V];++V}let Y=ae(D)[0];u.push(Y+1-p[w].length)}return[new S("int64",_.flat(1/0),[3,e.dims[0],e.dims[1]]),new S("int64",u,[u.length,1])]}else if(n){let{data:p,dims:d}=Mp(n),_=BigInt64Array.from({length:3*p.length},(h,x)=>p[x%p.length]),m=Array.from({length:d[0]},(h,x)=>ae(p.subarray(d[1]*x,d[1]*(x+1)))[0]+1n+BigInt(d[1]));return[new S("int64",_,[3,...d]),new S("int64",m,[m.length,1])]}else{let[p,d]=e.dims,_=BigInt64Array.from({length:3*p*d},(m,h)=>BigInt(Math.floor(h%d/p)));return[new S("int64",_,[3,...e.dims]),tc([p,1])]}}async encode_image({pixel_values:e,image_grid_thw:s}){return(await q(this.sessions.vision_encoder,{pixel_values:e,grid_thw:s})).image_features}_merge_input_ids_with_image_features(e){return _t({image_token_id:this.config.image_token_id,...e})}prepare_inputs_for_generation(e,s,r){if(s.attention_mask&&!s.position_ids)if(!s.past_key_values)[s.position_ids,s.rope_deltas]=this.get_rope_index(s.input_ids,s.image_grid_thw,s.video_grid_thw,s.attention_mask);else{s.pixel_values=null;let n=BigInt(Object.values(s.past_key_values)[0].dims.at(-2)),o=s.rope_deltas.map(a=>n+a);s.position_ids=Ke([o,o,o],0)}return s}};var ao=class extends f{},Oh=class extends ao{},Ih=class extends ao{};var io=class extends f{},zh=class extends io{},Th=class extends io{async _call(e){return new z(await super._call(e))}};var lo=class extends f{},Ph=class extends lo{},Ch=class extends lo{async _call(e){return new Ai(await super._call(e))}},Ai=class extends mt{};var Rt=class extends f{},Nh=class extends Rt{},Lh=class extends Rt{async _call(e){return new J(await super._call(e))}},$h=class extends Rt{async _call(e){return new z(await super._call(e))}},Rh=class extends Rt{async _call(e){return new K(await super._call(e))}},Fh=class extends Rt{async _call(e){return new oe(await super._call(e))}};var Ft=class extends f{},Dh=class extends Ft{},jh=class extends Ft{async _call(e){return new J(await super._call(e))}},Bh=class extends Ft{async _call(e){return new z(await super._call(e))}},Uh=class extends Ft{async _call(e){return new K(await super._call(e))}},qh=class extends Ft{async _call(e){return new oe(await super._call(e))}};var co=class extends f{},Gh=class extends co{},Wh=class extends co{async _call(e){return new Mi(await super._call(e))}},Mi=class extends mt{};var Si=class extends pe{constructor({iou_scores:e,pred_masks:s}){super(),this.iou_scores=e,this.pred_masks=s}},Oi=class extends f{},Vh=class extends Oi{async get_image_embeddings({pixel_values:e}){return await Je(this,{pixel_values:e})}async forward(e){!e.image_embeddings||!e.image_positional_embeddings?e={...e,...await this.get_image_embeddings(e)}:e={...e},e.input_labels??=Oe(e.input_points.dims.slice(0,-1));let s={image_embeddings:e.image_embeddings,image_positional_embeddings:e.image_positional_embeddings};return e.input_points&&(s.input_points=e.input_points),e.input_labels&&(s.input_labels=e.input_labels),e.input_boxes&&(s.input_boxes=e.input_boxes),await q(this.sessions.prompt_encoder_mask_decoder,s)}async _call(e){return new Si(await super._call(e))}};var Ii=class extends pe{constructor({iou_scores:e,pred_masks:s,object_score_logits:r}){super(),this.iou_scores=e,this.pred_masks=s,this.object_score_logits=r}},zi=class extends f{},uo=class extends zi{async get_image_embeddings({pixel_values:e}){return await Je(this,{pixel_values:e})}async forward(e){let{num_feature_levels:s}=this.config.vision_config;if(Array.from({length:s},(a,i)=>`image_embeddings.${i}`).some(a=>!e[a])?e={...e,...await this.get_image_embeddings(e)}:e={...e},e.input_points){if(e.input_boxes&&e.input_boxes.dims[1]!==1)throw new Error("When both `input_points` and `input_boxes` are provided, the number of boxes per image must be 1.");let a=e.input_points.dims;e.input_labels??=Oe(a.slice(0,-1)),e.input_boxes??=xe([a[0],0,4],0)}else if(e.input_boxes){let a=e.input_boxes.dims;e.input_labels=xe([a[0],a[1],0],-1n),e.input_points=xe([a[0],1,0,2],0)}else throw new Error("At least one of `input_points` or `input_boxes` must be provided.");let n=this.sessions.prompt_encoder_mask_decoder,o=Me(e,n.inputNames);return await q(n,o)}async _call(e){return new Ii(await super._call(e))}},Hh=class extends uo{},Xh=class extends uo{};var Ws=class extends f{},Kh=class extends Ws{},Qh=class extends Ws{},Jh=class extends Ws{};var Vs=class extends f{},Yh=class extends Vs{},Zh=class extends Vs{},ex=class extends Vs{};var po=class extends f{},tx=class extends po{},_o=class extends po{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"text_model"})}},sx=class extends ft{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"vision_model"})}};var fo=class extends f{},rx=class extends fo{},nx=class extends fo{};var Hs=class extends f{main_input_name="input_values";forward_params=["input_values"]},ox=class extends Hs{async encode(e){return await q(this.sessions.encoder_model,e)}async decode(e){return await q(this.sessions.decoder_model,e)}},mo=class extends Hs{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"encoder_model"})}},ho=class extends Hs{static async from_pretrained(e,s={}){return super.from_pretrained(e,{...s,model_file_name:s.model_file_name??"decoder_model"})}};var Xs=class extends f{},ax=class extends Xs{},ix=class extends Xs{},lx=class extends Xs{async generate_speech(e,s,{threshold:r=.5,minlenratio:n=0,maxlenratio:o=20,vocoder:a=null}={}){let i={input_ids:e},{encoder_outputs:l,encoder_attention_mask:c}=await Je(this,i),u=l.dims[1]/this.config.reduction_factor,p=Math.floor(u*o),d=Math.floor(u*n),_=this.config.num_mel_bins,m=[],h=null,x=null,g=0;for(;;){++g;let E=Ap(!!x),A;x?A=x.output_sequence_out:A=new S("float32",new Float32Array(_),[1,1,_]);let b={use_cache_branch:E,output_sequence:A,encoder_attention_mask:c,speaker_embeddings:s,encoder_hidden_states:l};this.addPastKeyValues(b,h),x=await q(this.sessions.decoder_model_merged,b),h=this.getPastKeyValues(x,h);let{prob:O,spectrum:N}=x;if(m.push(N),g>=d&&(Array.from(O.data).filter(F=>F>=r).length>0||g>=p))break}let w=ne(m),{waveform:y}=await q(a.sessions.model,{spectrogram:w});return{spectrogram:w,waveform:y}}},cx=class extends f{main_input_name="spectrogram"};var ls=class extends f{},ux=class extends ls{},px=class extends ls{async _call(e){return new J(await super._call(e))}},dx=class extends ls{async _call(e){return new z(await super._call(e))}},_x=class extends ls{async _call(e){return new oe(await super._call(e))}};var xo=class extends f{},fx=class extends xo{},mx=class extends xo{};var go=class extends f{},hx=class extends go{},xx=class extends go{};var Ti=class extends f{},gx=class extends Ti{};var Pi=class extends f{},wo=class extends Pi{async generate_speech({input_ids:e,attention_mask:s,style:r,num_inference_steps:n=5,speed:o=1.05}){let{sampling_rate:a,chunk_compress_factor:i,base_chunk_size:l,latent_dim:c}=this.config,{last_hidden_state:u,durations:p}=await q(this.sessions.text_encoder,{input_ids:e,attention_mask:s,style:r}),d=p.div(o).mul_(a),_=l*i,m=d.data,h=Int32Array.from(m,R=>Math.ceil(R/_)),x=Math.max(...h),g=e.dims[0],w=new BigInt64Array(g*x);for(let R=0;R<g;++R)w.fill(1n,R*x,R*x+h[R]);let y=new S("int64",w,[g,x]),E=c*i,A=E*x,b=Dw([g,E,x]),O=b.data;for(let R=0;R<g;++R)if(h[R]!==x)for(let B=0;B<E;++B)O.fill(0,R*A+B*x+h[R],R*A+(B+1)*x);let N=xe([g],n);for(let R=0;R<n;++R){let B=xe([g],R);({denoised_latents:b}=await q(this.sessions.latent_denoiser,{style:r,noisy_latents:b,latent_mask:y,encoder_outputs:u,attention_mask:s,timestep:B,num_inference_steps:N}))}let{waveform:F}=await q(this.sessions.voice_decoder,{latents:b});return{waveform:F,durations:d}}};var Ks=class extends f{},wx=class extends Ks{},yx=class extends Ks{async _call(e){return new z(await super._call(e))}},bx=class extends Ks{};var yo=class extends f{},kx=class extends yo{},vx=class extends yo{};var bo=class extends f{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"]},Ex=class extends bo{},Ax=class extends bo{};var ko=class extends f{},Mx=class extends ko{},Sx=class extends ko{async _call(e){return new Ci(await super._call(e))}},Ci=class extends Rs{};var Ni=class extends f{},Ox=class extends Ni{};var Li=class extends f{forward_params=["input_ids","attention_mask","position_ids","audio_values","past_key_values"]},$i=class extends Li{_merge_input_ids_with_audio_features(e){let s=e.audio_features.dims.at(-1),r=e.audio_features.view(-1,s);return Ha({audio_token_id:this.config.ignore_index??this.config.audio_token_id,...e,audio_features:r})}},Ix=class extends $i{};var Qs=class extends f{},zx=class extends Qs{},Tx=class extends Qs{async _call(e){return new $e(await super._call(e))}},Px=class extends Qs{async _call(e){return new z(await super._call(e))}};var cs=class extends f{},Cx=class extends cs{},Nx=class extends cs{async _call(e){return new $e(await super._call(e))}},Lx=class extends cs{async _call(e){return new z(await super._call(e))}},$x=class extends cs{async _call(e){return new K(await super._call(e))}};var vo=class extends f{},Rx=class extends vo{},Fx=class extends vo{};var Dx=class extends f{main_input_name="pixel_values";forward_params=["pixel_values","decoder_input_ids","encoder_hidden_states","past_key_values"]};var Eo=class extends f{},jx=class extends Eo{},Bx=class extends Eo{async _call(e){return new z(await super._call(e))}};var Ri=class extends f{},Ux=class extends Ri{};var Ao=class extends f{},qx=class extends Ao{},Gx=class extends Ao{async _call(e){return new z(await super._call(e))}};var Fi=class extends f{},Wx=class extends Fi{async _call(e){return new za(await super._call(e))}};var Di=class extends f{},Vx=class extends Di{};var ji=class extends pe{constructor({waveform:e,spectrogram:s}){super(),this.waveform=e,this.spectrogram=s}},Bi=class extends f{},Hx=class extends Bi{async _call(e){return new ji(await super._call(e))}};var Js=class extends f{},Xx=class extends Js{},Kx=class extends Js{async _call(e){return new $e(await super._call(e))}},Qx=class extends Js{async _call(e){return new z(await super._call(e))}};var Ui=class extends pe{constructor({logits:e,embeddings:s}){super(),this.logits=e,this.embeddings=s}},Dt=class extends f{},Jx=class extends Dt{},Yx=class extends Dt{async _call(e){return new $e(await super._call(e))}},Zx=class extends Dt{async _call(e){return new z(await super._call(e))}},eg=class extends Dt{async _call(e){return new Ui(await super._call(e))}},tg=class extends Dt{async _call(e){return new K(await super._call(e))}};var qi=class extends f{},sg=class extends qi{};var Gi=class extends Ts{return_timestamps=null;return_token_timestamps=null;num_frames=null;alignment_heads=null;task=null;language=null;no_timestamps_token_id=null;prompt_ids=null;is_multilingual=null;lang_to_id=null;task_to_id=null;max_initial_timestamp_index=1};var Mo=class extends f{requires_attention_mask=!1;main_input_name="input_features";forward_params=["input_features","attention_mask","decoder_input_ids","decoder_attention_mask","past_key_values"]},rg=class extends Mo{},Wi=class extends Mo{_prepare_generation_config(e,s){return super._prepare_generation_config(e,s,Gi)}_retrieve_init_tokens(e){let s=[e.decoder_start_token_id],r=e.language,n=e.task;if(e.is_multilingual){r||(console.warn("No language specified - defaulting to English (en)."),r="en");let a=`<|${Uw(r)}|>`;s.push(e.lang_to_id[a]),s.push(e.task_to_id[n??"transcribe"])}else if(r||n)throw new Error("Cannot specify `task` or `language` for an English-only model. If the model is intended to be multilingual, pass `is_multilingual=true` to generate, or update the generation config.");return!e.return_timestamps&&e.no_timestamps_token_id&&s.at(-1)!==e.no_timestamps_token_id?s.push(e.no_timestamps_token_id):e.return_timestamps&&s.at(-1)===e.no_timestamps_token_id&&(console.warn("<|notimestamps|> prompt token is removed from generation_config since `return_timestamps` is set to `true`."),s.pop()),s.filter(o=>o!=null)}async generate({inputs:e=null,generation_config:s=null,logits_processor:r=null,stopping_criteria:n=null,...o}){s=this._prepare_generation_config(s,o);let a=o.decoder_input_ids??this._retrieve_init_tokens(s);if(s.return_timestamps&&(r??=new Zt,r.push(new Ca(s,a))),s.begin_suppress_tokens&&(r??=new Zt,r.push(new zs(s.begin_suppress_tokens,a.length))),s.return_token_timestamps){if(!s.alignment_heads)throw new Error("Model generation config has no `alignment_heads`, token-level timestamps not available. See https://gist.github.com/hollance/42e32852f24243b748ae6bc1f985b13a on how to add this property to the generation config.");s.task==="translate"&&console.warn("Token-level timestamps may not be reliable for task 'translate'."),s.output_attentions=!0,s.return_dict_in_generate=!0}let i=await super.generate({inputs:e,generation_config:s,logits_processor:r,decoder_input_ids:a,...o});return s.return_token_timestamps&&(i.token_timestamps=this._extract_token_timestamps(i,s.alignment_heads,s.num_frames)),i}_extract_token_timestamps(e,s,r=null,n=.02){if(!e.cross_attentions)throw new Error("Model outputs must contain cross attentions to extract timestamps. This is most likely because the model was not exported with `output_attentions=True`.");r==null&&console.warn("`num_frames` has not been set, meaning the entire audio will be analyzed. This may lead to inaccurate token-level timestamps for short audios (< 30 seconds).");let o=this.config.median_filter_width;o===void 0&&(console.warn("Model config has no `median_filter_width`, using default value of 7."),o=7);let a=e.cross_attentions,i=Array.from({length:this.config.decoder_layers},(h,x)=>ne(a.map(g=>g[x]),2)),l=Ke(s.map(([h,x])=>{if(h>=i.length)throw new Error(`Layer index ${h} is out of bounds for cross attentions (length ${i.length}).`);return r?i[h].slice(null,x,null,[0,r]):i[h].slice(null,x)})).transpose(1,0,2,3),[c,u]=Zl(l,-2,0,!0),p=l.clone();for(let h=0;h<p.dims[0];++h){let x=p[h];for(let g=0;g<x.dims[0];++g){let w=x[g],y=c[h][g][0].data,E=u[h][g][0].data;for(let A=0;A<w.dims[0];++A){let b=w[A].data;for(let O=0;O<b.length;++O)b[O]=(b[O]-E[O])/y[O];b.set(ww(b,o))}}}let d=[ta(p,1)],_=e.sequences.dims,m=new S("float32",new Float32Array(_[0]*_[1]),_);for(let h=0;h<_[0];++h){let x=d[h].neg().squeeze_(0),[g,w]=bw(x.tolist()),y=Array.from({length:g.length-1},(b,O)=>g[O+1]-g[O]),E=Pe([1],y).map(b=>!!b),A=[];for(let b=0;b<E.length;++b)E[b]&&A.push(w[b]*n);m[h].data.set(A,1)}return m}},ng=class extends Wi{};var jt=class extends f{},og=class extends jt{},ag=class extends jt{async _call(e){return new J(await super._call(e))}},ig=class extends jt{async _call(e){return new z(await super._call(e))}},lg=class extends jt{async _call(e){return new K(await super._call(e))}},cg=class extends jt{async _call(e){return new oe(await super._call(e))}};var Bt=class extends f{},ug=class extends Bt{},pg=class extends Bt{async _call(e){return new J(await super._call(e))}},dg=class extends Bt{async _call(e){return new z(await super._call(e))}},_g=class extends Bt{async _call(e){return new K(await super._call(e))}},fg=class extends Bt{async _call(e){return new oe(await super._call(e))}};var So=class extends f{},mg=class extends So{},hg=class extends So{async _call(e){return new Vi(await super._call(e))}},Vi=class extends pe{constructor({logits:e,pred_boxes:s}){super(),this.logits=e,this.pred_boxes=s}};var Oo=class extends f{},xg=class extends Oo{},gg=class extends Oo{};var Sv=new Map([["bert","BertModel"],["neobert","NeoBertModel"],["modernbert","ModernBertModel"],["nomic_bert","NomicBertModel"],["roformer","RoFormerModel"],["electra","ElectraModel"],["esm","EsmModel"],["convbert","ConvBertModel"],["camembert","CamembertModel"],["deberta","DebertaModel"],["deberta-v2","DebertaV2Model"],["mpnet","MPNetModel"],["albert","AlbertModel"],["distilbert","DistilBertModel"],["roberta","RobertaModel"],["xlm","XLMModel"],["xlm-roberta","XLMRobertaModel"],["clap","ClapModel"],["clip","CLIPModel"],["clipseg","CLIPSegModel"],["chinese_clip","ChineseCLIPModel"],["siglip","SiglipModel"],["jina_clip","JinaCLIPModel"],["mobilebert","MobileBertModel"],["squeezebert","SqueezeBertModel"],["wav2vec2","Wav2Vec2Model"],["wav2vec2-bert","Wav2Vec2BertModel"],["unispeech","UniSpeechModel"],["unispeech-sat","UniSpeechSatModel"],["hubert","HubertModel"],["wavlm","WavLMModel"],["audio-spectrogram-transformer","ASTModel"],["vits","VitsModel"],["pyannote","PyAnnoteModel"],["wespeaker-resnet","WeSpeakerResNetModel"],["detr","DetrModel"],["rt_detr","RTDetrModel"],["rt_detr_v2","RTDetrV2Model"],["rf_detr","RFDetrModel"],["d_fine","DFineModel"],["table-transformer","TableTransformerModel"],["vit","ViTModel"],["ijepa","IJepaModel"],["pvt","PvtModel"],["vit_msn","ViTMSNModel"],["vit_mae","ViTMAEModel"],["groupvit","GroupViTModel"],["fastvit","FastViTModel"],["mobilevit","MobileViTModel"],["mobilevitv2","MobileViTV2Model"],["owlvit","OwlViTModel"],["owlv2","Owlv2Model"],["beit","BeitModel"],["deit","DeiTModel"],["hiera","HieraModel"],["convnext","ConvNextModel"],["convnextv2","ConvNextV2Model"],["dinov2","Dinov2Model"],["dinov2_with_registers","Dinov2WithRegistersModel"],["dinov3_vit","DINOv3ViTModel"],["dinov3_convnext","DINOv3ConvNextModel"],["resnet","ResNetModel"],["swin","SwinModel"],["swin2sr","Swin2SRModel"],["donut-swin","DonutSwinModel"],["yolos","YolosModel"],["dpt","DPTModel"],["glpn","GLPNModel"],["hifigan","SpeechT5HifiGan"],["efficientnet","EfficientNetModel"],["decision_transformer","DecisionTransformerModel"],["patchtst","PatchTSTModel"],["patchtsmixer","PatchTSMixerModel"],["mobilenet_v1","MobileNetV1Model"],["mobilenet_v2","MobileNetV2Model"],["mobilenet_v3","MobileNetV3Model"],["mobilenet_v4","MobileNetV4Model"],["maskformer","MaskFormerModel"],["mgp-str","MgpstrForSceneTextRecognition"],["style_text_to_speech_2","StyleTextToSpeech2Model"]]),Ov=new Map([["t5","T5Model"],["longt5","LongT5Model"],["mt5","MT5Model"],["bart","BartModel"],["mbart","MBartModel"],["marian","MarianModel"],["whisper","WhisperModel"],["m2m_100","M2M100Model"],["blenderbot","BlenderbotModel"],["blenderbot-small","BlenderbotSmallModel"]]),Iv=new Map([["mimi","MimiModel"],["dac","DacModel"],["snac","SnacModel"]]),zv=new Map([["bloom","BloomModel"],["jais","JAISModel"],["gpt2","GPT2Model"],["gpt_oss","GptOssModel"],["gptj","GPTJModel"],["gpt_bigcode","GPTBigCodeModel"],["gpt_neo","GPTNeoModel"],["gpt_neox","GPTNeoXModel"],["codegen","CodeGenModel"],["llama","LlamaModel"],["apertus","ApertusModel"],["nanochat","NanoChatModel"],["arcee","ArceeModel"],["lfm2","Lfm2Model"],["lfm2_moe","Lfm2MoeModel"],["smollm3","SmolLM3Model"],["exaone","ExaoneModel"],["olmo","OlmoModel"],["olmo2","Olmo2Model"],["olmo3","Olmo3Model"],["mobilellm","MobileLLMModel"],["granite","GraniteModel"],["granitemoehybrid","GraniteMoeHybridModel"],["cohere","CohereModel"],["cohere2","Cohere2Model"],["gemma","GemmaModel"],["gemma2","Gemma2Model"],["vaultgemma","VaultGemmaModel"],["gemma3_text","Gemma3Model"],["helium","HeliumModel"],["glm","GlmModel"],["openelm","OpenELMModel"],["qwen2","Qwen2Model"],["qwen3","Qwen3Model"],["phi","PhiModel"],["phi3","Phi3Model"],["mpt","MptModel"],["opt","OPTModel"],["mistral","MistralModel"],["ministral","MinistralModel"],["ministral3","Ministral3Model"],["ernie4_5","Ernie4_5_Model"],["starcoder2","Starcoder2Model"],["falcon","FalconModel"],["falcon_h1","FalconH1Model"],["stablelm","StableLmModel"],["modernbert-decoder","ModernBertDecoderModel"],["hunyuan_v1_dense","HunYuanDenseV1Model"],["youtu","YoutuModel"]]),_y=new Map([["speecht5","SpeechT5ForSpeechToText"],["whisper","WhisperForConditionalGeneration"],["lite-whisper","LiteWhisperForConditionalGeneration"],["moonshine","MoonshineForConditionalGeneration"]]),fy=new Map([["speecht5","SpeechT5ForTextToSpeech"]]),my=new Map([["vits","VitsModel"],["musicgen","MusicgenForConditionalGeneration"],["supertonic","SupertonicForConditionalGeneration"]]),hy=new Map([["bert","BertForSequenceClassification"],["neobert","NeoBertForSequenceClassification"],["modernbert","ModernBertForSequenceClassification"],["roformer","RoFormerForSequenceClassification"],["electra","ElectraForSequenceClassification"],["esm","EsmForSequenceClassification"],["convbert","ConvBertForSequenceClassification"],["camembert","CamembertForSequenceClassification"],["deberta","DebertaForSequenceClassification"],["deberta-v2","DebertaV2ForSequenceClassification"],["mpnet","MPNetForSequenceClassification"],["albert","AlbertForSequenceClassification"],["distilbert","DistilBertForSequenceClassification"],["roberta","RobertaForSequenceClassification"],["xlm","XLMForSequenceClassification"],["xlm-roberta","XLMRobertaForSequenceClassification"],["bart","BartForSequenceClassification"],["mbart","MBartForSequenceClassification"],["mobilebert","MobileBertForSequenceClassification"],["squeezebert","SqueezeBertForSequenceClassification"]]),xy=new Map([["bert","BertForTokenClassification"],["neobert","NeoBertForTokenClassification"],["modernbert","ModernBertForTokenClassification"],["roformer","RoFormerForTokenClassification"],["electra","ElectraForTokenClassification"],["esm","EsmForTokenClassification"],["convbert","ConvBertForTokenClassification"],["camembert","CamembertForTokenClassification"],["deberta","DebertaForTokenClassification"],["deberta-v2","DebertaV2ForTokenClassification"],["mpnet","MPNetForTokenClassification"],["distilbert","DistilBertForTokenClassification"],["roberta","RobertaForTokenClassification"],["xlm","XLMForTokenClassification"],["xlm-roberta","XLMRobertaForTokenClassification"]]),gy=new Map([["t5","T5ForConditionalGeneration"],["longt5","LongT5ForConditionalGeneration"],["mt5","MT5ForConditionalGeneration"],["bart","BartForConditionalGeneration"],["mbart","MBartForConditionalGeneration"],["marian","MarianMTModel"],["m2m_100","M2M100ForConditionalGeneration"],["blenderbot","BlenderbotForConditionalGeneration"],["blenderbot-small","BlenderbotSmallForConditionalGeneration"]]),wy=new Map([["bloom","BloomForCausalLM"],["gpt2","GPT2LMHeadModel"],["gpt_oss","GptOssForCausalLM"],["jais","JAISLMHeadModel"],["gptj","GPTJForCausalLM"],["gpt_bigcode","GPTBigCodeForCausalLM"],["gpt_neo","GPTNeoForCausalLM"],["gpt_neox","GPTNeoXForCausalLM"],["codegen","CodeGenForCausalLM"],["llama","LlamaForCausalLM"],["nanochat","NanoChatForCausalLM"],["apertus","ApertusForCausalLM"],["llama4_text","Llama4ForCausalLM"],["arcee","ArceeForCausalLM"],["lfm2","Lfm2ForCausalLM"],["lfm2_moe","Lfm2MoeForCausalLM"],["smollm3","SmolLM3ForCausalLM"],["exaone","ExaoneForCausalLM"],["olmo","OlmoForCausalLM"],["olmo2","Olmo2ForCausalLM"],["olmo3","Olmo3ForCausalLM"],["mobilellm","MobileLLMForCausalLM"],["granite","GraniteForCausalLM"],["granitemoehybrid","GraniteMoeHybridForCausalLM"],["cohere","CohereForCausalLM"],["cohere2","Cohere2ForCausalLM"],["gemma","GemmaForCausalLM"],["gemma2","Gemma2ForCausalLM"],["vaultgemma","VaultGemmaForCausalLM"],["gemma3_text","Gemma3ForCausalLM"],["helium","HeliumForCausalLM"],["glm","GlmForCausalLM"],["openelm","OpenELMForCausalLM"],["qwen2","Qwen2ForCausalLM"],["qwen3","Qwen3ForCausalLM"],["phi","PhiForCausalLM"],["phi3","Phi3ForCausalLM"],["mpt","MptForCausalLM"],["opt","OPTForCausalLM"],["mbart","MBartForCausalLM"],["mistral","MistralForCausalLM"],["ministral","MinistralForCausalLM"],["ministral3","Ministral3ForCausalLM"],["ernie4_5","Ernie4_5_ForCausalLM"],["starcoder2","Starcoder2ForCausalLM"],["falcon","FalconForCausalLM"],["falcon_h1","FalconH1ForCausalLM"],["trocr","TrOCRForCausalLM"],["stablelm","StableLmForCausalLM"],["modernbert-decoder","ModernBertDecoderForCausalLM"],["hunyuan_v1_dense","HunYuanDenseV1ForCausalLM"],["youtu","YoutuForCausalLM"],["phi3_v","Phi3VForCausalLM"]]),Tv=new Map([["multi_modality","MultiModalityCausalLM"]]),yy=new Map([["bert","BertForMaskedLM"],["neobert","NeoBertForMaskedLM"],["modernbert","ModernBertForMaskedLM"],["roformer","RoFormerForMaskedLM"],["electra","ElectraForMaskedLM"],["esm","EsmForMaskedLM"],["convbert","ConvBertForMaskedLM"],["camembert","CamembertForMaskedLM"],["deberta","DebertaForMaskedLM"],["deberta-v2","DebertaV2ForMaskedLM"],["mpnet","MPNetForMaskedLM"],["albert","AlbertForMaskedLM"],["distilbert","DistilBertForMaskedLM"],["roberta","RobertaForMaskedLM"],["xlm","XLMWithLMHeadModel"],["xlm-roberta","XLMRobertaForMaskedLM"],["mobilebert","MobileBertForMaskedLM"],["squeezebert","SqueezeBertForMaskedLM"]]),by=new Map([["bert","BertForQuestionAnswering"],["neobert","NeoBertForQuestionAnswering"],["roformer","RoFormerForQuestionAnswering"],["electra","ElectraForQuestionAnswering"],["convbert","ConvBertForQuestionAnswering"],["camembert","CamembertForQuestionAnswering"],["deberta","DebertaForQuestionAnswering"],["deberta-v2","DebertaV2ForQuestionAnswering"],["mpnet","MPNetForQuestionAnswering"],["albert","AlbertForQuestionAnswering"],["distilbert","DistilBertForQuestionAnswering"],["roberta","RobertaForQuestionAnswering"],["xlm","XLMForQuestionAnswering"],["xlm-roberta","XLMRobertaForQuestionAnswering"],["mobilebert","MobileBertForQuestionAnswering"],["squeezebert","SqueezeBertForQuestionAnswering"]]),ky=new Map([["vision-encoder-decoder","VisionEncoderDecoderModel"],["idefics3","Idefics3ForConditionalGeneration"],["smolvlm","SmolVLMForConditionalGeneration"]]),vy=new Map([["llava","LlavaForConditionalGeneration"],["llava_onevision","LlavaOnevisionForConditionalGeneration"],["moondream1","Moondream1ForConditionalGeneration"],["florence2","Florence2ForConditionalGeneration"],["qwen2-vl","Qwen2VLForConditionalGeneration"],["idefics3","Idefics3ForConditionalGeneration"],["smolvlm","SmolVLMForConditionalGeneration"],["paligemma","PaliGemmaForConditionalGeneration"],["llava_qwen2","LlavaQwen2ForCausalLM"],["gemma3n","Gemma3nForConditionalGeneration"],["mistral3","Mistral3ForConditionalGeneration"]]),Ey=new Map([["ultravox","UltravoxModel"],["voxtral","VoxtralForConditionalGeneration"]]),Pv=new Map([["vision-encoder-decoder","VisionEncoderDecoderModel"]]),Ay=new Map([["vit","ViTForImageClassification"],["ijepa","IJepaForImageClassification"],["pvt","PvtForImageClassification"],["vit_msn","ViTMSNForImageClassification"],["fastvit","FastViTForImageClassification"],["mobilevit","MobileViTForImageClassification"],["mobilevitv2","MobileViTV2ForImageClassification"],["beit","BeitForImageClassification"],["deit","DeiTForImageClassification"],["hiera","HieraForImageClassification"],["convnext","ConvNextForImageClassification"],["convnextv2","ConvNextV2ForImageClassification"],["dinov2","Dinov2ForImageClassification"],["dinov2_with_registers","Dinov2WithRegistersForImageClassification"],["resnet","ResNetForImageClassification"],["swin","SwinForImageClassification"],["segformer","SegformerForImageClassification"],["efficientnet","EfficientNetForImageClassification"],["mobilenet_v1","MobileNetV1ForImageClassification"],["mobilenet_v2","MobileNetV2ForImageClassification"],["mobilenet_v3","MobileNetV3ForImageClassification"],["mobilenet_v4","MobileNetV4ForImageClassification"]]),My=new Map([["detr","DetrForObjectDetection"],["rt_detr","RTDetrForObjectDetection"],["rt_detr_v2","RTDetrV2ForObjectDetection"],["rf_detr","RFDetrForObjectDetection"],["d_fine","DFineForObjectDetection"],["table-transformer","TableTransformerForObjectDetection"],["yolos","YolosForObjectDetection"]]),Sy=new Map([["owlvit","OwlViTForObjectDetection"],["owlv2","Owlv2ForObjectDetection"],["grounding-dino","GroundingDinoForObjectDetection"]]),Ys=new Map([["detr","DetrForSegmentation"],["clipseg","CLIPSegForImageSegmentation"]]),Oy=new Map([["segformer","SegformerForSemanticSegmentation"],["sapiens","SapiensForSemanticSegmentation"],["swin","SwinForSemanticSegmentation"],["mobilenet_v1","MobileNetV1ForSemanticSegmentation"],["mobilenet_v2","MobileNetV2ForSemanticSegmentation"],["mobilenet_v3","MobileNetV3ForSemanticSegmentation"],["mobilenet_v4","MobileNetV4ForSemanticSegmentation"]]),Iy=new Map([["detr","DetrForSegmentation"],["maskformer","MaskFormerForInstanceSegmentation"]]),zy=new Map([["sam","SamModel"],["sam2","Sam2Model"],["edgetam","EdgeTamModel"],["sam3_tracker","Sam3TrackerModel"]]),Ty=new Map([["wav2vec2","Wav2Vec2ForCTC"],["wav2vec2-bert","Wav2Vec2BertForCTC"],["unispeech","UniSpeechForCTC"],["unispeech-sat","UniSpeechSatForCTC"],["wavlm","WavLMForCTC"],["hubert","HubertForCTC"],["parakeet_ctc","ParakeetForCTC"]]),Py=new Map([["wav2vec2","Wav2Vec2ForSequenceClassification"],["wav2vec2-bert","Wav2Vec2BertForSequenceClassification"],["unispeech","UniSpeechForSequenceClassification"],["unispeech-sat","UniSpeechSatForSequenceClassification"],["wavlm","WavLMForSequenceClassification"],["hubert","HubertForSequenceClassification"],["audio-spectrogram-transformer","ASTForAudioClassification"]]),Cy=new Map([["wavlm","WavLMForXVector"]]),Ny=new Map([["unispeech-sat","UniSpeechSatForAudioFrameClassification"],["wavlm","WavLMForAudioFrameClassification"],["wav2vec2","Wav2Vec2ForAudioFrameClassification"],["pyannote","PyAnnoteForAudioFrameClassification"]]),Ly=new Map([["vitmatte","VitMatteForImageMatting"]]),Cv=new Map([["patchtst","PatchTSTForPrediction"],["patchtsmixer","PatchTSMixerForPrediction"]]),$y=new Map([["swin2sr","Swin2SRForImageSuperResolution"]]),Ry=new Map([["dpt","DPTForDepthEstimation"],["depth_anything","DepthAnythingForDepthEstimation"],["glpn","GLPNForDepthEstimation"],["sapiens","SapiensForDepthEstimation"],["depth_pro","DepthProForDepthEstimation"],["metric3d","Metric3DForDepthEstimation"],["metric3dv2","Metric3Dv2ForDepthEstimation"]]),Fy=new Map([["sapiens","SapiensForNormalEstimation"]]),Dy=new Map([["vitpose","VitPoseForPoseEstimation"]]),jy=new Map([["clip","CLIPVisionModelWithProjection"],["siglip","SiglipVisionModel"],["jina_clip","JinaCLIPVisionModel"]]),wg=[[Sv,C.EncoderOnly],[Ov,C.EncoderDecoder],[zv,C.DecoderOnlyWithoutHead],[Iv,C.AutoEncoder],[hy,C.EncoderOnly],[xy,C.EncoderOnly],[gy,C.Seq2Seq],[_y,C.Seq2Seq],[wy,C.DecoderOnly],[Tv,C.MultiModality],[yy,C.EncoderOnly],[by,C.EncoderOnly],[ky,C.Vision2Seq],[vy,C.ImageTextToText],[Ey,C.AudioTextToText],[Ay,C.EncoderOnly],[Ys,C.EncoderOnly],[Iy,C.EncoderOnly],[Oy,C.EncoderOnly],[Ly,C.EncoderOnly],[Cv,C.EncoderOnly],[$y,C.EncoderOnly],[Ry,C.EncoderOnly],[Fy,C.EncoderOnly],[Dy,C.EncoderOnly],[My,C.EncoderOnly],[Sy,C.EncoderOnly],[zy,C.MaskGeneration],[Ty,C.EncoderOnly],[Py,C.EncoderOnly],[fy,C.Seq2Seq],[my,C.EncoderOnly],[Cy,C.EncoderOnly],[Ny,C.EncoderOnly],[jy,C.EncoderOnly]];for(let[t,e]of wg)for(let s of t.values()){ss.set(s,e);let r=Io[s];ts.set(r,s),Va.set(s,r)}var Nv=[["MusicgenForConditionalGeneration",qn,C.Musicgen],["Phi3VForCausalLM",so,C.Phi3V],["CLIPTextModelWithProjection",Rr,C.EncoderOnly],["SiglipTextModel",_o,C.EncoderOnly],["JinaCLIPTextModel",En,C.EncoderOnly],["ClapTextModelWithProjection",Lr,C.EncoderOnly],["ClapAudioModelWithProjection",$r,C.EncoderOnly],["DacEncoderModel",Vr,C.EncoderOnly],["DacDecoderModel",Hr,C.EncoderOnly],["MimiEncoderModel",Pn,C.EncoderOnly],["MimiDecoderModel",Cn,C.EncoderOnly],["SnacEncoderModel",mo,C.EncoderOnly],["SnacDecoderModel",ho,C.EncoderOnly],["Gemma3nForConditionalGeneration",ln,C.ImageAudioTextToText],["SupertonicForConditionalGeneration",wo,C.Supertonic],["ChatterboxModel",Nr,C.Chatterbox]];for(let[t,e,s]of Nv)ss.set(t,s),ts.set(e,t),Va.set(t,e);var yg=new Map([["modnet",Ys],["birefnet",Ys],["isnet",Ys],["ben",Ys]]);for(let[t,e]of yg.entries())e.set(t,"PreTrainedModel"),ss.set(t,C.EncoderOnly),Va.set(t,f);ss.set("PreTrainedModel",C.EncoderOnly);ts.set(f,"PreTrainedModel");var le={MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES:hy,MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING_NAMES:xy,MODEL_FOR_TEXT_TO_SPECTROGRAM_MAPPING_NAMES:fy,MODEL_FOR_TEXT_TO_WAVEFORM_MAPPING_NAMES:my,MODEL_FOR_MASKED_LM_MAPPING_NAMES:yy,MODEL_FOR_QUESTION_ANSWERING_MAPPING_NAMES:by,MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING_NAMES:Ay,MODEL_FOR_IMAGE_SEGMENTATION_MAPPING_NAMES:Ys,MODEL_FOR_SEMANTIC_SEGMENTATION_MAPPING_NAMES:Oy,MODEL_FOR_UNIVERSAL_SEGMENTATION_MAPPING_NAMES:Iy,MODEL_FOR_OBJECT_DETECTION_MAPPING_NAMES:My,MODEL_FOR_ZERO_SHOT_OBJECT_DETECTION_MAPPING_NAMES:Sy,MODEL_FOR_MASK_GENERATION_MAPPING_NAMES:zy,MODEL_FOR_CTC_MAPPING_NAMES:Ty,MODEL_FOR_AUDIO_CLASSIFICATION_MAPPING_NAMES:Py,MODEL_FOR_AUDIO_XVECTOR_MAPPING_NAMES:Cy,MODEL_FOR_AUDIO_FRAME_CLASSIFICATION_MAPPING_NAMES:Ny,MODEL_FOR_DOCUMENT_QUESTION_ANSWERING_MAPPING_NAMES:Pv,MODEL_FOR_IMAGE_MATTING_MAPPING_NAMES:Ly,MODEL_FOR_IMAGE_TO_IMAGE_MAPPING_NAMES:$y,MODEL_FOR_DEPTH_ESTIMATION_MAPPING_NAMES:Ry,MODEL_FOR_NORMAL_ESTIMATION_MAPPING_NAMES:Fy,MODEL_FOR_POSE_ESTIMATION_MAPPING_NAMES:Dy,MODEL_FOR_IMAGE_FEATURE_EXTRACTION_MAPPING_NAMES:jy,MODEL_FOR_IMAGE_TEXT_TO_TEXT_MAPPING_NAMES:vy,MODEL_FOR_AUDIO_TEXT_TO_TEXT_MAPPING_NAMES:Ey,MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING_NAMES:gy,MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING_NAMES:_y,MODEL_FOR_CAUSAL_LM_MAPPING_NAMES:wy,MODEL_FOR_VISION_2_SEQ_MAPPING_NAMES:ky};cy(le);var ie=class{static MODEL_CLASS_MAPPINGS=null;static BASE_IF_FAIL=!1;static async from_pretrained(e,{progress_callback:s=null,config:r=null,cache_dir:n=null,local_files_only:o=!1,revision:a="main",model_file_name:i=null,subfolder:l="onnx",device:c=null,dtype:u=null,use_external_data_format:p=null,session_options:d={}}={}){let _={progress_callback:s,config:r,cache_dir:n,local_files_only:o,revision:a,model_file_name:i,subfolder:l,device:c,dtype:u,use_external_data_format:p,session_options:d};if(_.config=await Yt.from_pretrained(e,_),!this.MODEL_CLASS_MAPPINGS)throw new Error("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: "+this.name);let m=_.config.model_type;for(let h of this.MODEL_CLASS_MAPPINGS){let x=h.get(m);if(!x){for(let g of h.values())if(g[0]===m){x=g;break}if(!x)continue}return await Io[x].from_pretrained(e,_)}if(this.BASE_IF_FAIL)return yg.has(m)||console.warn(`Unknown model class "${m}", attempting to construct from base class.`),await f.from_pretrained(e,_);throw Error(`Unsupported model type: ${m}`)}},kt=class extends ie{static MODEL_CLASS_MAPPINGS=wg.map(e=>e[0]);static BASE_IF_FAIL=!0},zo=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES]},Hi=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING_NAMES]},Zs=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING_NAMES]},Xi=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_SPEECH_SEQ_2_SEQ_MAPPING_NAMES]},Ki=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_TEXT_TO_SPECTROGRAM_MAPPING_NAMES]},Qi=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_TEXT_TO_WAVEFORM_MAPPING_NAMES]},Ji=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_CAUSAL_LM_MAPPING_NAMES]},Yi=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_MASKED_LM_MAPPING_NAMES]},Zi=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_QUESTION_ANSWERING_MAPPING_NAMES]},el=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_VISION_2_SEQ_MAPPING_NAMES]},tl=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING_NAMES]},To=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_SEGMENTATION_MAPPING_NAMES]},Po=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_SEMANTIC_SEGMENTATION_MAPPING_NAMES]},Co=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_UNIVERSAL_SEGMENTATION_MAPPING_NAMES]},sl=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_OBJECT_DETECTION_MAPPING_NAMES]},rl=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_ZERO_SHOT_OBJECT_DETECTION_MAPPING_NAMES]},By=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_MASK_GENERATION_MAPPING_NAMES]},nl=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_CTC_MAPPING_NAMES]},ol=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_AUDIO_CLASSIFICATION_MAPPING_NAMES]},Uy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_AUDIO_XVECTOR_MAPPING_NAMES]},qy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_AUDIO_FRAME_CLASSIFICATION_MAPPING_NAMES]},al=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_DOCUMENT_QUESTION_ANSWERING_MAPPING_NAMES]},Gy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_MATTING_MAPPING_NAMES]},il=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_TO_IMAGE_MAPPING_NAMES]},ll=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_DEPTH_ESTIMATION_MAPPING_NAMES]},Wy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_NORMAL_ESTIMATION_MAPPING_NAMES]},Vy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_POSE_ESTIMATION_MAPPING_NAMES]},cl=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_FEATURE_EXTRACTION_MAPPING_NAMES]},Hy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_IMAGE_TEXT_TO_TEXT_MAPPING_NAMES]},Xy=class extends ie{static MODEL_CLASS_MAPPINGS=[le.MODEL_FOR_AUDIO_TEXT_TO_TEXT_MAPPING_NAMES]};async function be(t){return Array.isArray(t)||(t=[t]),await Promise.all(t.map(e=>we.read(e)))}async function Ut(t,e){return Array.isArray(t)||(t=[t]),await Promise.all(t.map(s=>typeof s=="string"||s instanceof URL?Jc(s,e):s instanceof Float64Array?new Float32Array(s):s))}function No(t,e){e&&(t=t.map(a=>a|0));let[s,r,n,o]=t;return{xmin:s,ymin:r,xmax:n,ymax:o}}var W=class extends ke{constructor({task:e,model:s,tokenizer:r=null,processor:n=null}){super(),this.task=e,this.model=s,this.tokenizer=r,this.processor=n}async dispose(){await this.model.dispose()}};var ul=class extends W{async _call(e,{top_k:s=1}={}){let r=this.tokenizer(e,{padding:!0,truncation:!0}),n=await this.model(r),{problem_type:o,id2label:a}=this.model.config,i=o==="multi_label_classification"?c=>c.sigmoid():c=>new S("float32",ue(c.data),c.dims),l=[];for(let c of n.logits){let u=i(c),p=await ot(u,s),d=p[0].tolist(),m=p[1].tolist().map((h,x)=>({label:a?a[h]:`LABEL_${h}`,score:d[x]}));s===1?l.push(...m):l.push(m)}return Array.isArray(e)||s===1?l:l[0]}};var pl=class extends W{async _call(e,{ignore_labels:s=["O"]}={}){let r=Array.isArray(e),n=this.tokenizer(r?e:[e],{padding:!0,truncation:!0}),a=(await this.model(n)).logits,i=this.model.config.id2label,l=[];for(let c=0;c<a.dims[0];++c){let u=n.input_ids[c],p=a[c],d=[];for(let _=0;_<p.dims[0];++_){let m=p[_],h=ae(m.data)[1],x=i?i[h]:`LABEL_${h}`;if(s.includes(x))continue;let g=this.tokenizer.decode([u[_].item()],{skip_special_tokens:!0});if(g==="")continue;let w=ue(m.data);d.push({entity:x,score:w[h],index:_,word:g})}l.push(d)}return r?l:l[0]}};var dl=class extends W{async _call(e,s,{top_k:r=1}={}){let n=this.tokenizer(e,{text_pair:s,padding:!0,truncation:!0}),o=Array.isArray(e),{start_logits:a,end_logits:i}=await this.model(n),l=n.input_ids.tolist(),c=n.attention_mask.tolist(),{all_special_ids:u,sep_token_id:p}=this.tokenizer,d=[];for(let _=0;_<a.dims[0];++_){let m=l[_],h=m.findIndex(b=>b==p),x=a[_].tolist(),g=i[_].tolist();for(let b=1;b<x.length;++b)(c[_]==0||b<=h||u.findIndex(O=>O==m[b])!==-1)&&(x[b]=-1/0,g[b]=-1/0);let w=ue(x).map((b,O)=>[b,O]),y=ue(g).map((b,O)=>[b,O]);w[0][0]=0,y[0][0]=0;let E=aw(w,y).filter(b=>b[0][1]<=b[1][1]).map(b=>[b[0][1],b[1][1],b[0][0]*b[1][0]]).sort((b,O)=>O[2]-b[2]),A=[];for(let b=0;b<Math.min(E.length,r);++b){let[O,N,F]=E[b],R=m.slice(O,N+1),B=this.tokenizer.decode(R,{skip_special_tokens:!0});A.push({answer:B,score:F})}r===1?d.push(...A):d.push(A)}return o?d:d[0]}};var _l=class extends W{async _call(e,{top_k:s=5}={}){let{mask_token_id:r,mask_token:n}=this.tokenizer,o=this.tokenizer(e,{padding:!0,truncation:!0}),{logits:a}=await this.model(o),i=[],l=o.input_ids.tolist();for(let c=0;c<l.length;++c){let u=l[c],p=u.findIndex(x=>x==r);if(p===-1)throw Error(`Mask token (${n}) not found in text.`);let d=a[c][p],_=await ot(new S("float32",ue(d.data),d.dims),s),m=_[0].tolist(),h=_[1].tolist();i.push(h.map((x,g)=>{let w=u.slice();return w[p]=x,{score:m[g],token:Number(x),token_str:this.tokenizer.decode([x]),sequence:this.tokenizer.decode(w,{skip_special_tokens:!0})}}))}return Array.isArray(e)?i:i[0]}};var qt=class extends W{_key="generated_text";async _call(e,s={}){Array.isArray(e)||(e=[e]),this.model.config.prefix&&(e=e.map(l=>this.model.config.prefix+l));let r=this.model.config.task_specific_params;r&&r[this.task]&&r[this.task].prefix&&(e=e.map(l=>r[this.task].prefix+l));let n=this.tokenizer,o={padding:!0,truncation:!0},a;this.task==="translation"&&"_build_translation_inputs"in n?a=n._build_translation_inputs(e,o,s):a=n(e,o);let i=await this.model.generate({...a,...s});return n.batch_decode(i,{skip_special_tokens:!0}).map(l=>({[this._key]:l}))}};var fl=class extends qt{_key="summary_text"};var ml=class extends qt{_key="translation_text"};function Ky(t){return Array.isArray(t)&&t.every(e=>"role"in e&&"content"in e)}var hl=class extends W{async _call(e,s={}){let r=!1,n=!1,o=s.add_special_tokens??(this.tokenizer.add_bos_token||this.tokenizer.add_eos_token)??!1,a=s.tokenizer_encode_kwargs,i;if(typeof e=="string")i=e=[e];else if(Array.isArray(e)&&e.every(m=>typeof m=="string"))r=!0,i=e;else{if(Ky(e))e=[e];else if(Array.isArray(e)&&e.every(Ky))r=!0;else throw new Error("Input must be a string, an array of strings, a Chat, or an array of Chats");n=!0,i=e.map(m=>this.tokenizer.apply_chat_template(m,{tokenize:!1,add_generation_prompt:!0,...a})),o=!1,a=void 0}let l=n?!1:s.return_full_text??!0;this.tokenizer.padding_side="left";let c=this.tokenizer(i,{add_special_tokens:o,padding:!0,truncation:!0,...a}),u=await this.model.generate({...c,...s}),p=this.tokenizer.batch_decode(u,{skip_special_tokens:!0}),d;!l&&c.input_ids.dims.at(-1)>0&&(d=this.tokenizer.batch_decode(c.input_ids,{skip_special_tokens:!0}).map(m=>m.length));let _=Array.from({length:e.length},m=>[]);for(let m=0;m<p.length;++m){let h=Math.floor(m/u.dims[0]*e.length);d&&(p[m]=p[m].slice(d[h])),_[h].push({generated_text:n?[...e[h],{role:"assistant",content:p[m]}]:p[m]})}return!r&&_.length===1?_[0]:_}};var xl=class extends W{constructor(e){super(e),this.label2id=Object.fromEntries(Object.entries(this.model.config.label2id).map(([s,r])=>[s.toLowerCase(),r])),this.entailment_id=this.label2id.entailment,this.entailment_id===void 0&&(console.warn("Could not find 'entailment' in label2id mapping. Using 2 as entailment_id."),this.entailment_id=2),this.contradiction_id=this.label2id.contradiction??this.label2id.not_entailment,this.contradiction_id===void 0&&(console.warn("Could not find 'contradiction' in label2id mapping. Using 0 as contradiction_id."),this.contradiction_id=0)}async _call(e,s,{hypothesis_template:r="This example is {}.",multi_label:n=!1}={}){let o=Array.isArray(e);o||(e=[e]),Array.isArray(s)||(s=[s]);let a=s.map(c=>r.replace("{}",c)),i=n||s.length===1,l=[];for(let c of e){let u=[];for(let _ of a){let m=this.tokenizer(c,{text_pair:_,padding:!0,truncation:!0}),h=await this.model(m);i?u.push([h.logits.data[this.contradiction_id],h.logits.data[this.entailment_id]]):u.push(h.logits.data[this.entailment_id])}let d=(i?u.map(_=>ue(_)[1]):ue(u)).map((_,m)=>[_,m]).sort((_,m)=>m[0]-_[0]);l.push({sequence:c,labels:d.map(_=>s[_[1]]),scores:d.map(_=>_[0])})}return o?l:l[0]}};var gl=class extends W{async _call(e,{top_k:s=5}={}){let r=this.processor.feature_extractor.config.sampling_rate,n=await Ut(e,r),o=this.model.config.id2label,a=[];for(let i of n){let l=await this.processor(i),u=(await this.model(l)).logits[0],p=await ot(new S("float32",ue(u.data),u.dims),s),d=p[0].tolist(),m=p[1].tolist().map((h,x)=>({label:o?o[h]:`LABEL_${h}`,score:d[x]}));a.push(m)}return Array.isArray(e)?a:a[0]}};var wl=class extends W{async _call(e,s,{hypothesis_template:r="This is a sound of {}."}={}){let n=!Array.isArray(e);n&&(e=[e]);let o=s.map(u=>r.replace("{}",u)),a=this.tokenizer(o,{padding:!0,truncation:!0}),i=this.processor.feature_extractor.config.sampling_rate,l=await Ut(e,i),c=[];for(let u of l){let p=await this.processor(u),d=await this.model({...a,...p}),_=ue(d.logits_per_audio.data);c.push([..._].map((m,h)=>({score:m,label:s[h]})))}return n?c[0]:c}};var yl=class extends W{async _call(e,s={}){switch(this.model.config.model_type){case"whisper":case"lite-whisper":return this._call_whisper(e,s);case"wav2vec2":case"wav2vec2-bert":case"unispeech":case"unispeech-sat":case"hubert":case"parakeet_ctc":return this._call_wav2vec2(e,s);case"moonshine":return this._call_moonshine(e,s);default:throw new Error(`AutomaticSpeechRecognitionPipeline does not support model type '${this.model.config.model_type}'.`)}}async _call_wav2vec2(e,s){s.language&&console.warn('`language` parameter is not yet supported for `wav2vec2` models, defaulting to "English".'),s.task&&console.warn('`task` parameter is not yet supported for `wav2vec2` models, defaulting to "transcribe".');let r=!Array.isArray(e),n=r?[e]:e,o=this.processor.feature_extractor.config.sampling_rate,a=await Ut(n,o),i=[];for(let l of a){let c=await this.processor(l),p=(await this.model(c)).logits[0],d=[];for(let m of p)d.push(ae(m.data)[1]);let _=this.tokenizer.decode(d,{skip_special_tokens:!0}).trim();i.push({text:_})}return r?i[0]:i}async _call_whisper(e,s){let r=s.return_timestamps??!1,n=s.chunk_length_s??0,o=s.force_full_sequences??!1,a=s.stride_length_s??null,i={...s};r==="word"&&(i.return_token_timestamps=!0,i.return_timestamps=!1);let l=!Array.isArray(e),c=l?[e]:e,u=this.processor.feature_extractor.config,p=u.chunk_length/this.model.config.max_source_positions,d=u.hop_length,_=u.sampling_rate,m=await Ut(c,_),h=[];for(let x of m){let g=[];if(n>0){if(a===null)a=n/6;else if(n<=a)throw Error("`chunk_length_s` must be larger than `stride_length_s`.");let E=_*n,A=_*a,b=E-2*A,O=0;for(;;){let N=O+E,F=x.subarray(O,N),R=await this.processor(F),B=O===0,G=N>=x.length;if(g.push({stride:[F.length,B?0:A,G?0:A],input_features:R.input_features,is_last:G}),G)break;O+=b}}else g=[{stride:[x.length,0,0],input_features:(await this.processor(x)).input_features,is_last:!0}];for(let E of g){i.num_frames=Math.floor(E.stride[0]/d);let A=await this.model.generate({inputs:E.input_features,...i});r==="word"?(E.tokens=A.sequences.tolist()[0],E.token_timestamps=A.token_timestamps.tolist()[0].map(b=>Kt(b,2))):E.tokens=A[0].tolist(),E.stride=E.stride.map(b=>b/_)}let[w,y]=this.tokenizer._decode_asr(g,{time_precision:p,return_timestamps:r,force_full_sequences:o});h.push({text:w,...y})}return l?h[0]:h}async _call_moonshine(e,s){let r=!Array.isArray(e),n=r?[e]:e,o=this.processor.feature_extractor.config.sampling_rate,a=await Ut(n,o),i=[];for(let l of a){let c=await this.processor(l),u=Math.floor(l.length/o)*6,p=await this.model.generate({max_new_tokens:u,...s,...c}),d=this.processor.batch_decode(p,{skip_special_tokens:!0})[0];i.push({text:d})}return r?i[0]:i}};var bl=class extends W{DEFAULT_VOCODER_ID="Xenova/speecht5_hifigan";constructor(e){super(e),this.vocoder=e.vocoder??null}async _prepare_speaker_embeddings(e,s){if((typeof e=="string"||e instanceof URL)&&(e=new Float32Array(await(await fetch(e)).arrayBuffer())),e instanceof Float32Array)e=new S("float32",e,[e.length]);else if(!(e instanceof S))throw new Error("Speaker embeddings must be a `Tensor`, `Float32Array`, `string`, or `URL`.");if(s>1){if(e.dims[0]===1)e=e.repeat(s,1);else if(e.dims[0]!==s)throw new Error(`Expected speaker embeddings batch size to be 1 or ${s}, but got ${e.dims[0]}.`)}return e}_postprocess_waveform(e,s,r,n=null){let o=s.data,[a,i]=s.dims,l=n?n.data:null,c=[];for(let u=0;u<a;++u){let p=l?Math.min(Math.ceil(l[u]),i):i,d=u*i;c.push(new hr(o.slice(d,d+p),r))}return Array.isArray(e)?c:c[0]}async _call(e,s){return this.processor?this._call_text_to_spectrogram(e,s):this.model.config.model_type==="supertonic"?this._call_supertonic(e,s):this._call_text_to_waveform(e)}async _call_supertonic(e,{speaker_embeddings:s,num_inference_steps:r,speed:n}){if(!s)throw new Error("Speaker embeddings must be provided for Supertonic models.");let{sampling_rate:o,style_dim:a}=this.model.config,i=this.tokenizer(e,{padding:!0,truncation:!0}),l=i.input_ids.dims[0];s=await this._prepare_speaker_embeddings(s,l),s=s.view(l,-1,a);let{waveform:c,durations:u}=await this.model.generate_speech({...i,style:s,num_inference_steps:r,speed:n});return this._postprocess_waveform(e,c,o,u)}async _call_text_to_waveform(e){let s=this.tokenizer(e,{padding:!0,truncation:!0}),{waveform:r}=await this.model(s),n=this.model.config.sampling_rate;return this._postprocess_waveform(e,r,n)}async _call_text_to_spectrogram(e,{speaker_embeddings:s}){this.vocoder||(console.log("No vocoder specified, using default HifiGan vocoder."),this.vocoder=await kt.from_pretrained(this.DEFAULT_VOCODER_ID,{dtype:"fp32"}));let{input_ids:r}=this.tokenizer(e,{padding:!0,truncation:!0}),n=r.dims[0];s=await this._prepare_speaker_embeddings(s,n),s=s.view(n,-1);let{waveform:o}=await this.model.generate_speech(r,s,{vocoder:this.vocoder}),a=this.processor.feature_extractor.config.sampling_rate;return this._postprocess_waveform(e,o,a)}};var kl=class extends W{async _call(e,s={}){let r=Array.isArray(e),n=await be(e),{pixel_values:o}=await this.processor(n),a=[];for(let i of o){i.dims=[1,...i.dims];let l=await this.model.generate({inputs:i,...s}),c=this.tokenizer.batch_decode(l,{skip_special_tokens:!0}).map(u=>({generated_text:u.trim()}));a.push(c)}return r?a:a[0]}};var vl=class extends W{async _call(e,{top_k:s=5}={}){let r=await be(e),{pixel_values:n}=await this.processor(r),o=await this.model({pixel_values:n}),{id2label:a}=this.model.config,i=[];for(let l of o.logits){let c=await ot(new S("float32",ue(l.data),l.dims),s),u=c[0].tolist(),d=c[1].tolist().map((_,m)=>({label:a?a[_]:`LABEL_${_}`,score:u[m]}));i.push(d)}return Array.isArray(e)?i:i[0]}};var Qy={panoptic:"post_process_panoptic_segmentation",instance:"post_process_instance_segmentation",semantic:"post_process_semantic_segmentation"},er=class extends W{async _call(e,{threshold:s=.5,mask_threshold:r=.5,overlap_mask_area_threshold:n=.8,label_ids_to_fuse:o=null,target_sizes:a=null,subtask:i=null}={}){if(Array.isArray(e)&&e.length!==1)throw Error("Image segmentation pipeline currently only supports a batch size of 1.");let c=await be(e),u=c.map(w=>[w.height,w.width]),p=await this.processor(c),{inputNames:d,outputNames:_}=this.model.sessions.model;if(!d.includes("pixel_values")){if(d.length!==1)throw Error(`Expected a single input name, but got ${d.length} inputs: ${d}.`);let w=d[0];if(w in p)throw Error(`Input name ${w} already exists in the inputs.`);p[w]=p.pixel_values}let m=await this.model(p),h=null;if(i!==null)h=Qy[i];else if(this.processor.image_processor){for(let[w,y]of Object.entries(Qy))if(y in this.processor.image_processor){h=this.processor.image_processor[y].bind(this.processor.image_processor),i=w;break}}let x=this.model.config.id2label,g=[];if(i)if(i==="panoptic"||i==="instance"){let w=h(m,s,r,n,o,a??u)[0],y=w.segmentation;for(let E of w.segments_info){let A=new Uint8ClampedArray(y.data.length);for(let O=0;O<y.data.length;++O)y.data[O]===E.id&&(A[O]=255);let b=new we(A,y.dims[1],y.dims[0],1);g.push({score:E.score,label:x[E.label_id],mask:b})}}else if(i==="semantic"){let{segmentation:w,labels:y}=h(m,a??u)[0];for(let E of y){let A=new Uint8ClampedArray(w.data.length);for(let O=0;O<w.data.length;++O)w.data[O]===E&&(A[O]=255);let b=new we(A,w.dims[1],w.dims[0],1);g.push({score:null,label:x[E],mask:b})}}else throw Error(`Subtask ${i} not supported.`);else{let y=m[_[0]];for(let E=0;E<u.length;++E){let A=u[E],b=y[E];b.data.some(N=>N<-1e-5||N>1+1e-5)&&b.sigmoid_();let O=await we.fromTensor(b.mul_(255).to("uint8")).resize(A[1],A[0]);g.push({label:null,score:null,mask:O})}}return g}};var El=class extends er{async _call(e,s={}){let r=await be(e),n=await super._call(e,s),o=r.map((a,i)=>{let l=a.clone();return l.putAlpha(n[i].mask),l});return Array.isArray(e)?o:o[0]}};var Al=class extends W{async _call(e,s,{hypothesis_template:r="This is a photo of {}"}={}){let n=Array.isArray(e),o=await be(e),a=s.map(d=>r.replace("{}",d)),i=this.tokenizer(a,{padding:this.model.config.model_type==="siglip"?"max_length":!0,truncation:!0}),{pixel_values:l}=await this.processor(o),c=await this.model({...i,pixel_values:l}),u=this.model.config.model_type==="siglip"?d=>d.sigmoid().data:d=>ue(d.data),p=[];for(let d of c.logits_per_image){let m=[...u(d)].map((h,x)=>({score:h,label:s[x]}));m.sort((h,x)=>x.score-h.score),p.push(m)}return n?p:p[0]}};var Ml=class extends W{async _call(e,{threshold:s=.9,percentage:r=!1}={}){let n=Array.isArray(e);if(n&&e.length!==1)throw Error("Object detection pipeline currently only supports a batch size of 1.");let o=await be(e),a=r?null:o.map(_=>[_.height,_.width]),{pixel_values:i,pixel_mask:l}=await this.processor(o),c=await this.model({pixel_values:i,pixel_mask:l}),u=this.processor.image_processor.post_process_object_detection(c,s,a),{id2label:p}=this.model.config,d=u.map(_=>_.boxes.map((m,h)=>({score:_.scores[h],label:p[_.classes[h]],box:No(m,!r)})));return n?d:d[0]}};var Sl=class extends W{async _call(e,s,{threshold:r=.1,top_k:n=null,percentage:o=!1}={}){let a=Array.isArray(e),i=await be(e),l=this.tokenizer(s,{padding:!0,truncation:!0}),c=await this.processor(i),u=[];for(let p=0;p<i.length;++p){let d=i[p],_=o?null:[[d.height,d.width]],m=c.pixel_values[p].unsqueeze_(0),h=await this.model({...l,pixel_values:m}),x;if("post_process_grounded_object_detection"in this.processor){let g=this.processor.post_process_grounded_object_detection(h,l.input_ids,{box_threshold:r,text_threshold:r,target_sizes:_})[0];x=g.boxes.map((w,y)=>({score:g.scores[y],label:g.labels[y],box:No(w,!o)}))}else{let g=this.processor.image_processor.post_process_object_detection(h,r,_,!0)[0];x=g.boxes.map((w,y)=>({score:g.scores[y],label:s[g.classes[y]],box:No(w,!o)}))}x.sort((g,w)=>w.score-g.score),n!==null&&(x=x.slice(0,n)),u.push(x)}return a?u:u[0]}};var Ol=class extends W{async _call(e,s,r={}){if(Array.isArray(e)){if(e.length!==1)throw Error("Document Question Answering pipeline currently only supports a batch size of 1.");e=e[0]}let n=(await be(e))[0],{pixel_values:o}=await this.processor(n),a=`<s_docvqa><s_question>${s}</s_question><s_answer>`,i=this.tokenizer(a,{add_special_tokens:!1,padding:!0,truncation:!0}).input_ids,l=await this.model.generate({inputs:o,max_length:this.model.config.decoder.max_position_embeddings,decoder_input_ids:i,...r}),u=this.tokenizer.batch_decode(l)[0].match(/<s_answer>(.*?)<\/s_answer>/),p=null;return u&&u.length>=2&&(p=u[1].trim()),[{answer:p}]}};var Il=class extends W{async _call(e){let s=await be(e),r=await this.processor(s),n=await this.model(r),o=[];for(let a of n.reconstruction){let i=a.squeeze().clamp_(0,1).mul_(255).round_().to("uint8");o.push(we.fromTensor(i))}return Array.isArray(e)?o:o[0]}};var zl=class extends W{async _call(e){let s=await be(e),r=await this.processor(s),{predicted_depth:n}=await this.model(r),o=[];for(let a=0;a<s.length;++a){let i=n[a],[l,c]=i.dims.slice(-2),[u,p]=s[a].size,d=(await Xe(i.view(1,1,l,c),{size:[p,u],mode:"bilinear"})).view(p,u),_=d.min().item(),m=d.max().item(),h=d.sub(_).div_(m-_).mul_(255).to("uint8").unsqueeze(0),x=we.fromTensor(h);o.push({predicted_depth:d,depth:x})}return Array.isArray(e)?o:o[0]}};var Tl=class extends W{async _call(e,{pooling:s="none",normalize:r=!1,quantize:n=!1,precision:o="binary"}={}){let a=this.tokenizer(e,{padding:!0,truncation:!0}),i=await this.model(a),l=i.last_hidden_state??i.logits??i.token_embeddings;switch(s){case"none":break;case"mean":l=Fw(l,a.attention_mask);break;case"first_token":case"cls":l=l.slice(null,0);break;case"last_token":case"eos":l=l.slice(null,-1);break;default:throw Error(`Pooling method '${s}' not supported.`)}return r&&(l=l.normalize(2,-1)),n&&(l=jw(l,o)),l}};var Pl=class extends W{async _call(e,{pool:s=null}={}){let r=await be(e),{pixel_values:n}=await this.processor(r),o=await this.model({pixel_values:n}),a;if(s){if(!("pooler_output"in o))throw Error("No pooled output was returned. Make sure the model has a 'pooler' layer when using the 'pool' option.");a=o.pooler_output}else a=o.last_hidden_state??o.logits??o.image_embeds;return a}};var Jy=Object.freeze({"text-classification":{tokenizer:L,pipeline:ul,model:zo,default:{model:"Xenova/distilbert-base-uncased-finetuned-sst-2-english"},type:"text"},"token-classification":{tokenizer:L,pipeline:pl,model:Hi,default:{model:"Xenova/bert-base-multilingual-cased-ner-hrl"},type:"text"},"question-answering":{tokenizer:L,pipeline:dl,model:Zi,default:{model:"Xenova/distilbert-base-cased-distilled-squad"},type:"text"},"fill-mask":{tokenizer:L,pipeline:_l,model:Yi,default:{model:"onnx-community/ettin-encoder-32m-ONNX",dtype:"fp32"},type:"text"},summarization:{tokenizer:L,pipeline:fl,model:Zs,default:{model:"Xenova/distilbart-cnn-6-6"},type:"text"},translation:{tokenizer:L,pipeline:ml,model:Zs,default:{model:"Xenova/t5-small"},type:"text"},"text2text-generation":{tokenizer:L,pipeline:qt,model:Zs,default:{model:"Xenova/flan-t5-small"},type:"text"},"text-generation":{tokenizer:L,pipeline:hl,model:Ji,default:{model:"onnx-community/Qwen3-0.6B-ONNX",dtype:"q4"},type:"text"},"zero-shot-classification":{tokenizer:L,pipeline:xl,model:zo,default:{model:"Xenova/distilbert-base-uncased-mnli"},type:"text"},"audio-classification":{pipeline:gl,model:ol,processor:ze,default:{model:"Xenova/wav2vec2-base-superb-ks"},type:"audio"},"zero-shot-audio-classification":{tokenizer:L,pipeline:wl,model:kt,processor:ze,default:{model:"Xenova/clap-htsat-unfused"},type:"multimodal"},"automatic-speech-recognition":{tokenizer:L,pipeline:yl,model:[Xi,nl],processor:ze,default:{model:"Xenova/whisper-tiny.en"},type:"multimodal"},"text-to-audio":{tokenizer:L,pipeline:bl,model:[Qi,Ki],processor:[ze,null],default:{model:"onnx-community/Supertonic-TTS-ONNX",dtype:"fp32"},type:"text"},"image-to-text":{tokenizer:L,pipeline:kl,model:el,processor:ze,default:{model:"Xenova/vit-gpt2-image-captioning"},type:"multimodal"},"image-classification":{pipeline:vl,model:tl,processor:ze,default:{model:"Xenova/vit-base-patch16-224"},type:"multimodal"},"image-segmentation":{pipeline:er,model:[To,Po,Co],processor:ze,default:{model:"Xenova/detr-resnet-50-panoptic"},type:"multimodal"},"background-removal":{pipeline:El,model:[To,Po,Co],processor:ze,default:{model:"Xenova/modnet"},type:"image"},"zero-shot-image-classification":{tokenizer:L,pipeline:Al,model:kt,processor:ze,default:{model:"Xenova/clip-vit-base-patch32"},type:"multimodal"},"object-detection":{pipeline:Ml,model:sl,processor:ze,default:{model:"Xenova/detr-resnet-50"},type:"multimodal"},"zero-shot-object-detection":{tokenizer:L,pipeline:Sl,model:rl,processor:ze,default:{model:"Xenova/owlvit-base-patch32"},type:"multimodal"},"document-question-answering":{tokenizer:L,pipeline:Ol,model:al,processor:ze,default:{model:"Xenova/donut-base-finetuned-docvqa"},type:"multimodal"},"image-to-image":{pipeline:Il,model:il,processor:ze,default:{model:"Xenova/swin2SR-classical-sr-x2-64"},type:"image"},"depth-estimation":{pipeline:zl,model:ll,processor:ze,default:{model:"onnx-community/depth-anything-v2-small"},type:"image"},"feature-extraction":{tokenizer:L,pipeline:Tl,model:kt,default:{model:"onnx-community/all-MiniLM-L6-v2-ONNX",dtype:"fp32"},type:"text"},"image-feature-extraction":{processor:ze,pipeline:Pl,model:[cl,kt],default:{model:"onnx-community/dinov3-vits16-pretrain-lvd1689m-ONNX",dtype:"fp32"},type:"image"}}),Lv=Object.freeze({"sentiment-analysis":"text-classification",ner:"token-classification",asr:"automatic-speech-recognition","text-to-speech":"text-to-audio",embeddings:"feature-extraction"});async function p9(t,e=null,{progress_callback:s=null,config:r=null,cache_dir:n=null,local_files_only:o=!1,revision:a="main",device:i=null,dtype:l=null,subfolder:c="onnx",use_external_data_format:u=null,model_file_name:p=null,session_options:d={}}={}){t=Lv[t]??t;let _=Jy[t.split("_",1)[0]];if(!_)throw Error(`Unsupported pipeline: ${t}. Must be one of [${Object.keys(Jy)}]`);e||(e=_.default.model,console.log(`No model specified. Using default model: "${e}".`),!l&&_.default.dtype&&(l=_.default.dtype));let m={progress_callback:s,config:r,cache_dir:n,local_files_only:o,revision:a,device:i,dtype:l,subfolder:c,use_external_data_format:u,model_file_name:p,session_options:d},h=new Map([["tokenizer",_.tokenizer],["model",_.model],["processor",_.processor]]),x=await $v(h,e,m);x.task=t,yt(s,{status:"ready",task:t,model:e});let g=_.pipeline;return new g(x)}async function $v(t,e,s){let r=Object.create(null),n=[];for(let[o,a]of t.entries()){if(!a)continue;let i;Array.isArray(a)?i=new Promise(async(l,c)=>{let u;for(let p of a){if(p===null){l(null);return}try{l(await p.from_pretrained(e,s));return}catch(d){if(d.message?.includes("Unsupported model type"))u=d;else if(d.message?.includes("Could not locate file"))u=d;else{c(d);return}}}c(u)}):i=a.from_pretrained(e,s),r[o]=i,n.push(i)}await Promise.all(n);for(let[o,a]of Object.entries(r))r[o]=await a;return r}var Rv=t=>t>=19968&&t<=40959||t>=13312&&t<=19903||t>=131072&&t<=173791||t>=173824&&t<=177983||t>=177984&&t<=178207||t>=178208&&t<=183983||t>=63744&&t<=64255||t>=194560&&t<=195103,bg=class{put(e){throw Error("Not implemented")}end(){throw Error("Not implemented")}},Yy=ee.IS_PROCESS_AVAILABLE?t=>process.stdout.write(t):t=>console.log(t),kg=class extends bg{constructor(e,{skip_prompt:s=!1,callback_function:r=null,token_callback_function:n=null,skip_special_tokens:o=!0,decode_kwargs:a={},...i}={}){super(),this.tokenizer=e,this.skip_prompt=s,this.callback_function=r??Yy,this.token_callback_function=n,this.decode_kwargs={skip_special_tokens:o,...a,...i},this.token_cache=[],this.print_len=0,this.next_tokens_are_prompt=!0,this.special_ids=new Set(this.tokenizer.all_special_ids.map(BigInt))}put(e){if(e.length>1)throw Error("TextStreamer only supports batch size of 1");let s=this.next_tokens_are_prompt;if(s&&(this.next_tokens_are_prompt=!1,this.skip_prompt))return;let r=e[0];if(this.token_callback_function?.(r),r.length===1&&this.special_ids.has(r[0])){if(this.decode_kwargs.skip_special_tokens)return;if(this.token_cache.length>0){let l=this.tokenizer.decode(this.token_cache,this.decode_kwargs).slice(this.print_len);this.on_finalized_text(l,!1),this.token_cache=[],this.print_len=0}let a=this.tokenizer.decode(r,this.decode_kwargs);this.on_finalized_text(a,!1);return}this.token_cache=Pe(this.token_cache,r);let n=this.tokenizer.decode(this.token_cache,this.decode_kwargs),o;s||n.endsWith(`
`)?(o=n.slice(this.print_len),this.token_cache=[],this.print_len=0):n.length>0&&Rv(n.charCodeAt(n.length-1))?(o=n.slice(this.print_len),this.print_len+=o.length):(o=n.slice(this.print_len,n.lastIndexOf(" ")+1),this.print_len+=o.length),this.on_finalized_text(o,!1)}end(){let e;this.token_cache.length>0?(e=this.tokenizer.decode(this.token_cache,this.decode_kwargs).slice(this.print_len),this.token_cache=[],this.print_len=0):e="",this.next_tokens_are_prompt=!0,this.on_finalized_text(e,!0)}on_finalized_text(e,s){e.length>0&&this.callback_function?.(e),s&&this.callback_function===Yy&&ee.IS_PROCESS_AVAILABLE&&this.callback_function?.(`
`)}},Zy=class extends kg{constructor(e,{skip_prompt:s=!1,callback_function:r=null,token_callback_function:n=null,on_chunk_start:o=null,on_chunk_end:a=null,on_finalize:i=null,time_precision:l=.02,skip_special_tokens:c=!0,decode_kwargs:u={}}={}){super(e,{skip_prompt:s,skip_special_tokens:c,callback_function:r,token_callback_function:n,decode_kwargs:u}),this.timestamp_begin=e.timestamp_begin,this.on_chunk_start=o,this.on_chunk_end=a,this.on_finalize=i,this.time_precision=l,this.waiting_for_timestamp=!1}put(e){if(e.length>1)throw Error("WhisperTextStreamer only supports batch size of 1");let s=e[0];if(s.length===1){let r=Number(s[0])-this.timestamp_begin;if(r>=0){let n=r*this.time_precision;this.waiting_for_timestamp?this.on_chunk_end?.(n):this.on_chunk_start?.(n),this.waiting_for_timestamp=!this.waiting_for_timestamp,this.token_callback_function?.(s);return}}return super.put(e)}end(){super.end(),this.on_finalize?.()}};var Lo=class{constructor(e,s){this.image=e,this.timestamp=s}},Cl=class{constructor(e,s){e.length>0&&e[0]instanceof we&&(e=e.map((r,n)=>new Lo(r,(n+1)/(e.length+1)*s))),this.frames=e,this.duration=s}get width(){return this.frames[0].image.width}get height(){return this.frames[0].image.height}get fps(){return this.frames.length/this.duration}};async function Fv(t,{num_frames:e=null,fps:s=null}={}){if(!ee.IS_BROWSER_ENV)throw new Error("`load_video` is currently only supported in browser environments.");if(e==null&&s==null)throw new Error("Either num_frames or fps must be provided.");let r=[],n=document.createElement("video");if(n.crossOrigin="anonymous",n.muted=!0,typeof t=="string")n.src=t;else if(t instanceof Blob)n.src=URL.createObjectURL(t);else if(t instanceof HTMLVideoElement)n.src=t.src;else throw new Error("Invalid URL or video element provided.");if(await new Promise(p=>n.onloadedmetadata=p),n.seekable.start(0)===n.seekable.end(0)){let d=await(await fetch(n.src)).blob();n.src=URL.createObjectURL(d),await new Promise(_=>n.onloadedmetadata=_)}let o=n.duration,a,i;e!=null?(a=e,i=e===1?0:o/(e-1)):(i=1/s,a=Math.floor(o/i));let l=[];for(let p=0;p<a;++p)l.push(e===1?o/2:p*i);let c=document.createElement("canvas");c.width=n.videoWidth,c.height=n.videoHeight;let u=c.getContext("2d",{willReadFrequently:!0});for(let p of l){n.currentTime=p,await new Promise(h=>{n.onseeked=h}),u.drawImage(n,0,0,c.width,c.height);let d=u.getImageData(0,0,c.width,c.height),_=new we(d.data,c.width,c.height,4),m=new Lo(_,p);r.push(m)}return n.remove(),new Cl(r,o)}export{Yc as ASTFeatureExtractor,$p as ASTForAudioClassification,Lp as ASTModel,Ir as ASTPreTrainedModel,zp as AlbertForMaskedLM,Ip as AlbertForQuestionAnswering,Op as AlbertForSequenceClassification,Sp as AlbertModel,rs as AlbertPreTrainedModel,oc as AlbertTokenizer,Pp as ApertusForCausalLM,Tp as ApertusModel,Sr as ApertusPreTrainedModel,Np as ArceeForCausalLM,Cp as ArceeModel,Or as ArceePreTrainedModel,gl as AudioClassificationPipeline,Yt as AutoConfig,ve as AutoFeatureExtractor,_e as AutoImageProcessor,kt as AutoModel,ol as AutoModelForAudioClassification,qy as AutoModelForAudioFrameClassification,Xy as AutoModelForAudioTextToText,nl as AutoModelForCTC,Ji as AutoModelForCausalLM,ll as AutoModelForDepthEstimation,al as AutoModelForDocumentQuestionAnswering,tl as AutoModelForImageClassification,cl as AutoModelForImageFeatureExtraction,Gy as AutoModelForImageMatting,To as AutoModelForImageSegmentation,Hy as AutoModelForImageTextToText,il as AutoModelForImageToImage,By as AutoModelForMaskGeneration,Yi as AutoModelForMaskedLM,Wy as AutoModelForNormalEstimation,sl as AutoModelForObjectDetection,Vy as AutoModelForPoseEstimation,Zi as AutoModelForQuestionAnswering,Po as AutoModelForSemanticSegmentation,Zs as AutoModelForSeq2SeqLM,zo as AutoModelForSequenceClassification,Xi as AutoModelForSpeechSeq2Seq,Ki as AutoModelForTextToSpectrogram,Qi as AutoModelForTextToWaveform,Hi as AutoModelForTokenClassification,Co as AutoModelForUniversalSegmentation,el as AutoModelForVision2Seq,Uy as AutoModelForXVector,rl as AutoModelForZeroShotObjectDetection,ze as AutoProcessor,L as AutoTokenizer,yl as AutomaticSpeechRecognitionPipeline,El as BackgroundRemovalPipeline,Fp as BartForConditionalGeneration,Dp as BartForSequenceClassification,Rp as BartModel,Cs as BartPretrainedModel,ac as BartTokenizer,bg as BaseStreamer,_u as BeitFeatureExtractor,Bp as BeitForImageClassification,jp as BeitModel,zr as BeitPreTrainedModel,qp as BertForMaskedLM,Vp as BertForQuestionAnswering,Gp as BertForSequenceClassification,Wp as BertForTokenClassification,Up as BertModel,Ot as BertPreTrainedModel,ic as BertTokenizer,fu as BitImageProcessor,Xp as BlenderbotForConditionalGeneration,Hp as BlenderbotModel,Tr as BlenderbotPreTrainedModel,Qp as BlenderbotSmallForConditionalGeneration,Kp as BlenderbotSmallModel,Pr as BlenderbotSmallPreTrainedModel,lc as BlenderbotSmallTokenizer,cc as BlenderbotTokenizer,Yp as BloomForCausalLM,Jp as BloomModel,Cr as BloomPreTrainedModel,uc as BloomTokenizer,hu as CLIPFeatureExtractor,ca as CLIPImageProcessor,ad as CLIPModel,ft as CLIPPreTrainedModel,pd as CLIPSegForImageSegmentation,ud as CLIPSegModel,Fr as CLIPSegPreTrainedModel,id as CLIPTextModel,Rr as CLIPTextModelWithProjection,dc as CLIPTokenizer,ld as CLIPVisionModel,cd as CLIPVisionModelWithProjection,ed as CamembertForMaskedLM,rd as CamembertForQuestionAnswering,td as CamembertForSequenceClassification,sd as CamembertForTokenClassification,Zp as CamembertModel,It as CamembertPreTrainedModel,pc as CamembertTokenizer,Zc as ChatterboxFeatureExtractor,Nr as ChatterboxModel,Xa as ChatterboxPreTrainedModel,uu as ChatterboxProcessor,mu as ChineseCLIPFeatureExtractor,nd as ChineseCLIPModel,Ka as ChineseCLIPPreTrainedModel,$r as ClapAudioModelWithProjection,eu as ClapFeatureExtractor,od as ClapModel,Ns as ClapPreTrainedModel,Lr as ClapTextModelWithProjection,Da as ClassifierFreeGuidanceLogitsProcessor,_d as CodeGenForCausalLM,dd as CodeGenModel,Dr as CodeGenPreTrainedModel,fc as CodeGenTokenizer,_c as CodeLlamaTokenizer,xd as Cohere2ForCausalLM,hd as Cohere2Model,Br as Cohere2PreTrainedModel,md as CohereForCausalLM,fd as CohereModel,jr as CoherePreTrainedModel,mc as CohereTokenizer,wd as ConvBertForMaskedLM,kd as ConvBertForQuestionAnswering,yd as ConvBertForSequenceClassification,bd as ConvBertForTokenClassification,gd as ConvBertModel,zt as ConvBertPreTrainedModel,hc as ConvBertTokenizer,xu as ConvNextFeatureExtractor,Ed as ConvNextForImageClassification,ua as ConvNextImageProcessor,vd as ConvNextModel,Ur as ConvNextPreTrainedModel,Md as ConvNextV2ForImageClassification,Ad as ConvNextV2Model,qr as ConvNextV2PreTrainedModel,zd as DFineForObjectDetection,Id as DFineModel,Wr as DFinePreTrainedModel,e_ as DINOv3ConvNextModel,si as DINOv3ConvNextPreTrainedModel,yu as DINOv3ViTImageProcessor,t_ as DINOv3ViTModel,ri as DINOv3ViTPreTrainedModel,ku as DPTFeatureExtractor,c_ as DPTForDepthEstimation,_a as DPTImageProcessor,l_ as DPTModel,Jr as DPTPreTrainedModel,Hr as DacDecoderModel,Ja as DacDecoderOutput,Vr as DacEncoderModel,Qa as DacEncoderOutput,gr as DacFeatureExtractor,Td as DacModel,Ls as DacPreTrainedModel,Cd as DebertaForMaskedLM,$d as DebertaForQuestionAnswering,Nd as DebertaForSequenceClassification,Ld as DebertaForTokenClassification,Pd as DebertaModel,Tt as DebertaPreTrainedModel,gc as DebertaTokenizer,Fd as DebertaV2ForMaskedLM,Bd as DebertaV2ForQuestionAnswering,Dd as DebertaV2ForSequenceClassification,jd as DebertaV2ForTokenClassification,Rd as DebertaV2Model,Pt as DebertaV2PreTrainedModel,xc as DebertaV2Tokenizer,Ud as DecisionTransformerModel,Ya as DecisionTransformerPreTrainedModel,gu as DeiTFeatureExtractor,Gd as DeiTForImageClassification,pa as DeiTImageProcessor,qd as DeiTModel,Xr as DeiTPreTrainedModel,Wd as DepthAnythingForDepthEstimation,Za as DepthAnythingPreTrainedModel,zl as DepthEstimationPipeline,Vd as DepthProForDepthEstimation,ei as DepthProPreTrainedModel,wu as DetrFeatureExtractor,Xd as DetrForObjectDetection,Kd as DetrForSegmentation,da as DetrImageProcessor,Hd as DetrModel,Rs as DetrObjectDetectionOutput,$s as DetrPreTrainedModel,ti as DetrSegmentationOutput,Jd as Dinov2ForImageClassification,Qd as Dinov2Model,Kr as Dinov2PreTrainedModel,Zd as Dinov2WithRegistersForImageClassification,Yd as Dinov2WithRegistersModel,Qr as Dinov2WithRegistersPreTrainedModel,a_ as DistilBertForMaskedLM,o_ as DistilBertForQuestionAnswering,r_ as DistilBertForSequenceClassification,n_ as DistilBertForTokenClassification,s_ as DistilBertModel,Ct as DistilBertPreTrainedModel,wc as DistilBertTokenizer,Ol as DocumentQuestionAnsweringPipeline,bu as DonutFeatureExtractor,vs as DonutImageProcessor,i_ as DonutSwinModel,ni as DonutSwinPreTrainedModel,Hh as EdgeTamModel,p_ as EfficientNetForImageClassification,vu as EfficientNetImageProcessor,u_ as EfficientNetModel,Yr as EfficientNetPreTrainedModel,__ as ElectraForMaskedLM,h_ as ElectraForQuestionAnswering,f_ as ElectraForSequenceClassification,m_ as ElectraForTokenClassification,d_ as ElectraModel,Nt as ElectraPreTrainedModel,yc as ElectraTokenizer,xr as EncodecFeatureExtractor,qa as EosTokenCriteria,g_ as Ernie4_5ForCausalLM,x_ as Ernie4_5Model,Zr as Ernie4_5PretrainedModel,y_ as EsmForMaskedLM,b_ as EsmForSequenceClassification,k_ as EsmForTokenClassification,w_ as EsmModel,ns as EsmPreTrainedModel,bc as EsmTokenizer,E_ as ExaoneForCausalLM,v_ as ExaoneModel,en as ExaonePreTrainedModel,M_ as FalconForCausalLM,O_ as FalconH1ForCausalLM,S_ as FalconH1Model,sn as FalconH1PreTrainedModel,A_ as FalconModel,tn as FalconPreTrainedModel,kc as FalconTokenizer,z_ as FastViTForImageClassification,I_ as FastViTModel,rn as FastViTPreTrainedModel,Tl as FeatureExtractionPipeline,de as FeatureExtractor,_l as FillMaskPipeline,T_ as Florence2ForConditionalGeneration,oi as Florence2PreTrainedModel,ep as Florence2Processor,Ta as ForcedBOSTokenLogitsProcessor,Pa as ForcedEOSTokenLogitsProcessor,Eu as GLPNFeatureExtractor,B_ as GLPNForDepthEstimation,j_ as GLPNModel,un as GLPNPreTrainedModel,J_ as GPT2LMHeadModel,Q_ as GPT2Model,mn as GPT2PreTrainedModel,Ac as GPT2Tokenizer,q_ as GPTBigCodeForCausalLM,U_ as GPTBigCodeModel,pn as GPTBigCodePreTrainedModel,Z_ as GPTJForCausalLM,Y_ as GPTJModel,hn as GPTJPreTrainedModel,W_ as GPTNeoForCausalLM,G_ as GPTNeoModel,dn as GPTNeoPreTrainedModel,H_ as GPTNeoXForCausalLM,V_ as GPTNeoXModel,_n as GPTNeoXPreTrainedModel,Ec as GPTNeoXTokenizer,L_ as Gemma2ForCausalLM,N_ as Gemma2Model,on as Gemma2PreTrainedModel,R_ as Gemma3ForCausalLM,$_ as Gemma3Model,an as Gemma3PreTrainedModel,tu as Gemma3nAudioFeatureExtractor,ln as Gemma3nForConditionalGeneration,ai as Gemma3nPreTrainedModel,tp as Gemma3nProcessor,C_ as GemmaForCausalLM,P_ as GemmaModel,nn as GemmaPreTrainedModel,vc as GemmaTokenizer,D_ as GlmForCausalLM,F_ as GlmModel,cn as GlmPreTrainedModel,K_ as GptOssForCausalLM,X_ as GptOssModel,fn as GptOssPreTrainedModel,tf as GraniteForCausalLM,ef as GraniteModel,rf as GraniteMoeHybridForCausalLM,sf as GraniteMoeHybridModel,gn as GraniteMoeHybridPreTrainedModel,xn as GranitePreTrainedModel,nf as GroundingDinoForObjectDetection,Au as GroundingDinoImageProcessor,ii as GroundingDinoPreTrainedModel,sp as GroundingDinoProcessor,of as GroupViTModel,li as GroupViTPreTrainedModel,lf as HeliumForCausalLM,af as HeliumModel,wn as HeliumPreTrainedModel,Mc as HerbertTokenizer,uf as HieraForImageClassification,cf as HieraModel,yn as HieraPreTrainedModel,xf as HubertForCTC,gf as HubertForSequenceClassification,hf as HubertModel,mf as HubertPreTrainedModel,yf as HunYuanDenseV1ForCausalLM,wf as HunYuanDenseV1Model,bn as HunYuanDenseV1PreTrainedModel,vf as IJepaForImageClassification,kf as IJepaModel,kn as IJepaPreTrainedModel,ui as Idefics3ForConditionalGeneration,fa as Idefics3ImageProcessor,ci as Idefics3PreTrainedModel,Ea as Idefics3Processor,vl as ImageClassificationPipeline,Pl as ImageFeatureExtractionPipeline,P as ImageFeatureExtractor,P as ImageProcessor,er as ImageSegmentationPipeline,Il as ImageToImagePipeline,kl as ImageToTextPipeline,iy as InterruptableStoppingCriteria,Af as JAISLMHeadModel,Ef as JAISModel,vn as JAISPreTrainedModel,Su as JinaCLIPImageProcessor,Mf as JinaCLIPModel,Fs as JinaCLIPPreTrainedModel,np as JinaCLIPProcessor,En as JinaCLIPTextModel,Sf as JinaCLIPVisionModel,If as Lfm2ForCausalLM,Of as Lfm2Model,Tf as Lfm2MoeForCausalLM,zf as Lfm2MoeModel,Mn as Lfm2MoePreTrainedModel,An as Lfm2PreTrainedModel,ng as LiteWhisperForConditionalGeneration,Nf as Llama4ForCausalLM,pi as Llama4PreTrainedModel,Cf as LlamaForCausalLM,Pf as LlamaModel,Sn as LlamaPreTrainedModel,Sc as LlamaTokenizer,Ds as LlavaForConditionalGeneration,Ds as LlavaOnevisionForConditionalGeneration,Ou as LlavaOnevisionImageProcessor,di as LlavaPreTrainedModel,op as LlavaProcessor,$f as LlavaQwen2ForCausalLM,Qe as LogitsProcessor,Zt as LogitsProcessorList,vr as LogitsWarper,Ff as LongT5ForConditionalGeneration,Rf as LongT5Model,On as LongT5PreTrainedModel,jf as M2M100ForConditionalGeneration,Df as M2M100Model,In as M2M100PreTrainedModel,Oc as M2M100Tokenizer,zc as MBart50Tokenizer,Xf as MBartForCausalLM,Vf as MBartForConditionalGeneration,Hf as MBartForSequenceClassification,Wf as MBartModel,os as MBartPreTrainedModel,_r as MBartTokenizer,Pm as MPNetForMaskedLM,Lm as MPNetForQuestionAnswering,Cm as MPNetForSequenceClassification,Nm as MPNetForTokenClassification,Tm as MPNetModel,Lt as MPNetPreTrainedModel,Cc as MPNetTokenizer,Dm as MT5ForConditionalGeneration,Fm as MT5Model,Bn as MT5PreTrainedModel,Uf as MarianMTModel,Bf as MarianModel,zn as MarianPreTrainedModel,Ic as MarianTokenizer,zu as Mask2FormerImageProcessor,Iu as MaskFormerFeatureExtractor,Gf as MaskFormerForInstanceSegmentation,Es as MaskFormerImageProcessor,qf as MaskFormerModel,Tn as MaskFormerPreTrainedModel,Ua as MaxLengthCriteria,Kf as Metric3DForDepthEstimation,_i as Metric3DPreTrainedModel,Qf as Metric3Dv2ForDepthEstimation,fi as Metric3Dv2PreTrainedModel,Jf as MgpstrForSceneTextRecognition,mi as MgpstrModelOutput,hi as MgpstrPreTrainedModel,ap as MgpstrProcessor,Tc as MgpstrTokenizer,Cn as MimiDecoderModel,gi as MimiDecoderOutput,Pn as MimiEncoderModel,xi as MimiEncoderOutput,Yf as MimiModel,js as MimiPreTrainedModel,$a as MinLengthLogitsProcessor,Ra as MinNewTokensLengthLogitsProcessor,em as MistralForCausalLM,Zf as MistralModel,Nn as MistralPreTrainedModel,sm as MobileBertForMaskedLM,nm as MobileBertForQuestionAnswering,rm as MobileBertForSequenceClassification,tm as MobileBertModel,as as MobileBertPreTrainedModel,Pc as MobileBertTokenizer,am as MobileLLMForCausalLM,om as MobileLLMModel,Ln as MobileLLMPreTrainedModel,Tu as MobileNetV1FeatureExtractor,lm as MobileNetV1ForImageClassification,cm as MobileNetV1ForSemanticSegmentation,ma as MobileNetV1ImageProcessor,im as MobileNetV1Model,Bs as MobileNetV1PreTrainedModel,Pu as MobileNetV2FeatureExtractor,pm as MobileNetV2ForImageClassification,dm as MobileNetV2ForSemanticSegmentation,ha as MobileNetV2ImageProcessor,um as MobileNetV2Model,Us as MobileNetV2PreTrainedModel,Cu as MobileNetV3FeatureExtractor,fm as MobileNetV3ForImageClassification,mm as MobileNetV3ForSemanticSegmentation,xa as MobileNetV3ImageProcessor,_m as MobileNetV3Model,qs as MobileNetV3PreTrainedModel,Nu as MobileNetV4FeatureExtractor,xm as MobileNetV4ForImageClassification,gm as MobileNetV4ForSemanticSegmentation,ga as MobileNetV4ImageProcessor,hm as MobileNetV4Model,Gs as MobileNetV4PreTrainedModel,Lu as MobileViTFeatureExtractor,ym as MobileViTForImageClassification,wa as MobileViTImageProcessor,wm as MobileViTModel,$n as MobileViTPreTrainedModel,km as MobileViTV2ForImageClassification,bm as MobileViTV2Model,Rn as MobileViTV2PreTrainedModel,Om as ModernBertDecoderForCausalLM,Sm as ModernBertDecoderModel,Fn as ModernBertDecoderPreTrainedModel,Em as ModernBertForMaskedLM,Am as ModernBertForSequenceClassification,Mm as ModernBertForTokenClassification,vm as ModernBertModel,is as ModernBertPreTrainedModel,Lf as Moondream1ForConditionalGeneration,su as MoonshineFeatureExtractor,zm as MoonshineForConditionalGeneration,Im as MoonshineModel,Dn as MoonshinePreTrainedModel,ip as MoonshineProcessor,Rm as MptForCausalLM,$m as MptModel,jn as MptPreTrainedModel,jm as MultiModalityCausalLM,wi as MultiModalityPreTrainedModel,Um as MusicgenForCausalLM,qn as MusicgenForConditionalGeneration,Bm as MusicgenModel,Un as MusicgenPreTrainedModel,Gm as NanoChatForCausalLM,qm as NanoChatModel,Gn as NanoChatPreTrainedModel,Vm as NeoBertForMaskedLM,Km as NeoBertForQuestionAnswering,Hm as NeoBertForSequenceClassification,Xm as NeoBertForTokenClassification,Wm as NeoBertModel,$t as NeoBertPreTrainedModel,Nc as NllbTokenizer,Fa as NoBadWordsLogitsProcessor,Na as NoRepeatNGramLogitsProcessor,Qm as NomicBertModel,yi as NomicBertPreTrainedModel,$u as NougatImageProcessor,Lc as NougatTokenizer,ah as OPTForCausalLM,oh as OPTModel,Kn as OPTPreTrainedModel,Ml as ObjectDetectionPipeline,eh as Olmo2ForCausalLM,Zm as Olmo2Model,Vn as Olmo2PreTrainedModel,sh as Olmo3ForCausalLM,th as Olmo3Model,Hn as Olmo3PreTrainedModel,Ym as OlmoForCausalLM,Jm as OlmoModel,Wn as OlmoPreTrainedModel,nh as OpenELMForCausalLM,rh as OpenELMModel,Xn as OpenELMPreTrainedModel,Ru as OwlViTFeatureExtractor,uh as OwlViTForObjectDetection,As as OwlViTImageProcessor,ch as OwlViTModel,Jn as OwlViTPreTrainedModel,lp as OwlViTProcessor,lh as Owlv2ForObjectDetection,Fu as Owlv2ImageProcessor,ih as Owlv2Model,Qn as Owlv2PreTrainedModel,ph as PaliGemmaForConditionalGeneration,bi as PaliGemmaPreTrainedModel,cp as PaliGemmaProcessor,ru as ParakeetFeatureExtractor,dh as ParakeetForCTC,ki as ParakeetPreTrainedModel,fh as PatchTSMixerForPrediction,_h as PatchTSMixerModel,Yn as PatchTSMixerPreTrainedModel,hh as PatchTSTForPrediction,mh as PatchTSTModel,Zn as PatchTSTPreTrainedModel,yh as Phi3ForCausalLM,wh as Phi3Model,to as Phi3PreTrainedModel,so as Phi3VForCausalLM,Bu as Phi3VImageProcessor,vi as Phi3VPreTrainedModel,up as Phi3VProcessor,gh as PhiForCausalLM,xh as PhiModel,eo as PhiPreTrainedModel,Uu as PixtralImageProcessor,pp as PixtralProcessor,f as PreTrainedModel,T as PreTrainedTokenizer,Oa as PretrainedConfig,j as Processor,kh as PvtForImageClassification,qu as PvtImageProcessor,bh as PvtModel,ro as PvtPreTrainedModel,wr as PyAnnoteFeatureExtractor,Eh as PyAnnoteForAudioFrameClassification,vh as PyAnnoteModel,no as PyAnnotePreTrainedModel,dp as PyAnnoteProcessor,dl as QuestionAnsweringPipeline,Mh as Qwen2ForCausalLM,Ah as Qwen2Model,oo as Qwen2PreTrainedModel,$c as Qwen2Tokenizer,Sh as Qwen2VLForConditionalGeneration,Gu as Qwen2VLImageProcessor,Ei as Qwen2VLPreTrainedModel,_p as Qwen2VLProcessor,Ih as Qwen3ForCausalLM,Oh as Qwen3Model,ao as Qwen3PreTrainedModel,Ch as RFDetrForObjectDetection,Ph as RFDetrModel,Ai as RFDetrObjectDetectionOutput,lo as RFDetrPreTrainedModel,Od as RTDetrForObjectDetection,Wu as RTDetrImageProcessor,Sd as RTDetrModel,mt as RTDetrObjectDetectionOutput,Gr as RTDetrPreTrainedModel,Wh as RTDetrV2ForObjectDetection,Gh as RTDetrV2Model,Mi as RTDetrV2ObjectDetectionOutput,co as RTDetrV2PreTrainedModel,hr as RawAudio,we as RawImage,Cl as RawVideo,Lo as RawVideoFrame,La as RepetitionPenaltyLogitsProcessor,Th as ResNetForImageClassification,zh as ResNetModel,io as ResNetPreTrainedModel,jh as RoFormerForMaskedLM,qh as RoFormerForQuestionAnswering,Bh as RoFormerForSequenceClassification,Uh as RoFormerForTokenClassification,Dh as RoFormerModel,Ft as RoFormerPreTrainedModel,Fc as RoFormerTokenizer,Lh as RobertaForMaskedLM,Fh as RobertaForQuestionAnswering,$h as RobertaForSequenceClassification,Rh as RobertaForTokenClassification,Nh as RobertaModel,Rt as RobertaPreTrainedModel,Rc as RobertaTokenizer,br as Sam2ImageProcessor,Ii as Sam2ImageSegmentationOutput,uo as Sam2Model,zi as Sam2PreTrainedModel,Aa as Sam2Processor,fp as Sam2VideoProcessor,br as Sam3ImageProcessor,Xh as Sam3TrackerModel,br as SamImageProcessor,Si as SamImageSegmentationOutput,Vh as SamModel,Oi as SamPreTrainedModel,kr as SamProcessor,Vu as SapiensFeatureExtractor,Qh as SapiensForDepthEstimation,Jh as SapiensForNormalEstimation,Kh as SapiensForSemanticSegmentation,ya as SapiensImageProcessor,Ws as SapiensPreTrainedModel,nu as SeamlessM4TFeatureExtractor,Hu as SegformerFeatureExtractor,Zh as SegformerForImageClassification,ex as SegformerForSemanticSegmentation,ba as SegformerImageProcessor,Yh as SegformerModel,Vs as SegformerPreTrainedModel,Xu as SiglipImageProcessor,tx as SiglipModel,po as SiglipPreTrainedModel,_o as SiglipTextModel,Dc as SiglipTokenizer,sx as SiglipVisionModel,nx as SmolLM3ForCausalLM,rx as SmolLM3Model,fo as SmolLM3PreTrainedModel,bf as SmolVLMForConditionalGeneration,fa as SmolVLMImageProcessor,Ea as SmolVLMProcessor,ho as SnacDecoderModel,mo as SnacEncoderModel,ou as SnacFeatureExtractor,ox as SnacModel,Hs as SnacPreTrainedModel,au as SpeechT5FeatureExtractor,ix as SpeechT5ForSpeechToText,lx as SpeechT5ForTextToSpeech,cx as SpeechT5HifiGan,ax as SpeechT5Model,Xs as SpeechT5PreTrainedModel,mp as SpeechT5Processor,jc as SpeechT5Tokenizer,px as SqueezeBertForMaskedLM,_x as SqueezeBertForQuestionAnswering,dx as SqueezeBertForSequenceClassification,ux as SqueezeBertModel,ls as SqueezeBertPreTrainedModel,Bc as SqueezeBertTokenizer,mx as StableLmForCausalLM,fx as StableLmModel,xo as StableLmPreTrainedModel,xx as Starcoder2ForCausalLM,hx as Starcoder2Model,go as Starcoder2PreTrainedModel,Ps as StoppingCriteria,Ba as StoppingCriteriaList,gx as StyleTextToSpeech2Model,Ti as StyleTextToSpeech2PreTrainedModel,fl as SummarizationPipeline,wo as SupertonicForConditionalGeneration,Pi as SupertonicPreTrainedModel,zs as SuppressTokensAtBeginLogitsProcessor,vx as Swin2SRForImageSuperResolution,Ku as Swin2SRImageProcessor,kx as Swin2SRModel,yo as Swin2SRPreTrainedModel,yx as SwinForImageClassification,bx as SwinForSemanticSegmentation,wx as SwinModel,Ks as SwinPreTrainedModel,Ax as T5ForConditionalGeneration,Ex as T5Model,bo as T5PreTrainedModel,Uc as T5Tokenizer,Sx as TableTransformerForObjectDetection,Mx as TableTransformerModel,Ci as TableTransformerObjectDetectionOutput,ko as TableTransformerPreTrainedModel,ja as TemperatureLogitsWarper,S as Tensor,qt as Text2TextGenerationPipeline,ul as TextClassificationPipeline,hl as TextGenerationPipeline,kg as TextStreamer,bl as TextToAudioPipeline,pl as TokenClassificationPipeline,T as TokenizersBackend,ay as TopKLogitsWarper,oy as TopPLogitsWarper,Ox as TrOCRForCausalLM,Ni as TrOCRPreTrainedModel,ml as TranslationPipeline,$i as UltravoxModel,Li as UltravoxPreTrainedModel,hp as UltravoxProcessor,Tx as UniSpeechForCTC,Px as UniSpeechForSequenceClassification,zx as UniSpeechModel,Qs as UniSpeechPreTrainedModel,$x as UniSpeechSatForAudioFrameClassification,Nx as UniSpeechSatForCTC,Lx as UniSpeechSatForSequenceClassification,Cx as UniSpeechSatModel,cs as UniSpeechSatPreTrainedModel,rp as VLChatProcessor,Mu as VLMImageProcessor,Fx as VaultGemmaForCausalLM,Rx as VaultGemmaModel,vo as VaultGemmaPreTrainedModel,Qu as ViTFeatureExtractor,Bx as ViTForImageClassification,ka as ViTImageProcessor,Ux as ViTMAEModel,Ri as ViTMAEPreTrainedModel,Gx as ViTMSNForImageClassification,qx as ViTMSNModel,Ao as ViTMSNPreTrainedModel,jx as ViTModel,Eo as ViTPreTrainedModel,Dx as VisionEncoderDecoderModel,Wx as VitMatteForImageMatting,Ju as VitMatteImageProcessor,Fi as VitMattePreTrainedModel,Vx as VitPoseForPoseEstimation,Yu as VitPoseImageProcessor,Di as VitPosePreTrainedModel,Hx as VitsModel,ji as VitsModelOutput,Bi as VitsPreTrainedModel,Gc as VitsTokenizer,Ix as VoxtralForConditionalGeneration,xp as VoxtralProcessor,Kx as Wav2Vec2BertForCTC,Qx as Wav2Vec2BertForSequenceClassification,Xx as Wav2Vec2BertModel,Js as Wav2Vec2BertPreTrainedModel,Wc as Wav2Vec2CTCTokenizer,iu as Wav2Vec2FeatureExtractor,ff as Wav2Vec2ForAudioFrameClassification,df as Wav2Vec2ForCTC,_f as Wav2Vec2ForSequenceClassification,pf as Wav2Vec2Model,it as Wav2Vec2PreTrainedModel,gp as Wav2Vec2Processor,wp as Wav2Vec2ProcessorWithLM,tg as WavLMForAudioFrameClassification,Yx as WavLMForCTC,Zx as WavLMForSequenceClassification,eg as WavLMForXVector,Jx as WavLMModel,Dt as WavLMPreTrainedModel,lu as WeSpeakerFeatureExtractor,sg as WeSpeakerResNetModel,qi as WeSpeakerResNetPreTrainedModel,cu as WhisperFeatureExtractor,Wi as WhisperForConditionalGeneration,rg as WhisperModel,Mo as WhisperPreTrainedModel,yp as WhisperProcessor,Zy as WhisperTextStreamer,Ca as WhisperTimeStampLogitsProcessor,Vc as WhisperTokenizer,cg as XLMForQuestionAnswering,ig as XLMForSequenceClassification,lg as XLMForTokenClassification,og as XLMModel,jt as XLMPreTrainedModel,pg as XLMRobertaForMaskedLM,fg as XLMRobertaForQuestionAnswering,dg as XLMRobertaForSequenceClassification,_g as XLMRobertaForTokenClassification,ug as XLMRobertaModel,Bt as XLMRobertaPreTrainedModel,Hc as XLMRobertaTokenizer,Xc as XLMTokenizer,ag as XLMWithLMHeadModel,Ui as XVectorOutput,Zu as YolosFeatureExtractor,hg as YolosForObjectDetection,va as YolosImageProcessor,mg as YolosModel,Vi as YolosObjectDetectionOutput,So as YolosPreTrainedModel,gg as YoutuForCausalLM,xg as YoutuModel,Oo as YoutuPreTrainedModel,wl as ZeroShotAudioClassificationPipeline,xl as ZeroShotClassificationPipeline,Al as ZeroShotImageClassificationPipeline,Sl as ZeroShotObjectDetectionPipeline,ne as cat,bk as cos_sim,xw as dot,ce as env,xe as full,dr as full_like,Yl as interpolate,Xe as interpolate_4d,CM as layer_norm,rv as load_image,Fv as load_video,Gl as log_softmax,Rw as matmul,ta as mean,Fw as mean_pooling,Oe as ones,sa as ones_like,Lk as permute,p9 as pipeline,jw as quantize_embeddings,NM as rand,Dw as randn,Jc as read_audio,PM as rfft,ea as slice,ue as softmax,Ke as stack,Zl as std_mean,ot as topk,tc as zeros,sc as zeros_like};
